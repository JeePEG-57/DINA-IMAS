...
Ip_div=3.3; ref_ramp=3; t_eob=82.9; Ip_rd=0; amp_noise=1.05/sqrt(20)*1e0;
...
Ics1_eob=-30e-3*ntur(3); t_eob2=25; dt_contr_hl=0; cIp_end=1.5; dt_end=dtpl_term_l*cIp_end/7.5;

%dt_contr_hl=0;- переход с шага с 10 на 5 мсек по Ics1_eob=-30e-3*ntur(3)
% teb не нужно использовать
%dt_end-за это время спадает до нуля
