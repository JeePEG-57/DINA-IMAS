...
c-------------------
	...
	call out42(n_pr,a_print,num,apr)
        ...
        print *,' brad_p bvert_p ',brad_p,bvert_pn
...
c---
	...
	if(kpr.eq.1)print *,' k brad_p bvert_p ',k,brad_p,bvert_p


       if(dabs(brad_p)+dabs(bvert_p).gt.5.e-8)go to 1

	if(kpr.eq.1)print *,' k brad bvert ',k,brad,bvert
...
c	print *,'x',(x(i),i=1,nr)
c	print *,'y',(y(i),i=1,nz)
...
c       if(dabs(brad)+dabs(bvert).gt.5.e-8)go to 1
