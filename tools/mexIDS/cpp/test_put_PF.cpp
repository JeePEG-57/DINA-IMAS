...
int main(int argc, char *argv[])
{
  ...
  //The parameters passed to this creator define the shot and run number. The second pair of arguments defines the reference shot and run
  //and is used when the a new database is created, as in this example.
  //All the UAL classes belong to the idsNs namespace
  imas_create("ids", 997, 997, 997, 997, &number);
...
//  ids._pf_active.Vertical_Forces.names[0] = "VF name1";
        ...
        //A sample int
  ids._pf_active.ids_properties.cocos = 1;
