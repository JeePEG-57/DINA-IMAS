     ...
     *       elong_sep,b_cs,uli_p,coef_imp,nz_imp,volume,
...
c************************************
c        if(kpr.eq.1)print*,'ntay vs_start vs kefit',
...
c        nz_imp=74
        ...
        coef_imp=(zeff_a-1.)/(z_2-zeff_a*z_1)
...
c*** >>>>> MW
c        if(kpr.eq.1)print*,'vv in cm3',vv
c*** [w_imp]=MW
...
c        if(kpr.eq.1)print*,'from dop ntay=',ntay
c        if(kpr.eq.1)print*,'key_help key_h_to_l',key_help,key_h_to_l
c        read(*,*)
