 ...
 * C/C++ source code generated on : Thu May 16 14:39:31 2019
 *
...
void t15_2_step(void)
{
   ...
   *  Inport: '<Root>/In1'
   */
  t15_2_B.e3 = t15_2_P.e3_Gain_j * t15_2_U.In1[8];
  ...
  t15_2_B.RelationalOperator_j = (t15_2_B.e3 >= t15_2_B.Sum2);

  /* Stop: '<S4>/Stop Simulation' */
  if (t15_2_B.RelationalOperator_j) {
   ...
   */
  for (i = 0; i < 15; i++) {
    t15_2_B.e6_k[i] = t15_2_U.In2[i + 6] * t15_2_P.e6_Gain_m;
  }

  /* End of Gain: '<S13>/1e-6   ' */

  /* Memory: '<S22>/Memory2' */
  t15_2_B.Memory2_c = t15_2_DWork.Memory2_PreviousInput_o;

  /* Sum: '<S22>/Add3' */
  t15_2_B.Add3 = t15_2_B.e6_k[2] + t15_2_B.Memory2_c;

  /* DataStoreRead: '<S22>/Data Store Read1' */
  t15_2_B.DataStoreRead1 = t15_2_DWork.RupRd[4];

  /* Gain: '<S22>/1e-3' */
  t15_2_B.e3_g = t15_2_P.e3_Gain_a * t15_2_B.DataStoreRead1;

  /* DataStoreRead: '<S22>/Data Store Read2' */
  t15_2_B.DataStoreRead2 = t15_2_DWork.ntur[2];

  /* Product: '<S22>/Product1' */
  t15_2_B.Product1 = t15_2_B.e3_g * t15_2_B.DataStoreRead2;
  ...
  /* End of Switch: '<S22>/0.999' */

  /* Sum: '<S22>/Add2' */
  t15_2_B.Add2 = t15_2_B.u99 - t15_2_B.e3;

  /* DataStoreRead: '<S22>/Data Store Read' */
  t15_2_B.DataStoreRead_k = t15_2_DWork.RupRd[1];

  /* Product: '<S22>/Product' */
  t15_2_B.Product = t15_2_B.Add2 / t15_2_B.DataStoreRead_k;
  ...
  /* End of Saturate: '<S22>/1 0' */

  /* Memory: '<S16>/Memory1' */
  t15_2_B.Memory1_k = t15_2_DWork.Memory1_PreviousInput_o;

  /* Switch: '<S16>/c_eob' */
  if (t15_2_B.u_n > t15_2_P.c_eob_Threshold_i) {
    for (i = 0; i < 500; i++) {
      /* DataStoreRead: '<S16>/Data Store Read1' */
      t15_2_B.DataStoreRead1_eot[i] = t15_2_DWork.scr_data[13 * i + 1];

      /* DataStoreRead: '<S16>/Data Store Read' */
      t15_2_B.DataStoreRead_lg[i] = t15_2_DWork.scr_data[13 * i];
    }

    /* Dynamic Look-Up Table Block: '<S16>/Ipref'
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.Ipref_l), &t15_2_B.DataStoreRead1_eot[0],
                         t15_2_B.e3, &t15_2_B.DataStoreRead_lg[0], 499U);
    t15_2_B.c_eob = t15_2_B.Ipref_l;
  } else {
  ...
  /* Level2 S-Function Block: '<S18>/S-Function1' (read_gaps) */
  {
  ...
  /* UnitDelay: '<S24>/UD' */
  t15_2_B.Uk1_f = t15_2_DWork.UD_DSTATE_j;
  ...
  if (t15_2_B.u_n > t15_2_P.c_eob_Threshold_k) {
    for (i = 0; i < 500; i++) {
      ...
      t15_2_B.DataStoreRead1_lj[i] = t15_2_DWork.scr_data[13 * i + 3];

      /* DataStoreRead: '<S28>/Data Store Read' */
      t15_2_B.DataStoreRead_bq[i] = t15_2_DWork.scr_data[13 * i];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.I1_br), &t15_2_B.DataStoreRead1_lj[0],
                         t15_2_B.e3, &t15_2_B.DataStoreRead_bq[0], 499U);
    t15_2_B.c_eob_b = t15_2_B.I1_br;
  } else {
  ...
  /* Sum: '<S19>/Add1' */
  t15_2_B.Add1_f = t15_2_B.e6_k[1] - t15_2_B.Divide1;

  /* Memory: '<S26>/Memory2' */
  t15_2_B.Memory2_e = t15_2_DWork.Memory2_PreviousInput_i;

  /* Switch: '<S26>/c_eob' */
  if (t15_2_B.u_n > t15_2_P.c_eob_Threshold_hp) {
    for (i = 0; i < 500; i++) {
      /* DataStoreRead: '<S26>/Data Store Read1' */
      t15_2_B.DataStoreRead1_gs[i] = t15_2_DWork.scr_data[13 * i + 11];
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.I1_e), &t15_2_B.DataStoreRead1_gs[0],
                         t15_2_B.e3, &t15_2_B.DataStoreRead_cm[0], 499U);
    t15_2_B.c_eob_n = t15_2_B.I1_e;
  } else {
    t15_2_B.c_eob_n = t15_2_B.Memory2_e;
  }

  /* End of Switch: '<S26>/c_eob' */

  /* Product: '<S26>/Divide1' */
  t15_2_B.Divide1_m = t15_2_B.c_eob_n * t15_2_B.u_n;

  /* Sum: '<S19>/Add10' */
  t15_2_B.Add10 = t15_2_B.e6_k[9] - t15_2_B.Divide1_m;

  /* Memory: '<S27>/Memory2' */
  t15_2_B.Memory2_ew = t15_2_DWork.Memory2_PreviousInput_k;

  /* Switch: '<S27>/c_eob' */
  if (t15_2_B.u_n > t15_2_P.c_eob_Threshold_e) {
    for (i = 0; i < 500; i++) {
      /* DataStoreRead: '<S27>/Data Store Read1' */
      t15_2_B.DataStoreRead1_lt[i] = t15_2_DWork.scr_data[13 * i + 12];

      /* DataStoreRead: '<S27>/Data Store Read' */
      t15_2_B.DataStoreRead_mt[i] = t15_2_DWork.scr_data[13 * i];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.I1_bx), &t15_2_B.DataStoreRead1_lt[0],
                         t15_2_B.e3, &t15_2_B.DataStoreRead_mt[0], 499U);
    t15_2_B.c_eob_p = t15_2_B.I1_bx;
  } else {
    t15_2_B.c_eob_p = t15_2_B.Memory2_ew;
  }

  /* End of Switch: '<S27>/c_eob' */

  /* Product: '<S27>/Divide1' */
  t15_2_B.Divide1_e = t15_2_B.c_eob_p * t15_2_B.u_n;

  /* Sum: '<S19>/Add11' */
  t15_2_B.Add11 = t15_2_B.e6_k[10] - t15_2_B.Divide1_e;

  /* Memory: '<S29>/Memory2' */
  t15_2_B.Memory2_i = t15_2_DWork.Memory2_PreviousInput_p;

  /* Switch: '<S29>/c_eob' */
  if (t15_2_B.u_n > t15_2_P.c_eob_Threshold_h0) {
    for (i = 0; i < 500; i++) {
      /* DataStoreRead: '<S29>/Data Store Read1' */
      t15_2_B.DataStoreRead1_c[i] = t15_2_DWork.scr_data[13 * i + 4];
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.I1_fe), &t15_2_B.DataStoreRead1_c[0],
                         t15_2_B.e3, &t15_2_B.DataStoreRead_o0[0], 499U);
    t15_2_B.c_eob_na = t15_2_B.I1_fe;
  } else {
    t15_2_B.c_eob_na = t15_2_B.Memory2_i;
  }

  /* End of Switch: '<S29>/c_eob' */

  /* Product: '<S29>/Divide1' */
  t15_2_B.Divide1_j = t15_2_B.c_eob_na * t15_2_B.u_n;

  /* Sum: '<S19>/Add2' */
  t15_2_B.Add2_i = t15_2_B.e6_k[2] - t15_2_B.Divide1_j;
  ...
  if (t15_2_B.u_n > t15_2_P.c_eob_Threshold_g) {
    for (i = 0; i < 500; i++) {
      ...
      t15_2_B.DataStoreRead1_i[i] = t15_2_DWork.scr_data[13 * i + 2];

      /* DataStoreRead: '<S25>/Data Store Read' */
      t15_2_B.DataStoreRead_j5[i] = t15_2_DWork.scr_data[13 * i];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.I1_j), &t15_2_B.DataStoreRead1_i[0],
                         t15_2_B.e3, &t15_2_B.DataStoreRead_j5[0], 499U);
    t15_2_B.c_eob_j = t15_2_B.I1_j;
  } else {
    t15_2_B.c_eob_j = t15_2_B.Memory2_g;
  }
  ...
  /* Sum: '<S19>/Add3' */
  t15_2_B.Add3_p = t15_2_B.e6_k[0] - t15_2_B.Divide1_d;

  /* Memory: '<S30>/Memory2' */
  t15_2_B.Memory2_eo = t15_2_DWork.Memory2_PreviousInput_id;

  /* Switch: '<S30>/c_eob' */
  if (t15_2_B.u_n > t15_2_P.c_eob_Threshold_p) {
    for (i = 0; i < 500; i++) {
      /* DataStoreRead: '<S30>/Data Store Read1' */
      t15_2_B.DataStoreRead1_k[i] = t15_2_DWork.scr_data[13 * i + 5];

      /* DataStoreRead: '<S30>/Data Store Read' */
      t15_2_B.DataStoreRead_pa[i] = t15_2_DWork.scr_data[13 * i];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.I1_f), &t15_2_B.DataStoreRead1_k[0],
                         t15_2_B.e3, &t15_2_B.DataStoreRead_pa[0], 499U);
    t15_2_B.c_eob_o = t15_2_B.I1_f;
  } else {
    t15_2_B.c_eob_o = t15_2_B.Memory2_eo;
  }

  /* End of Switch: '<S30>/c_eob' */

  /* Product: '<S30>/Divide1' */
  t15_2_B.Divide1_i = t15_2_B.c_eob_o * t15_2_B.u_n;

  /* Sum: '<S19>/Add4' */
  t15_2_B.Add4 = t15_2_B.e6_k[3] - t15_2_B.Divide1_i;

  /* Memory: '<S31>/Memory2' */
  t15_2_B.Memory2_p = t15_2_DWork.Memory2_PreviousInput_pz;

  /* Switch: '<S31>/c_eob' */
  if (t15_2_B.u_n > t15_2_P.c_eob_Threshold_pq) {
    for (i = 0; i < 500; i++) {
      /* DataStoreRead: '<S31>/Data Store Read1' */
      t15_2_B.DataStoreRead1_dm[i] = t15_2_DWork.scr_data[13 * i + 6];

      /* DataStoreRead: '<S31>/Data Store Read' */
      t15_2_B.DataStoreRead_ob[i] = t15_2_DWork.scr_data[13 * i];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.I1_d), &t15_2_B.DataStoreRead1_dm[0],
                         t15_2_B.e3, &t15_2_B.DataStoreRead_ob[0], 499U);
    t15_2_B.c_eob_nv = t15_2_B.I1_d;
  } else {
    t15_2_B.c_eob_nv = t15_2_B.Memory2_p;
  }

  /* End of Switch: '<S31>/c_eob' */

  /* Product: '<S31>/Divide1' */
  t15_2_B.Divide1_l = t15_2_B.c_eob_nv * t15_2_B.u_n;

  /* Sum: '<S19>/Add5' */
  t15_2_B.Add5 = t15_2_B.e6_k[4] - t15_2_B.Divide1_l;

  /* Memory: '<S32>/Memory2' */
  t15_2_B.Memory2_j = t15_2_DWork.Memory2_PreviousInput_h;

  /* Switch: '<S32>/c_eob' */
  if (t15_2_B.u_n > t15_2_P.c_eob_Threshold_ii) {
    for (i = 0; i < 500; i++) {
      /* DataStoreRead: '<S32>/Data Store Read1' */
      t15_2_B.DataStoreRead1_f[i] = t15_2_DWork.scr_data[13 * i + 7];

      /* DataStoreRead: '<S32>/Data Store Read' */
      t15_2_B.DataStoreRead_c1[i] = t15_2_DWork.scr_data[13 * i];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.I1_g), &t15_2_B.DataStoreRead1_f[0],
                         t15_2_B.e3, &t15_2_B.DataStoreRead_c1[0], 499U);
    t15_2_B.c_eob_h = t15_2_B.I1_g;
  } else {
    t15_2_B.c_eob_h = t15_2_B.Memory2_j;
  }

  /* End of Switch: '<S32>/c_eob' */

  /* Product: '<S32>/Divide1' */
  t15_2_B.Divide1_g = t15_2_B.c_eob_h * t15_2_B.u_n;

  /* Sum: '<S19>/Add6' */
  t15_2_B.Add6 = t15_2_B.e6_k[5] - t15_2_B.Divide1_g;

  /* Memory: '<S33>/Memory2' */
  t15_2_B.Memory2_f = t15_2_DWork.Memory2_PreviousInput_k4;

  /* Switch: '<S33>/c_eob' */
  if (t15_2_B.u_n > t15_2_P.c_eob_Threshold_gy) {
    for (i = 0; i < 500; i++) {
      /* DataStoreRead: '<S33>/Data Store Read1' */
      t15_2_B.DataStoreRead1_a[i] = t15_2_DWork.scr_data[13 * i + 8];
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.I1_l), &t15_2_B.DataStoreRead1_a[0],
                         t15_2_B.e3, &t15_2_B.DataStoreRead_g[0], 499U);
    t15_2_B.c_eob_pl = t15_2_B.I1_l;
  } else {
    t15_2_B.c_eob_pl = t15_2_B.Memory2_f;
  }

  /* End of Switch: '<S33>/c_eob' */

  /* Product: '<S33>/Divide1' */
  t15_2_B.Divide1_gn = t15_2_B.c_eob_pl * t15_2_B.u_n;

  /* Sum: '<S19>/Add7' */
  t15_2_B.Add7 = t15_2_B.e6_k[6] - t15_2_B.Divide1_gn;
  ...
  if (t15_2_B.u_n > t15_2_P.c_eob_Threshold_b) {
    for (i = 0; i < 500; i++) {
      ...
      t15_2_B.DataStoreRead1_oc[i] = t15_2_DWork.scr_data[13 * i + 9];

      /* DataStoreRead: '<S34>/Data Store Read' */
      t15_2_B.DataStoreRead_bh[i] = t15_2_DWork.scr_data[13 * i];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.I1_b), &t15_2_B.DataStoreRead1_oc[0],
                         t15_2_B.e3, &t15_2_B.DataStoreRead_bh[0], 499U);
    t15_2_B.c_eob_a = t15_2_B.I1_b;
  } else {
  ...
  /* Product: '<S34>/Divide1' */
  t15_2_B.Divide1_ih = t15_2_B.c_eob_a * t15_2_B.u_n;

  /* Sum: '<S19>/Add8' */
  t15_2_B.Add8 = t15_2_B.e6_k[7] - t15_2_B.Divide1_ih;

  /* Memory: '<S35>/Memory2' */
  t15_2_B.Memory2_a = t15_2_DWork.Memory2_PreviousInput_by;

  /* Switch: '<S35>/c_eob' */
  if (t15_2_B.u_n > t15_2_P.c_eob_Threshold_px) {
    for (i = 0; i < 500; i++) {
      /* DataStoreRead: '<S35>/Data Store Read1' */
      t15_2_B.DataStoreRead1_pc[i] = t15_2_DWork.scr_data[13 * i + 10];
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.I1), &t15_2_B.DataStoreRead1_pc[0],
                         t15_2_B.e3, &t15_2_B.DataStoreRead_hb[0], 499U);
    t15_2_B.c_eob_pr = t15_2_B.I1;
  } else {
    t15_2_B.c_eob_pr = t15_2_B.Memory2_a;
  }

  /* End of Switch: '<S35>/c_eob' */

  /* Product: '<S35>/Divide1' */
  t15_2_B.Divide1_a = t15_2_B.c_eob_pr * t15_2_B.u_n;

  /* Sum: '<S19>/Add9' */
  t15_2_B.Add9 = t15_2_B.e6_k[8] - t15_2_B.Divide1_a;

  /* Sum: '<S15>/Sum2' incorporates:
   *  Inport: '<Root>/In1'
   */
  t15_2_B.Sum2_k = t15_2_U.In1[5] - t15_2_U.In1[7];

  /* Switch: '<S15>/>=0' incorporates:
   *  Inport: '<Root>/In1'
   */
  if (t15_2_B.Sum2_k >= t15_2_P.u_Threshold) {
    t15_2_B.u_h = t15_2_U.In1[7];
  } else {
    t15_2_B.u_h = t15_2_U.In1[5];
  }

  /* End of Switch: '<S15>/>=0' */

  /* Gain: '<S20>/1e2' incorporates:
   *  Inport: '<Root>/In1'
   *  Inport: '<Root>/In2'
   */
  ...
  t15_2_B.e2[5] = t15_2_P.e2_Gain * t15_2_B.u_h;
  ...
  /* Memory: '<S41>/Memory2' */
  t15_2_B.Memory2_d = t15_2_DWork.Memory2_PreviousInput_n;
  ...
  if (t15_2_B.u_n > t15_2_P.c_eob1_Threshold) {
    ...
    /* Dynamic Look-Up Table Block: '<S41>/g1ref'
     * Input0  Data Type:  Floating Point real_T
     * Input1  Data Type:  Floating Point real_T
     * Input2  Data Type:  Floating Point real_T
     * Output0 Data Type:  Floating Point real_T
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.g1ref), &t15_2_B.Selector_p[0], t15_2_B.e3,
                         &t15_2_B.Selector1_j[0], 49U);
    t15_2_B.c_eob1 = t15_2_B.g1ref;
  } else {
    t15_2_B.c_eob1 = t15_2_B.Memory2_d;
  }

  /* End of Switch: '<S41>/c_eob  1' */

  /* Memory: '<S41>/Memory1' */
  t15_2_B.Memory1_j = t15_2_DWork.Memory1_PreviousInput_e;

  /* Switch: '<S41>/c_eob  ' */
  if (t15_2_B.u_n > t15_2_P.c_eob_Threshold_ie) {
    t15_2_B.c_eob_nav = t15_2_B.e3;
  } else {
    t15_2_B.c_eob_nav = t15_2_B.Memory1_j;
  }
  ...
  if (t15_2_B.u_n > t15_2_P.c_eob_Threshold_j) {
    ...
    /* SignalConversion: '<S47>/TmpSignal ConversionAtg1_term,refInport3' */
    t15_2_B.TmpSignalConversionAtg1_termref[0] = t15_2_B.c_eob1;
    for (i = 0; i < 49; i++) {
      /* Selector: '<S47>/Selector' */
      t15_2_B.Selector_n[i] = t15_2_B.SFunction1_i[((1 + i) << 1) + 1];
      t15_2_B.TmpSignalConversionAtg1_termref[i + 1] = t15_2_B.Selector_n[i];
    }

    /* End of SignalConversion: '<S47>/TmpSignal ConversionAtg1_term,refInport3' */

    /* DataStoreRead: '<S47>/Data Store Read' */
    t15_2_B.DataStoreRead_mj = t15_2_DWork.RupRd[1];
    for (i = 0; i < 50; i++) {
      /* Selector: '<S47>/Selector1' */
      t15_2_B.Selector1_a[i] = t15_2_B.SFunction1_i[i << 1];

      /* Product: '<S47>/Divide6' incorporates:
       *  Constant: '<S47>/Constant'
       */
      t15_2_B.Divide6_pd[i] = t15_2_B.Selector1_a[i] * t15_2_B.DataStoreRead_mj /
        t15_2_P.Constant_Value_mf;

      /* Sum: '<S47>/Add2' */
      t15_2_B.Add2_f[i] = t15_2_B.c_eob_nav + t15_2_B.Divide6_pd[i];
    }

    /* Dynamic Look-Up Table Block: '<S47>/g1_term,ref'
     * Input0  Data Type:  Floating Point real_T
     * Input1  Data Type:  Floating Point real_T
     * Input2  Data Type:  Floating Point real_T
     * Output0 Data Type:  Floating Point real_T
  ...
  /* Sum: '<S20>/Add2' */
  t15_2_B.Add2_k = t15_2_B.e2[0] - t15_2_B.c_eob_k;

  /* Lookup: '<S20>/Lookup Table1'
   * About '<S20>/Lookup Table1':
   * Input0  Data Type:  Floating Point real_T
   * Output0 Data Type:  Floating Point real_T
   * Lookup Method: Linear_Endpoint
   *
  ...
  /* Product: '<S20>/Divide6' */
  t15_2_B.Divide6_m = t15_2_B.Add2_k * t15_2_B.LookupTable1;

  /* Level2 S-Function Block: '<S36>/S-Function1' (read_gaps) */
  {
  ...
  /* Memory: '<S36>/Memory2' */
  t15_2_B.Memory2_j1 = t15_2_DWork.Memory2_PreviousInput_g;

  /* Switch: '<S36>/c_eob  1' */
  if (t15_2_B.u_n > t15_2_P.c_eob1_Threshold_p) {
    for (i = 0; i < 50; i++) {
      /* Selector: '<S36>/Selector' */
      t15_2_B.Selector_pi[i] = t15_2_B.SFunction1_od[(i << 1) + 1];

      /* Selector: '<S36>/Selector1' */
      t15_2_B.Selector1_i1[i] = t15_2_B.SFunction1_od[i << 1];
    }

    /* Dynamic Look-Up Table Block: '<S36>/g2ref'
     * Input0  Data Type:  Floating Point real_T
     * Input1  Data Type:  Floating Point real_T
     * Input2  Data Type:  Floating Point real_T
     * Output0 Data Type:  Floating Point real_T
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.g2ref), &t15_2_B.Selector_pi[0], t15_2_B.e3,
                         &t15_2_B.Selector1_i1[0], 49U);
    t15_2_B.c_eob1_c = t15_2_B.g2ref;
  } else {
    t15_2_B.c_eob1_c = t15_2_B.Memory2_j1;
  }

  /* End of Switch: '<S36>/c_eob  1' */

  /* Memory: '<S36>/Memory1' */
  t15_2_B.Memory1_e = t15_2_DWork.Memory1_PreviousInput_k;

  /* Switch: '<S36>/c_eob  ' */
  if (t15_2_B.u_n > t15_2_P.c_eob_Threshold_n) {
    t15_2_B.c_eob_l = t15_2_B.e3;
  } else {
    t15_2_B.c_eob_l = t15_2_B.Memory1_e;
  }

  /* End of Switch: '<S36>/c_eob  ' */

  /* Level2 S-Function Block: '<S42>/S-Function1' (read_gaps_term) */
  {
  ...
  /* Switch: '<S36>/c_eob' */
  if (t15_2_B.u_n > t15_2_P.c_eob_Threshold_jx) {
    t15_2_B.c_eob_nr = t15_2_B.c_eob1_c;
  } else {
    /* SignalConversion: '<S42>/TmpSignal ConversionAtg2_term,refInport3' */
    t15_2_B.TmpSignalConversionAtg2_termref[0] = t15_2_B.c_eob1_c;
    for (i = 0; i < 49; i++) {
      /* Selector: '<S42>/Selector' */
      t15_2_B.Selector_d[i] = t15_2_B.SFunction1_gp[((1 + i) << 1) + 1];
      t15_2_B.TmpSignalConversionAtg2_termref[i + 1] = t15_2_B.Selector_d[i];
    }

    /* End of SignalConversion: '<S42>/TmpSignal ConversionAtg2_term,refInport3' */

    /* DataStoreRead: '<S42>/Data Store Read' */
    t15_2_B.DataStoreRead_nz = t15_2_DWork.RupRd[1];
    for (i = 0; i < 50; i++) {
      /* Selector: '<S42>/Selector1' */
      t15_2_B.Selector1_gy[i] = t15_2_B.SFunction1_gp[i << 1];

      /* Product: '<S42>/Divide6' incorporates:
       *  Constant: '<S42>/Constant'
       */
      t15_2_B.Divide6_a[i] = t15_2_B.Selector1_gy[i] * t15_2_B.DataStoreRead_nz /
        t15_2_P.Constant_Value;

      /* Sum: '<S42>/Add2' */
      t15_2_B.Add2_e[i] = t15_2_B.c_eob_l + t15_2_B.Divide6_a[i];
    }

    /* Dynamic Look-Up Table Block: '<S42>/g2_term,ref'
     * Input0  Data Type:  Floating Point real_T
     * Input1  Data Type:  Floating Point real_T
     * Input2  Data Type:  Floating Point real_T
     * Output0 Data Type:  Floating Point real_T
    ...
    t15_2_B.c_eob_nr = t15_2_B.g2_termref;
  }

  /* End of Switch: '<S36>/c_eob' */

  /* Sum: '<S20>/Add1' */
  t15_2_B.Add1_o = t15_2_B.e2[1] - t15_2_B.c_eob_nr;

  /* Lookup: '<S20>/Lookup Table2'
   * About '<S20>/Lookup Table2':
   * Input0  Data Type:  Floating Point real_T
   * Output0 Data Type:  Floating Point real_T
   * Lookup Method: Linear_Endpoint
   *
  ...
  /* Product: '<S20>/Divide1' */
  t15_2_B.Divide1_me = t15_2_B.Add1_o * t15_2_B.LookupTable2;
  ...
  /* Memory: '<S37>/Memory2' */
  t15_2_B.Memory2_gn = t15_2_DWork.Memory2_PreviousInput_i0;
  ...
  if (t15_2_B.u_n > t15_2_P.c_eob1_Threshold_l) {
    for (i = 0; i < 50; i++) {
      ...
      t15_2_B.Selector1_n[i] = t15_2_B.SFunction1_l[i << 1];
    }

    /* Dynamic Look-Up Table Block: '<S37>/g3ref'
     * Input0  Data Type:  Floating Point real_T
     * Input1  Data Type:  Floating Point real_T
     * Input2  Data Type:  Floating Point real_T
     * Output0 Data Type:  Floating Point real_T
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.g3ref), &t15_2_B.Selector_m[0], t15_2_B.e3,
                         &t15_2_B.Selector1_n[0], 49U);
    t15_2_B.c_eob1_g = t15_2_B.g3ref;
  } else {
    t15_2_B.c_eob1_g = t15_2_B.Memory2_gn;
  }

  /* End of Switch: '<S37>/c_eob  1' */

  /* Memory: '<S37>/Memory1' */
  t15_2_B.Memory1_i = t15_2_DWork.Memory1_PreviousInput_a;

  /* Switch: '<S37>/c_eob  ' */
  if (t15_2_B.u_n > t15_2_P.c_eob_Threshold_g1) {
    t15_2_B.c_eob_g = t15_2_B.e3;
  } else {
    t15_2_B.c_eob_g = t15_2_B.Memory1_i;
  }
  ...
  if (t15_2_B.u_n > t15_2_P.c_eob_Threshold_l) {
    t15_2_B.c_eob_bn = t15_2_B.c_eob1_g;
  } else {
    /* SignalConversion: '<S43>/TmpSignal ConversionAtg3_term,refInport3' */
    t15_2_B.TmpSignalConversionAtg3_termref[0] = t15_2_B.c_eob1_g;
    for (i = 0; i < 49; i++) {
      /* Selector: '<S43>/Selector' */
      t15_2_B.Selector_l[i] = t15_2_B.SFunction1_n[((1 + i) << 1) + 1];
      t15_2_B.TmpSignalConversionAtg3_termref[i + 1] = t15_2_B.Selector_l[i];
    }

    /* End of SignalConversion: '<S43>/TmpSignal ConversionAtg3_term,refInport3' */

    /* DataStoreRead: '<S43>/Data Store Read' */
    t15_2_B.DataStoreRead_hf = t15_2_DWork.RupRd[1];
    for (i = 0; i < 50; i++) {
      /* Selector: '<S43>/Selector1' */
      t15_2_B.Selector1_h[i] = t15_2_B.SFunction1_n[i << 1];

      /* Product: '<S43>/Divide6' incorporates:
       *  Constant: '<S43>/Constant'
       */
      t15_2_B.Divide6_d[i] = t15_2_B.Selector1_h[i] * t15_2_B.DataStoreRead_hf /
        t15_2_P.Constant_Value_o;

      /* Sum: '<S43>/Add2' */
      t15_2_B.Add2_b[i] = t15_2_B.c_eob_g + t15_2_B.Divide6_d[i];
    }

    /* Dynamic Look-Up Table Block: '<S43>/g3_term,ref'
     * Input0  Data Type:  Floating Point real_T
     * Input1  Data Type:  Floating Point real_T
     * Input2  Data Type:  Floating Point real_T
     * Output0 Data Type:  Floating Point real_T
    ...
    LookUp_real_T_real_T( &(t15_2_B.g3_termref),
                         ...
                         &t15_2_B.Add2_b[0], 49U);
    t15_2_B.c_eob_bn = t15_2_B.g3_termref;
  }

  /* End of Switch: '<S37>/c_eob' */

  /* Sum: '<S20>/Add3' */
  t15_2_B.Add3_l = t15_2_B.e2[2] - t15_2_B.c_eob_bn;
  ...
  /* Memory: '<S38>/Memory2' */
  t15_2_B.Memory2_h = t15_2_DWork.Memory2_PreviousInput_a;

  /* Switch: '<S38>/c_eob  1' */
  if (t15_2_B.u_n > t15_2_P.c_eob1_Threshold_d) {
    for (i = 0; i < 50; i++) {
      /* Selector: '<S38>/Selector' */
      t15_2_B.Selector_j[i] = t15_2_B.SFunction1_oi[(i << 1) + 1];

      /* Selector: '<S38>/Selector1' */
      t15_2_B.Selector1_e[i] = t15_2_B.SFunction1_oi[i << 1];
    }

    /* Dynamic Look-Up Table Block: '<S38>/g4ref'
     * Input0  Data Type:  Floating Point real_T
     * Input1  Data Type:  Floating Point real_T
     * Input2  Data Type:  Floating Point real_T
     * Output0 Data Type:  Floating Point real_T
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.g4ref), &t15_2_B.Selector_j[0], t15_2_B.e3,
                         &t15_2_B.Selector1_e[0], 49U);
    t15_2_B.c_eob1_cr = t15_2_B.g4ref;
  } else {
    t15_2_B.c_eob1_cr = t15_2_B.Memory2_h;
  }

  /* End of Switch: '<S38>/c_eob  1' */

  /* Memory: '<S38>/Memory1' */
  t15_2_B.Memory1_a = t15_2_DWork.Memory1_PreviousInput_f;

  /* Switch: '<S38>/c_eob  ' */
  if (t15_2_B.u_n > t15_2_P.c_eob_Threshold_f) {
    t15_2_B.c_eob_hb = t15_2_B.e3;
  } else {
    t15_2_B.c_eob_hb = t15_2_B.Memory1_a;
  }
  ...
  /* Switch: '<S38>/c_eob' */
  if (t15_2_B.u_n > t15_2_P.c_eob_Threshold_bb) {
    t15_2_B.c_eob_i = t15_2_B.c_eob1_cr;
  } else {
    /* SignalConversion: '<S44>/TmpSignal ConversionAtg4_term,refInport3' */
    t15_2_B.TmpSignalConversionAtg4_termref[0] = t15_2_B.c_eob1_cr;
    for (i = 0; i < 49; i++) {
      /* Selector: '<S44>/Selector' */
      t15_2_B.Selector_a[i] = t15_2_B.SFunction1_j[((1 + i) << 1) + 1];
      t15_2_B.TmpSignalConversionAtg4_termref[i + 1] = t15_2_B.Selector_a[i];
    }

    /* End of SignalConversion: '<S44>/TmpSignal ConversionAtg4_term,refInport3' */

    /* DataStoreRead: '<S44>/Data Store Read' */
    t15_2_B.DataStoreRead_jc = t15_2_DWork.RupRd[1];
    for (i = 0; i < 50; i++) {
      /* Selector: '<S44>/Selector1' */
      t15_2_B.Selector1_k[i] = t15_2_B.SFunction1_j[i << 1];

      /* Product: '<S44>/Divide6' incorporates:
       *  Constant: '<S44>/Constant'
       */
      t15_2_B.Divide6_g[i] = t15_2_B.Selector1_k[i] * t15_2_B.DataStoreRead_jc /
        t15_2_P.Constant_Value_m;

      /* Sum: '<S44>/Add2' */
      t15_2_B.Add2_h[i] = t15_2_B.c_eob_hb + t15_2_B.Divide6_g[i];
    }

    /* Dynamic Look-Up Table Block: '<S44>/g4_term,ref'
     * Input0  Data Type:  Floating Point real_T
     * Input1  Data Type:  Floating Point real_T
     * Input2  Data Type:  Floating Point real_T
     * Output0 Data Type:  Floating Point real_T
  ...
  /* Sum: '<S20>/Add4' */
  t15_2_B.Add4_e = t15_2_B.e2[3] - t15_2_B.c_eob_i;

  /* Lookup: '<S20>/Lookup Table3'
   * About '<S20>/Lookup Table3':
   * Input0  Data Type:  Floating Point real_T
   * Output0 Data Type:  Floating Point real_T
   * Lookup Method: Linear_Endpoint
   *
  ...
  /* Product: '<S20>/Divide2' */
  t15_2_B.Divide2 = t15_2_B.Add4_e * t15_2_B.LookupTable3;
  ...
  /* Switch: '<S39>/c_eob  1' */
  if (t15_2_B.u_n > t15_2_P.c_eob1_Threshold_i) {
    for (i = 0; i < 50; i++) {
      /* Selector: '<S39>/Selector' */
      t15_2_B.Selector_ny[i] = t15_2_B.SFunction1_a[(i << 1) + 1];

      /* Selector: '<S39>/Selector1' */
      t15_2_B.Selector1_g[i] = t15_2_B.SFunction1_a[i << 1];
    }

    /* Dynamic Look-Up Table Block: '<S39>/g5ref'
     * Input0  Data Type:  Floating Point real_T
     * Input1  Data Type:  Floating Point real_T
     * Input2  Data Type:  Floating Point real_T
     * Output0 Data Type:  Floating Point real_T
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.g5ref), &t15_2_B.Selector_ny[0], t15_2_B.e3,
                         &t15_2_B.Selector1_g[0], 49U);
    t15_2_B.c_eob1_k = t15_2_B.g5ref;
  } else {
    t15_2_B.c_eob1_k = t15_2_B.Memory2_o;
  }

  /* End of Switch: '<S39>/c_eob  1' */

  /* Memory: '<S39>/Memory1' */
  t15_2_B.Memory1_o = t15_2_DWork.Memory1_PreviousInput_n;

  /* Switch: '<S39>/c_eob  ' */
  if (t15_2_B.u_n > t15_2_P.c_eob_Threshold_a) {
    t15_2_B.c_eob_k0 = t15_2_B.e3;
  } else {
    t15_2_B.c_eob_k0 = t15_2_B.Memory1_o;
  }
  ...
  /* Switch: '<S39>/c_eob' */
  if (t15_2_B.u_n > t15_2_P.c_eob_Threshold_fx) {
    t15_2_B.c_eob_lw = t15_2_B.c_eob1_k;
  } else {
    /* SignalConversion: '<S45>/TmpSignal ConversionAtg5_term,refInport3' */
    t15_2_B.TmpSignalConversionAtg5_termref[0] = t15_2_B.c_eob1_k;
    for (i = 0; i < 49; i++) {
      /* Selector: '<S45>/Selector' */
      t15_2_B.Selector_pl[i] = t15_2_B.SFunction1_b[((1 + i) << 1) + 1];
      t15_2_B.TmpSignalConversionAtg5_termref[i + 1] = t15_2_B.Selector_pl[i];
    }

    /* End of SignalConversion: '<S45>/TmpSignal ConversionAtg5_term,refInport3' */

    /* DataStoreRead: '<S45>/Data Store Read' */
    t15_2_B.DataStoreRead_bl = t15_2_DWork.RupRd[1];
    for (i = 0; i < 50; i++) {
      /* Selector: '<S45>/Selector1' */
      t15_2_B.Selector1_ao[i] = t15_2_B.SFunction1_b[i << 1];

      /* Product: '<S45>/Divide6' incorporates:
       *  Constant: '<S45>/Constant'
       */
      t15_2_B.Divide6_c[i] = t15_2_B.Selector1_ao[i] * t15_2_B.DataStoreRead_bl /
        t15_2_P.Constant_Value_g;

      /* Sum: '<S45>/Add2' */
      t15_2_B.Add2_m[i] = t15_2_B.c_eob_k0 + t15_2_B.Divide6_c[i];
    }

    /* Dynamic Look-Up Table Block: '<S45>/g5_term,ref'
     * Input0  Data Type:  Floating Point real_T
     * Input1  Data Type:  Floating Point real_T
     * Input2  Data Type:  Floating Point real_T
     * Output0 Data Type:  Floating Point real_T
    ...
    LookUp_real_T_real_T( &(t15_2_B.g5_termref),
                         ...
                         &t15_2_B.Add2_m[0], 49U);
    t15_2_B.c_eob_lw = t15_2_B.g5_termref;
  }

  /* End of Switch: '<S39>/c_eob' */

  /* Sum: '<S20>/Add5' */
  t15_2_B.Add5_f = t15_2_B.e2[4] - t15_2_B.c_eob_lw;
  ...
  /* Memory: '<S40>/Memory2' */
  t15_2_B.Memory2_kq = t15_2_DWork.Memory2_PreviousInput_on;

  /* Switch: '<S40>/c_eob  1' */
  if (t15_2_B.u_n > t15_2_P.c_eob1_Threshold_dy) {
    for (i = 0; i < 50; i++) {
      /* Selector: '<S40>/Selector' */
      t15_2_B.Selector_g[i] = t15_2_B.SFunction1_p[(i << 1) + 1];

      /* Selector: '<S40>/Selector1' */
      t15_2_B.Selector1_i[i] = t15_2_B.SFunction1_p[i << 1];
    }

    /* Dynamic Look-Up Table Block: '<S40>/g6ref'
     * Input0  Data Type:  Floating Point real_T
     * Input1  Data Type:  Floating Point real_T
     * Input2  Data Type:  Floating Point real_T
     * Output0 Data Type:  Floating Point real_T
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.g6ref), &t15_2_B.Selector_g[0], t15_2_B.e3,
                         &t15_2_B.Selector1_i[0], 49U);
    t15_2_B.c_eob1_ky = t15_2_B.g6ref;
  } else {
    t15_2_B.c_eob1_ky = t15_2_B.Memory2_kq;
  }

  /* End of Switch: '<S40>/c_eob  1' */

  /* Memory: '<S40>/Memory1' */
  t15_2_B.Memory1_f = t15_2_DWork.Memory1_PreviousInput_oz;

  /* Switch: '<S40>/c_eob  ' */
  if (t15_2_B.u_n > t15_2_P.c_eob_Threshold_m) {
    t15_2_B.c_eob_ks = t15_2_B.e3;
  } else {
    t15_2_B.c_eob_ks = t15_2_B.Memory1_f;
  }
  ...
  /* Switch: '<S40>/c_eob' */
  if (t15_2_B.u_n > t15_2_P.c_eob_Threshold_k2) {
    t15_2_B.c_eob_ij = t15_2_B.c_eob1_ky;
  } else {
    /* SignalConversion: '<S46>/TmpSignal ConversionAtg6_term,refInport3' */
    t15_2_B.TmpSignalConversionAtg6_termref[0] = t15_2_B.c_eob1_ky;
    for (i = 0; i < 49; i++) {
      /* Selector: '<S46>/Selector' */
      t15_2_B.Selector_e[i] = t15_2_B.SFunction1_aw[((1 + i) << 1) + 1];
      t15_2_B.TmpSignalConversionAtg6_termref[i + 1] = t15_2_B.Selector_e[i];
    }

    /* End of SignalConversion: '<S46>/TmpSignal ConversionAtg6_term,refInport3' */

    /* DataStoreRead: '<S46>/Data Store Read' */
    t15_2_B.DataStoreRead_mo = t15_2_DWork.RupRd[1];
    for (i = 0; i < 50; i++) {
      /* Selector: '<S46>/Selector1' */
      t15_2_B.Selector1_o[i] = t15_2_B.SFunction1_aw[i << 1];

      /* Product: '<S46>/Divide6' incorporates:
       *  Constant: '<S46>/Constant'
       */
      t15_2_B.Divide6_o[i] = t15_2_B.Selector1_o[i] * t15_2_B.DataStoreRead_mo /
        t15_2_P.Constant_Value_h;

      /* Sum: '<S46>/Add2' */
      t15_2_B.Add2_c[i] = t15_2_B.c_eob_ks + t15_2_B.Divide6_o[i];
    }

    /* Dynamic Look-Up Table Block: '<S46>/g6_term,ref'
     * Input0  Data Type:  Floating Point real_T
     * Input1  Data Type:  Floating Point real_T
     * Input2  Data Type:  Floating Point real_T
     * Output0 Data Type:  Floating Point real_T
    ...
    LookUp_real_T_real_T( &(t15_2_B.g6_termref),
                         ...
                         &t15_2_B.Add2_c[0], 49U);
    t15_2_B.c_eob_ij = t15_2_B.g6_termref;
  }

  /* End of Switch: '<S40>/c_eob' */

  /* Sum: '<S20>/Add6' */
  t15_2_B.Add6_i = t15_2_B.e2[5] - t15_2_B.c_eob_ij;

  /* Gain: '<S20>/1e-2' */
  t15_2_B.e2_d[0] = t15_2_P.e2_Gain_a * t15_2_B.Divide6_m;
  t15_2_B.e2_d[1] = t15_2_P.e2_Gain_a * t15_2_B.Divide1_me;
  t15_2_B.e2_d[2] = t15_2_P.e2_Gain_a * t15_2_B.Add3_l;
  t15_2_B.e2_d[3] = t15_2_P.e2_Gain_a * t15_2_B.Divide2;
  t15_2_B.e2_d[4] = t15_2_P.e2_Gain_a * t15_2_B.Add5_f;
  t15_2_B.e2_d[5] = t15_2_P.e2_Gain_a * t15_2_B.Add6_i;

  /* RelationalOperator: '<S48>/Compare' incorporates:
   *  Constant: '<S48>/Constant'
   */
  t15_2_B.Compare = (uint8_T)(t15_2_B.e6 > t15_2_P.Constant_Value_l);

  /* DataStoreRead: '<S21>/Data Store Read' */
  t15_2_B.DataStoreRead_h = t15_2_DWork.RupRd[0];

  /* RelationalOperator: '<S21>/Relational Operator' */
  t15_2_B.RelationalOperator_n = (t15_2_B.e3 > t15_2_B.DataStoreRead_h);

  /* Logic: '<S21>/Logical Operator1' */
  t15_2_B.LogicalOperator1 = ((t15_2_B.Compare != 0) ||
    t15_2_B.RelationalOperator_n);

  /* Switch: '<S21>/0.99' incorporates:
   *  Constant: '<S13>/Constant4'
   */
  if (t15_2_B.LogicalOperator1 >= t15_2_P.u9_Threshold) {
    for (i = 0; i < 6; i++) {
      t15_2_B.u9[i] = t15_2_B.e2_d[i];
    }

    t15_2_B.u9[6] = t15_2_P.Constant4_Value_h;
    t15_2_B.u9[7] = t15_2_B.Add1_a;
    t15_2_B.u9[8] = t15_2_B.Add3_p;
    t15_2_B.u9[9] = t15_2_B.Add1_f;
    t15_2_B.u9[10] = t15_2_B.Add2_i;
    ...
    t15_2_B.u9[19] = t15_2_P.Constant4_Value_h;
  } else {
    for (i = 0; i < 50; i++) {
      /* Selector: '<S18>/Selector' */
      t15_2_B.Selector[i] = t15_2_B.SFunction1_g[(i << 1) + 1];

      /* Selector: '<S18>/Selector1' */
      t15_2_B.Selector1[i] = t15_2_B.SFunction1_g[i << 1];
    }

    /* Dynamic Look-Up Table Block: '<S18>/elong'
     * Input0  Data Type:  Floating Point real_T
     * Input1  Data Type:  Floating Point real_T
     * Input2  Data Type:  Floating Point real_T
     * Output0 Data Type:  Floating Point real_T
    ...
    /* Gain: '<S13>/k_gaplim' */
    t15_2_B.k_gaplim[0] = t15_2_P.k_gaplim_Gain[0] * t15_2_B.e2_d[2];
    t15_2_B.k_gaplim[1] = t15_2_P.k_gaplim_Gain[1] * t15_2_B.e2_d[3];
    t15_2_B.k_gaplim[2] = t15_2_P.k_gaplim_Gain[2] * t15_2_B.e2_d[4];
    t15_2_B.k_gaplim[3] = t15_2_P.k_gaplim_Gain[3] * t15_2_B.e2_d[5];
    t15_2_B.u9[0] = t15_2_B.Add2_g;
    t15_2_B.u9[1] = t15_2_P.Constant4_Value_h;
  ...
  /* End of Switch: '<S21>/0.99' */

  /* Gain: '<S22>/1e6' */
  t15_2_B.e6_a = t15_2_P.e6_Gain_d * t15_2_B.Add2;
   ...
   */
  t15_2_B.Compare_m = (uint8_T)(t15_2_B.e6 > t15_2_P.Constant_Value_p);

  /* DataStoreRead: '<S66>/Data Store Read' */
  t15_2_B.DataStoreRead_m = t15_2_DWork.RupRd[0];

  /* RelationalOperator: '<S66>/Relational Operator' */
  t15_2_B.RelationalOperator_e = (t15_2_B.e3 > t15_2_B.DataStoreRead_m);

  /* Logic: '<S49>/Logical Operator1' */
  t15_2_B.LogicalOperator1_k = ((t15_2_B.Compare_m != 0) ||
    t15_2_B.RelationalOperator_e);

  /* Switch: '<S49>/0.9999' */
  if (t15_2_B.LogicalOperator1_k > t15_2_P.u999_Threshold) {
    t15_2_B.u999 = t15_2_B.Memory3;
  } else {
    t15_2_B.u999 = t15_2_B.e3;
  }

  /* End of Switch: '<S49>/0.9999' */

  /* Sum: '<S49>/Subtract2' */
  t15_2_B.Subtract2 = t15_2_B.e3 - t15_2_B.u999;

  /* Gain: '<S49>/Gain1' */
  t15_2_B.Gain1 = t15_2_P.Gain1_Gain_k * t15_2_B.Subtract2;
  ...
  /* Memory: '<S50>/Memory1' */
  t15_2_B.Memory1_ab = t15_2_DWork.Memory1_PreviousInput_kn;
  ...
  t15_2_B.DataStoreRead_b = t15_2_DWork.RupRd[0];

  /* RelationalOperator: '<S68>/Relational Operator' */
  t15_2_B.RelationalOperator_l = (t15_2_B.e3 > t15_2_B.DataStoreRead_b);
  ...
  /* Switch: '<S50>/0.9999' */
  if (t15_2_B.LogicalOperator2 > t15_2_P.u999_Threshold_c) {
    t15_2_B.u999_a = t15_2_B.Memory1_ab;
  } else {
    t15_2_B.u999_a = t15_2_B.e3;
  }

  /* End of Switch: '<S50>/0.9999' */

  /* Sum: '<S50>/Subtract2' */
  t15_2_B.Subtract2_n = t15_2_B.e3 - t15_2_B.u999_a;

  /* Gain: '<S50>/Gain1' */
  t15_2_B.Gain1_h = t15_2_P.Gain1_Gain_n * t15_2_B.Subtract2_n;

  /* Sum: '<S50>/Subtract3' incorporates:
   *  Constant: '<S50>/1'
   */
  t15_2_B.Subtract3 = t15_2_B.Gain1_h + t15_2_P._Value_m;

  /* Saturate: '<S50>/Saturation' */
  tmin = t15_2_B.Subtract3;
  u = t15_2_P.Saturation_LowerSat_b;
   ...
   *  Constant: '<S50>/1'
   */
  t15_2_B.Subtract1_p = t15_2_P._Value_m - t15_2_B.Saturation;

  /* Sum: '<S50>/Subtract4' incorporates:
   *  Constant: '<S50>/1'
   */
  t15_2_B.Subtract4 = t15_2_P._Value_m - t15_2_B.LogicalOperator2;

  /* DataStoreRead: '<S51>/Data Store Read1' */
  t15_2_B.DataStoreRead1_m = t15_2_DWork.c_cur_max;

  /* DataStoreRead: '<S60>/Data Store Read' */
  t15_2_B.DataStoreRead_d = t15_2_DWork.RupRd[2];

  /* Abs: '<S60>/Abs' */
  t15_2_B.Abs_d = fabs(t15_2_B.DataStoreRead_d);

  /* RelationalOperator: '<S60>/Relational Operator' */
  t15_2_B.RelationalOperator_b = (t15_2_B.e6 < t15_2_B.Abs_d);

  /* DataStoreRead: '<S60>/Data Store Read1' */
  t15_2_B.DataStoreRead1_p = t15_2_DWork.RupRd[0];

  /* RelationalOperator: '<S60>/Relational Operator1' */
  t15_2_B.RelationalOperator1_l = (t15_2_B.e3 > t15_2_B.DataStoreRead1_p);

  /* Logic: '<S60>/Logical Operator2' */
  t15_2_B.LogicalOperator2_o = (t15_2_B.RelationalOperator_b &&
    t15_2_B.RelationalOperator1_l);
  for (i = 0; i < 11; i++) {
    /* Gain: '<S51>/1e3' */
    t15_2_B.e3_h[i] = t15_2_P.e3_Gain_a2 * t15_2_B.e6_k[i];

    /* Abs: '<S51>/Abs' */
    t15_2_B.Abs_h[i] = fabs(t15_2_B.e3_h[i]);

    /* DataStoreRead: '<S14>/Data Store Read1' */
    t15_2_B.DataStoreRead1_o[i] = t15_2_DWork.Imax[i];

    /* DataStoreRead: '<S51>/Data Store Read2' */
    t15_2_B.DataStoreRead2_d[i] = t15_2_DWork.ntur[i];

    /* Product: '<S51>/Divide5' */
    t15_2_B.Divide5[i] = t15_2_B.DataStoreRead1_o[i] *
      t15_2_B.DataStoreRead2_d[i];

    /* Sum: '<S51>/Sum2' */
    t15_2_B.Sum2_i[i] = t15_2_B.Divide5[i] - t15_2_B.Abs_h[i];

    /* Product: '<S51>/Divide3' */
    t15_2_B.Divide3[i] = t15_2_B.Divide5[i] * t15_2_B.DataStoreRead1_m;
    ...
    /* Product: '<S51>/Divide1' */
    t15_2_B.Divide1_ej[i] = t15_2_B.Divide4[i] * t15_2_B.Divide4[i] *
      t15_2_B.Divide4[i];

    /* Saturate: '<S51>/Saturation' */
    tmin = t15_2_B.Divide1_ej[i];
    u = t15_2_P.Saturation_LowerSat_f;
    u_0 = t15_2_P.Saturation_UpperSat_p;
    if (tmin >= u_0) {
      tmin = u_0;
    } else {
      if (tmin <= u) {
     ...
     */
    t15_2_B.Compare_l[i] = (uint8_T)(t15_2_B.Saturation_f[i] <
      t15_2_P.Constant_Value_lf);

    /* Memory: '<S60>/Memory1' */
    t15_2_B.Memory1_h[i] = t15_2_DWork.Memory1_PreviousInput_d[i];
   ...
   */
  t15_2_B.Compare_p = (uint8_T)(t15_2_B.e6 < t15_2_P.Constant_Value_lk);

  /* DataStoreRead: '<S74>/Data Store Read' */
  t15_2_B.DataStoreRead_hn = t15_2_DWork.RupRd[0];

  /* RelationalOperator: '<S74>/Relational Operator' */
  t15_2_B.RelationalOperator_la = (t15_2_B.e3 > t15_2_B.DataStoreRead_hn);

  /* DataStoreRead: '<S61>/Data Store Read1' */
  t15_2_B.DataStoreRead1_d = t15_2_DWork.RupRd[2];

  /* Abs: '<S61>/Abs' */
  t15_2_B.Abs_o = fabs(t15_2_B.DataStoreRead1_d);

  /* RelationalOperator: '<S61>/Relational Operator' */
  t15_2_B.RelationalOperator_h = (t15_2_B.e6 > t15_2_B.Abs_o);

  /* Logic: '<S61>/Logical Operator1' */
  t15_2_B.LogicalOperator1_m = ((t15_2_B.Compare_p != 0) &&
    t15_2_B.RelationalOperator_la && t15_2_B.RelationalOperator_h);

  /* Product: '<S14>/Divide2' */
  for (i = 0; i < 20; i++) {
    t15_2_B.Divide2_f[i] = t15_2_B.LogicalOperator1_k * t15_2_B.u9[i];
  }

  /* End of Product: '<S14>/Divide2' */

  /* DiscreteStateSpace: '<S53>/Div. contr.' */
  {
    {
...

    {
      ...
      const real_T *u = &t15_2_B.Divide2_f[0];
      real_T *y0 = &t15_2_B.Divcontr[0];
      int_T numNonZero = 17;
      while (numNonZero--) {
        *y0 += (*pD0++) * u[*pDidx++];
    ...
    t15_2_B.Divcontr[4] += (t15_2_P.Divcontr_D[68])*t15_2_B.Divide2_f[12];
  ...
  /* Switch: '<S61>/0.99' */
  if (t15_2_B.LogicalOperator1_m >= t15_2_P.u9_Threshold_l) {
    memcpy(&t15_2_B.u9_n[0], &t15_2_B.Memory[0], 11U * sizeof(real_T));
  } else {
    /* Sum: '<S49>/Subtract3' incorporates:
     *  Constant: '<S49>/1'
     */
    t15_2_B.Subtract3_m = t15_2_P._Value_d - t15_2_B.Saturation1;

    /* Product: '<S14>/Divide' */
    for (i = 0; i < 11; i++) {
      t15_2_B.Divide_o[i] = t15_2_B.Subtract3_m * t15_2_B.Divcontr[i];
      t15_2_B.u9_n[i] = t15_2_B.Divide_o[i];
    }

    /* End of Product: '<S14>/Divide' */
  }

  /* End of Switch: '<S61>/0.99' */

  /* Memory: '<S59>/Memory1' */
  t15_2_B.Memory1_n = t15_2_DWork.Memory1_PreviousInput_g;

  /* RelationalOperator: '<S71>/Compare' incorporates:
   *  Constant: '<S71>/Constant'
   */
  t15_2_B.Compare_c = (uint8_T)(t15_2_B.e6 < t15_2_P.Constant_Value_pl);

  /* DataStoreRead: '<S72>/Data Store Read' */
  t15_2_B.DataStoreRead_hj = t15_2_DWork.RupRd[0];

  /* RelationalOperator: '<S72>/Relational Operator' */
  t15_2_B.RelationalOperator_ed = (t15_2_B.e3 > t15_2_B.DataStoreRead_hj);

  /* Logic: '<S59>/Logical Operator1' */
  t15_2_B.LogicalOperator1_d = ((t15_2_B.Compare_c != 0) &&
    t15_2_B.RelationalOperator_ed);

  /* Switch: '<S59>/0.9999' */
  if (t15_2_B.LogicalOperator1_d > t15_2_P.u999_Threshold_a) {
    t15_2_B.u999_f = t15_2_B.Memory1_n;
  } else {
    t15_2_B.u999_f = t15_2_B.e3;
  }

  /* End of Switch: '<S59>/0.9999' */

  /* Product: '<S14>/Divide13' */
  for (i = 0; i < 20; i++) {
    t15_2_B.Divide13[i] = t15_2_B.Divide2_f[i] * t15_2_B.LogicalOperator1_d;
  }

  /* End of Product: '<S14>/Divide13' */

  /* DiscreteStateSpace: '<S54>/Div_rd contr' */
  {
    {
  ...
  /* Memory: '<S58>/Memory1' */
  t15_2_B.Memory1_b = t15_2_DWork.Memory1_PreviousInput_ka;

  /* Switch: '<S58>/c_eob' */
  if (t15_2_B.u_n > t15_2_P.c_eob_Threshold_ka) {
    for (i = 0; i < 500; i++) {
      /* DataStoreRead: '<S58>/Data Store Read1' */
      t15_2_B.DataStoreRead1_gw[i] = t15_2_DWork.scr_data[13 * i + 1];

      /* DataStoreRead: '<S58>/Data Store Read' */
      t15_2_B.DataStoreRead_ni[i] = t15_2_DWork.scr_data[13 * i];
    }

    /* Dynamic Look-Up Table Block: '<S58>/Ipref'
     * Input0  Data Type:  Floating Point real_T
     * Input1  Data Type:  Floating Point real_T
     * Input2  Data Type:  Floating Point real_T
     * Output0 Data Type:  Floating Point real_T
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.Ipref), &t15_2_B.DataStoreRead1_gw[0],
                         t15_2_B.e3, &t15_2_B.DataStoreRead_ni[0], 499U);
    t15_2_B.c_eob_gw = t15_2_B.Ipref;
  } else {
    t15_2_B.c_eob_gw = t15_2_B.Memory1_b;
  }

  /* End of Switch: '<S58>/c_eob' */

  /* Switch: '<S60>/0.999' */
  if (t15_2_B.LogicalOperator2_o > t15_2_P.u99_Threshold_n) {
    memcpy(&t15_2_B.u99_p[0], &t15_2_B.Memory1_h[0], 11U * sizeof(real_T));
  } else {
    /* Sum: '<S59>/Subtract2' */
    t15_2_B.Subtract2_j = t15_2_B.e3 - t15_2_B.u999_f;

    /* Gain: '<S59>/Gain1' */
    t15_2_B.Gain1_n = t15_2_P.Gain1_Gain_c * t15_2_B.Subtract2_j;

    /* Sum: '<S59>/Subtract3' incorporates:
     *  Constant: '<S59>/1'
     */
    t15_2_B.Subtract3_h = t15_2_B.Gain1_n + t15_2_P._Value;

    /* Saturate: '<S59>/Saturation' */
    tmin = t15_2_B.Subtract3_h;
    u = t15_2_P.Saturation_LowerSat_d;
    u_0 = t15_2_P.Saturation_UpperSat_i;
    if (tmin >= u_0) {
      t15_2_B.Saturation_d = u_0;
    } else if (tmin <= u) {
      t15_2_B.Saturation_d = u;
    } else {
      t15_2_B.Saturation_d = tmin;
    }
     ...
     *  Constant: '<S59>/1'
     */
    t15_2_B.Subtract1_h = t15_2_P._Value - t15_2_B.Saturation_d;
    ...
    if (t15_2_B.u_n > t15_2_P.c_eob_Threshold) {
      ...
      t15_2_B.c_eob_jv = t15_2_B.Saturation_c;
    } else {
      /* Product: '<S58>/Divide6' */
      t15_2_B.Divide6_h = t15_2_B.c_eob_gw * t15_2_B.u_n;

      /* Sum: '<S58>/Sum' incorporates:
       *  Constant: '<S58>/c1_y0'
       */
      t15_2_B.Sum = t15_2_B.Divide6_h - t15_2_P.c1_y0_Value;

      /* Product: '<S58>/Divide2' incorporates:
       *  Constant: '<S58>/(1-y0)//...'
       */
      t15_2_B.Divide2_e0 = t15_2_B.Sum * t15_2_P.uy0_Value;

      /* Sum: '<S58>/Sum1' incorporates:
       *  Constant: '<S58>/y0'
       */
      t15_2_B.Sum1_d = t15_2_B.Divide2_e0 + t15_2_P.y0_Value;
      ...
      /* End of Saturate: '<S58>/[1 y0]' */
      t15_2_B.c_eob_jv = t15_2_B.uy0;
    }

    for (i = 0; i < 11; i++) {
      /* Product: '<S14>/Divide3' */
      t15_2_B.Divide3_p[i] = t15_2_B.Div_rdcontr[i] * t15_2_B.c_eob_jv *
        t15_2_B.Subtract1_h;

      /* Product: '<S14>/Divide1' */
      t15_2_B.Divide1_ihu[i] = t15_2_B.u9_n[i] * t15_2_B.Saturation_d;

      /* Sum: '<S14>/Sum2' */
      t15_2_B.Sum2_f[i] = t15_2_B.Divide1_ihu[i] + t15_2_B.Divide3_p[i];
      t15_2_B.u99_p[i] = t15_2_B.Sum2_f[i];
    }

    /* End of Switch: '<S14>/c_eob' */
  }

  /* End of Switch: '<S60>/0.999' */

  /* DiscreteStateSpace: '<S52>/Curr. term. contr' */
  {
  ...
  for (i = 0; i < 11; i++) {
    /* Product: '<S14>/Divide4' */
    t15_2_B.Divide4_h[i] = t15_2_B.u99_p[i] * t15_2_B.Saturation;

    /* Product: '<S14>/Divide5' */
    t15_2_B.Divide5_h[i] = t15_2_B.Currtermcontr[i] * t15_2_B.Subtract1_p;

    /* Memory: '<S55>/Memory2' */
    t15_2_B.Memory2_iw[i] = t15_2_DWork.Memory2_PreviousInput_l[i];
  }

  /* Switch: '<S55>/tcont2 ' incorporates:
   *  Constant: '<S55>/zeros(20,1)'
   */
  for (i = 0; i < 20; i++) {
    if (t15_2_B.e3 > t15_2_P.tcont2_Threshold_n) {
  ...
  /* Switch: '<S55>/Ip>Ip_div ' incorporates:
   *  Switch: '<S55>/tcont2'
   */
  if (t15_2_B.e6 > t15_2_P.IpIp_div_Threshold_k) {
    memcpy(&t15_2_B.IpIp_div[0], &t15_2_B.Memory2_iw[0], 11U * sizeof(real_T));
  } else {
    if (t15_2_B.e3 > t15_2_P.tcont2_Threshold) {
      /* Lookup: '<S55>/gain_cont2'
       * About '<S55>/gain_cont2':
       * Input0  Data Type:  Floating Point real_T
       * Output0 Data Type:  Floating Point real_T
       * Lookup Method: Linear_Endpoint
       *
      ...
      for (i = 0; i < 11; i++) {
        /* Product: '<S55>/Divide ' */
        t15_2_B.Divide_mq[i] = t15_2_B.Limcontr[i] * t15_2_B.gain_cont2;
        t15_2_B.tcont2_h[i] = t15_2_B.Divide_mq[i];
      }
    } else {
      for (i = 0; i < 11; i++) {
        /* Product: '<S55>/Divide 2' incorporates:
         *  Switch: '<S55>/tcont2'
         */
        t15_2_B.Divide2_fd[i] = t15_2_B.Currcontr[i] /
          t15_2_B.DataStoreRead2_a[i];

        /* Switch: '<S55>/tcont2' */
        t15_2_B.tcont2_h[i] = t15_2_B.Divide2_fd[i];
      }
    }
  ...
  /* End of Switch: '<S55>/Ip>Ip_div ' */

  /* Product: '<S14>/Divide6' */
  for (i = 0; i < 11; i++) {
    t15_2_B.Divide6_p[i] = t15_2_B.Saturation1 * t15_2_B.IpIp_div[i];
  }

  for (i = 0; i < 500; i++) {
    /* DataStoreRead: '<S79>/Data Store Read' */
    t15_2_B.DataStoreRead_kd[i] = t15_2_DWork.volt[20 * i];

    /* Gain: '<S79>/0.001' */
    t15_2_B.u01[i] = t15_2_P.u01_Gain * t15_2_B.DataStoreRead_kd[i];
    ...
    /* Gain: '<S82>/0.001' */
    t15_2_B.u01_l[i] = t15_2_P.u01_Gain_f * t15_2_B.DataStoreRead_c[i];

    /* DataStoreRead: '<S82>/Data Store Read1' */
    t15_2_B.DataStoreRead1_b[i] = t15_2_DWork.volt[20 * i + 2];

    /* DataStoreRead: '<S83>/Data Store Read' */
    t15_2_B.DataStoreRead_p[i] = t15_2_DWork.volt[20 * i];

    /* Gain: '<S83>/0.001' */
    t15_2_B.u01_c[i] = t15_2_P.u01_Gain_fs * t15_2_B.DataStoreRead_p[i];

    /* DataStoreRead: '<S83>/Data Store Read1' */
    t15_2_B.DataStoreRead1_pv[i] = t15_2_DWork.volt[20 * i + 3];

    /* DataStoreRead: '<S84>/Data Store Read' */
    t15_2_B.DataStoreRead_o[i] = t15_2_DWork.volt[20 * i];

    /* Gain: '<S84>/0.001' */
    t15_2_B.u01_p[i] = t15_2_P.u01_Gain_h * t15_2_B.DataStoreRead_o[i];

    /* DataStoreRead: '<S84>/Data Store Read1' */
    t15_2_B.DataStoreRead1_pp[i] = t15_2_DWork.volt[20 * i + 4];

    /* DataStoreRead: '<S85>/Data Store Read' */
    t15_2_B.DataStoreRead_j[i] = t15_2_DWork.volt[20 * i];

    /* Gain: '<S85>/0.001' */
    t15_2_B.u01_n[i] = t15_2_P.u01_Gain_p * t15_2_B.DataStoreRead_j[i];

    /* DataStoreRead: '<S85>/Data Store Read1' */
    t15_2_B.DataStoreRead1_l[i] = t15_2_DWork.volt[20 * i + 5];

    /* DataStoreRead: '<S86>/Data Store Read' */
    t15_2_B.DataStoreRead_a[i] = t15_2_DWork.volt[20 * i];

    /* Gain: '<S86>/0.001' */
    t15_2_B.u01_d[i] = t15_2_P.u01_Gain_l * t15_2_B.DataStoreRead_a[i];

    /* DataStoreRead: '<S86>/Data Store Read1' */
    t15_2_B.DataStoreRead1_mc[i] = t15_2_DWork.volt[20 * i + 6];

    /* DataStoreRead: '<S87>/Data Store Read' */
    t15_2_B.DataStoreRead_l[i] = t15_2_DWork.volt[20 * i];

    /* Gain: '<S87>/0.001' */
    t15_2_B.u01_e[i] = t15_2_P.u01_Gain_b * t15_2_B.DataStoreRead_l[i];

    /* DataStoreRead: '<S87>/Data Store Read1' */
    t15_2_B.DataStoreRead1_e[i] = t15_2_DWork.volt[20 * i + 7];

    /* DataStoreRead: '<S88>/Data Store Read' */
    t15_2_B.DataStoreRead_o4[i] = t15_2_DWork.volt[20 * i];

    /* Gain: '<S88>/0.001' */
    t15_2_B.u01_ez[i] = t15_2_P.u01_Gain_f5 * t15_2_B.DataStoreRead_o4[i];

    /* DataStoreRead: '<S88>/Data Store Read1' */
    t15_2_B.DataStoreRead1_mp[i] = t15_2_DWork.volt[20 * i + 8];

    /* DataStoreRead: '<S89>/Data Store Read' */
    t15_2_B.DataStoreRead_c5[i] = t15_2_DWork.volt[20 * i];

    /* Gain: '<S89>/0.001' */
    t15_2_B.u01_g[i] = t15_2_P.u01_Gain_f2 * t15_2_B.DataStoreRead_c5[i];

    /* DataStoreRead: '<S89>/Data Store Read1' */
    t15_2_B.DataStoreRead1_bi[i] = t15_2_DWork.volt[20 * i + 9];

    /* DataStoreRead: '<S80>/Data Store Read' */
    t15_2_B.DataStoreRead_ke[i] = t15_2_DWork.volt[20 * i];

    /* Gain: '<S80>/0.001' */
    t15_2_B.u01_cs[i] = t15_2_P.u01_Gain_d * t15_2_B.DataStoreRead_ke[i];

    /* DataStoreRead: '<S80>/Data Store Read1' */
    t15_2_B.DataStoreRead1_eo[i] = t15_2_DWork.volt[20 * i + 10];

    /* DataStoreRead: '<S81>/Data Store Read' */
    t15_2_B.DataStoreRead_d4[i] = t15_2_DWork.volt[20 * i];

    /* Gain: '<S81>/0.001' */
    t15_2_B.u01_pg[i] = t15_2_P.u01_Gain_i * t15_2_B.DataStoreRead_d4[i];

    /* DataStoreRead: '<S81>/Data Store Read1' */
    t15_2_B.DataStoreRead1_gz[i] = t15_2_DWork.volt[20 * i + 11];
  }

  /* End of Product: '<S14>/Divide6' */
  /* Dynamic Look-Up Table Block: '<S79>/volt1'
   * Input0  Data Type:  Floating Point real_T
   * Input1  Data Type:  Floating Point real_T
   * Input2  Data Type:  Floating Point real_T
   * Output0 Data Type:  Floating Point real_T
   ...
   *
   */
  LookUp_real_T_real_T( &(t15_2_B.volt1_d), &t15_2_B.DataStoreRead1_pv[0],
                       t15_2_B.e3, &t15_2_B.u01_c[0], 499U);
   ...
   *
   */
  LookUp_real_T_real_T( &(t15_2_B.volt1_n), &t15_2_B.DataStoreRead1_pp[0],
                       t15_2_B.e3, &t15_2_B.u01_p[0], 499U);
   ...
   *
   */
  LookUp_real_T_real_T( &(t15_2_B.volt1_h), &t15_2_B.DataStoreRead1_l[0],
   ...
   *
   */
  LookUp_real_T_real_T( &(t15_2_B.volt1_g), &t15_2_B.DataStoreRead1_mc[0],
                       t15_2_B.e3, &t15_2_B.u01_d[0], 499U);
   ...
   *
   */
  LookUp_real_T_real_T( &(t15_2_B.volt1_gv), &t15_2_B.DataStoreRead1_e[0],
   ...
   *
   */
  LookUp_real_T_real_T( &(t15_2_B.volt1_dv), &t15_2_B.DataStoreRead1_mp[0],
                       t15_2_B.e3, &t15_2_B.u01_ez[0], 499U);
   ...
   *
   */
  LookUp_real_T_real_T( &(t15_2_B.volt1_m), &t15_2_B.DataStoreRead1_bi[0],
   ...
   *
   */
  LookUp_real_T_real_T( &(t15_2_B.volt1_i4), &t15_2_B.DataStoreRead1_eo[0],
                       t15_2_B.e3, &t15_2_B.u01_cs[0], 499U);
   ...
   *
   */
  LookUp_real_T_real_T( &(t15_2_B.volt1_p), &t15_2_B.DataStoreRead1_gz[0],
                       t15_2_B.e3, &t15_2_B.u01_pg[0], 499U);

  /* Product: '<S14>/Divide7' */
  t15_2_B.Divide7[0] = t15_2_B.volt1 * t15_2_B.Subtract4;
  t15_2_B.Divide7[1] = t15_2_B.volt1_i * t15_2_B.Subtract4;
  t15_2_B.Divide7[2] = t15_2_B.volt1_d * t15_2_B.Subtract4;
  t15_2_B.Divide7[3] = t15_2_B.volt1_n * t15_2_B.Subtract4;
  t15_2_B.Divide7[4] = t15_2_B.volt1_h * t15_2_B.Subtract4;
  t15_2_B.Divide7[5] = t15_2_B.volt1_g * t15_2_B.Subtract4;
  t15_2_B.Divide7[6] = t15_2_B.volt1_gv * t15_2_B.Subtract4;
  t15_2_B.Divide7[7] = t15_2_B.volt1_dv * t15_2_B.Subtract4;
  t15_2_B.Divide7[8] = t15_2_B.volt1_m * t15_2_B.Subtract4;
  t15_2_B.Divide7[9] = t15_2_B.volt1_i4 * t15_2_B.Subtract4;
  t15_2_B.Divide7[10] = t15_2_B.volt1_p * t15_2_B.Subtract4;
  for (i = 0; i < 11; i++) {
    /* Sum: '<S14>/Sum3' */
    t15_2_B.Sum3[i] = ((t15_2_B.Divide4_h[i] + t15_2_B.Divide5_h[i]) +
                       t15_2_B.Divide6_p[i]) + t15_2_B.Divide7[i];

    /* Product: '<S51>/Divide2' */
    t15_2_B.Divide2_e[i] = t15_2_B.e6_k[i] * t15_2_B.Sum3[i];

    /* RelationalOperator: '<S70>/Compare' incorporates:
     *  Constant: '<S70>/Constant'
     */
    t15_2_B.Compare_a[i] = (uint8_T)(t15_2_B.Divide2_e[i] <
    ...
    /* Sum: '<S51>/Sum3' */
    t15_2_B.Sum3_e[i] = t15_2_B.Saturation_f[i] + (real_T)
      t15_2_B.LogicalOperator[i];

    /* Saturate: '<S51>/Saturation1' */
    tmin = t15_2_B.Sum3_e[i];
    ...
    t15_2_B.Saturation1_m[i] = tmin;

    /* End of Saturate: '<S51>/Saturation1' */

    /* Product: '<S51>/Divide6' */
    t15_2_B.Divide6_j[i] = t15_2_B.Sum3[i] * t15_2_B.Saturation1_m[i];
  }
  ...
  /* UnitDelay: '<S78>/UD' */
  t15_2_B.Uk1_k = t15_2_DWork.UD_DSTATE_p;

  /* Switch: '<S14>/t>t_tran2d' incorporates:
   *  Constant: '<S14>/zeros(2,1)'
   */
  if (t15_2_B.e3 > t15_2_P.tt_tran2d_Threshold) {
    /* Sum: '<S78>/Diff' */
    t15_2_B.Diff_c = t15_2_B.e3 - t15_2_B.Uk1_k;

    /* Gain: '<S77>/2e3' */
    t15_2_B.e3_f = t15_2_P.e3_Gain * t15_2_B.Diff_c;

    /* Sqrt: '<S77>/Sqrt' */
    t15_2_B.Sqrt = sqrt(t15_2_B.e3_f);

    /* DataStoreRead: '<S77>/Data Store Read' */
    t15_2_B.DataStoreRead_jq = t15_2_DWork.RupRd[5];

    /* Gain: '<S77>/1.75' */
    t15_2_B.u5 = t15_2_P.u5_Gain * t15_2_B.DataStoreRead_jq;

    /* Product: '<S77>/Divide11' */
    t15_2_B.Divide11_k = t15_2_B.UniformRandomNumber * t15_2_B.u5;

    /* Product: '<S77>/Divide1' */
    t15_2_B.Divide1_jq = t15_2_B.Divide11_k / t15_2_B.Sqrt;

    /* Sum: '<S24>/Diff' */
    t15_2_B.Diff_o = t15_2_B.e3 - t15_2_B.Uk1_f;

    /* Sum: '<S23>/Diff' incorporates:
     *  Inport: '<Root>/In1'
     */
    t15_2_B.Diff_cn = t15_2_U.In1[0] - t15_2_B.Uk1;

    /* Product: '<S17>/Divide' */
    t15_2_B.Divide_n = t15_2_B.Diff_cn / t15_2_B.Diff_o;

    /* Sum: '<S63>/Sum2' */
    t15_2_B.Sum2_m = t15_2_B.Divide1_jq + t15_2_B.Divide_n;
    t15_2_B.tt_tran2d[0] = t15_2_B.Sum2_m;
    t15_2_B.tt_tran2d[1] = t15_2_B.e6_k[11];
  } else {
    t15_2_B.tt_tran2d[0] = t15_2_P.zeros21_Value[0];
    t15_2_B.tt_tran2d[1] = t15_2_P.zeros21_Value[1];
  }

  /* End of Switch: '<S14>/t>t_tran2d' */

  /* DiscreteStateSpace: '<S56>/VS. contr' */
  {
    {
   ...
   *  Constant: '<S56>/c_eob '
   */
  t15_2_B.RelationalOperator_k = (t15_2_B.u_n < t15_2_P.c_eob_Value);

  /* Product: '<S56>/Divide4' */
  t15_2_B.Divide4_o[0] = t15_2_B.RelationalOperator_k * t15_2_B.tt_tran2d[0];
  t15_2_B.Divide4_o[1] = t15_2_B.RelationalOperator_k * t15_2_B.tt_tran2d[1];

  /* DiscreteStateSpace: '<S56>/VS. contr hl' */
  {
    {
      static const int_T colCidxRow0[5] = { 3, 4, 5, 6, 7 };
    ...
    t15_2_B.VScontrhl[0] += (t15_2_P.VScontrhl_D[0])*t15_2_B.Divide4_o[0] +
      (t15_2_P.VScontrhl_D[1])*t15_2_B.Divide4_o[1];
    ...
    t15_2_B.VScontrhl[1] += (t15_2_P.VScontrhl_D[2])*t15_2_B.Divide4_o[0] +
      (t15_2_P.VScontrhl_D[3])*t15_2_B.Divide4_o[1];
  }

  /* Switch: '<S56>/c_eob' */
  if (t15_2_B.u_n > t15_2_P.c_eob_Threshold_fw) {
    t15_2_B.c_eob_kj[0] = t15_2_B.VScontr[0];
    t15_2_B.c_eob_kj[1] = t15_2_B.VScontr[1];
  } else {
    t15_2_B.c_eob_kj[0] = t15_2_B.VScontrhl[0];
    t15_2_B.c_eob_kj[1] = t15_2_B.VScontrhl[1];
  }

  /* End of Switch: '<S56>/c_eob' */

  /* RelationalOperator: '<S75>/Compare' incorporates:
   *  Constant: '<S75>/Constant'
   */
  t15_2_B.Compare_g = (uint8_T)(t15_2_B.e6 < t15_2_P.Constant_Value_hs);

  /* DataStoreRead: '<S76>/Data Store Read' */
  t15_2_B.DataStoreRead_lp = t15_2_DWork.RupRd[0];

  /* RelationalOperator: '<S76>/Relational Operator' */
  t15_2_B.RelationalOperator_o = (t15_2_B.e3 > t15_2_B.DataStoreRead_lp);

  /* DataStoreRead: '<S62>/Data Store Read' */
  t15_2_B.DataStoreRead_n = t15_2_DWork.RupRd[2];

  /* Abs: '<S62>/Abs' */
  t15_2_B.Abs_n = fabs(t15_2_B.DataStoreRead_n);

  /* RelationalOperator: '<S62>/Relational Operator' */
  t15_2_B.RelationalOperator_c = (t15_2_B.e6 > t15_2_B.Abs_n);

  /* Logic: '<S62>/Logical Operator1' */
  t15_2_B.LogicalOperator1_l = ((t15_2_B.Compare_g != 0) &&
    t15_2_B.RelationalOperator_o && t15_2_B.RelationalOperator_c);

  /* Gain: '<S57>/atpl1//15' */
  t15_2_B.atpl115 = t15_2_P.atpl115_Gain * t15_2_B.e6;

  /* Switch: '<S62>/0.99' incorporates:
   *  Switch: '<S14>/c_eob '
   */
  if (t15_2_B.LogicalOperator1_l >= t15_2_P.u9_Threshold_p) {
    /* Gain: '<S14>/VS gain 3' */
    ...
    t15_2_B.Divide11[0] = t15_2_B.Saturation4 * t15_2_B.c_eob_kj[0];
    t15_2_B.Divide11[1] = t15_2_B.Saturation4 * t15_2_B.c_eob_kj[1];
    t15_2_B.u9_h[0] = t15_2_B.Divide11[0];
    t15_2_B.u9_h[1] = t15_2_B.Divide11[1];
  } else {
    if (t15_2_B.u_n > t15_2_P.c_eob_Threshold_h) {
      /* Switch: '<S57>/Ip>Ip_div' incorporates:
       *  Switch: '<S14>/c_eob '
       */
      if (t15_2_B.e6 > t15_2_P.IpIp_div_Threshold) {
        /* Saturate: '<S57>/Sat. Div' */
        ...
        /* End of Saturate: '<S57>/Sat. Div' */
        t15_2_B.IpIp_div_e = t15_2_B.SatDiv;
      } else {
        /* Saturate: '<S57>/Sat. Lim' */
        tmin = t15_2_B.atpl115;
        ...
        /* End of Saturate: '<S57>/Sat. Lim' */
        t15_2_B.IpIp_div_e = t15_2_B.SatLim;
      }

      /* End of Switch: '<S57>/Ip>Ip_div' */

      /* Product: '<S14>/Divide8' incorporates:
       *  Switch: '<S14>/c_eob '
       */
      t15_2_B.Divide8[0] = t15_2_B.IpIp_div_e * t15_2_B.c_eob_kj[0];
      t15_2_B.Divide8[1] = t15_2_B.IpIp_div_e * t15_2_B.c_eob_kj[1];

      /* Switch: '<S14>/c_eob ' */
      t15_2_B.c_eob_pf[0] = t15_2_B.Divide8[0];
      t15_2_B.c_eob_pf[1] = t15_2_B.Divide8[1];
    } else {
      /* Gain: '<S14>/VS gain 2' incorporates:
       *  Switch: '<S14>/c_eob '
       */
       ...
       *  Switch: '<S14>/c_eob '
       */
      t15_2_B.Divide_m[0] = t15_2_B.c_eob_kj[0] * t15_2_B.Saturation3;
      t15_2_B.Divide_m[1] = t15_2_B.c_eob_kj[1] * t15_2_B.Saturation3;

      /* Switch: '<S14>/c_eob ' */
      t15_2_B.c_eob_pf[0] = t15_2_B.Divide_m[0];
      t15_2_B.c_eob_pf[1] = t15_2_B.Divide_m[1];
    }

    t15_2_B.u9_h[0] = t15_2_B.c_eob_pf[0];
    t15_2_B.u9_h[1] = t15_2_B.c_eob_pf[1];
  }

  /* End of Switch: '<S62>/0.99' */

  /* Product: '<S14>/Divide10' */
  t15_2_B.Divide10[0] = t15_2_B.Subtract4 * t15_2_B.u9_h[0];
  t15_2_B.Divide10[1] = t15_2_B.Subtract4 * t15_2_B.u9_h[1];

  /* Product: '<S14>/Divide12' */
  for (i = 0; i < 20; i++) {
    t15_2_B.Divide12[i] = t15_2_B.Divide2_f[i] * t15_2_B.LogicalOperator2;
  }

  for (i = 0; i < 11; i++) {
    /* Product: '<S55>/Divide 1' */
    t15_2_B.Divide1_d5[i] = t15_2_B.u9[i + 8] / t15_2_B.DataStoreRead2_a[i];

    /* DataStoreRead: '<S4>/Data Store Read2' */
    t15_2_B.DataStoreRead2_d3[i] = t15_2_DWork.ntur[i];

    /* Product: '<S4>/Divide4' */
    t15_2_B.Divide4_c[i] = t15_2_B.DataStoreRead2_d3[i] * t15_2_B.Divide6_j[i];
  }

  /* End of Product: '<S14>/Divide12' */

  /* DataStoreWrite: '<Root>/Data Store Write10' incorporates:
   *  Constant: '<Root>/Constant15'
   */
  memcpy(&t15_2_DWork.ntur[0], &t15_2_P.Constant15_Value[0], 12U * sizeof(real_T));
  /* DataStoreWrite: '<Root>/Data Store Write1' incorporates:
   *  Constant: '<Root>/Constant2'
   */
  t15_2_DWork.tcont2 = t15_2_P.Constant2_Value;

  /* Level2 S-Function Block: '<Root>/S-Function' (read_tt_kavin2) */
  {
  ...
  /* End of DataStoreWrite: '<Root>/Data Store Write2' */
  ...
  /* UnitDelay: '<S5>/UD' */
  t15_2_B.Uk1_d = t15_2_DWork.UD_DSTATE_d;

  /* Sum: '<S5>/Diff' */
  t15_2_B.Diff = t15_2_B.e3 - t15_2_B.Uk1_d;
  for (i = 0; i < 11; i++) {
    ...
    t15_2_B.DataStoreRead1_mr[i] = t15_2_DWork.Vcspf_up[i];

    /* Memory: '<S6>/Memory1' */
    t15_2_B.Memory1_b1[i] = t15_2_DWork.Memory1_PreviousInput_ob[i];

    /* DataStoreRead: '<S7>/Data Store Read1' */
    t15_2_B.DataStoreRead1_g1[i] = t15_2_DWork.Vcspf_up[i];

    /* Gain: '<S7>/2' */
    t15_2_B.u_e[i] = t15_2_P._Gain * t15_2_B.DataStoreRead1_g1[i];

    /* Product: '<S7>/Divide1' */
    t15_2_B.Divide1_l3[i] = t15_2_B.u_e[i] / t15_2_B.DataStoreRead3;

    /* Sum: '<S6>/Add1' */
    t15_2_B.Add1_h[i] = t15_2_B.Divide4_c[i] - t15_2_B.Memory1_b1[i];

    /* Product: '<S6>/Divide' */
    t15_2_B.Divide[i] = t15_2_B.Add1_h[i] / t15_2_B.Diff;

    /* RelationalOperator: '<S9>/LowerRelop1' */
    t15_2_B.LowerRelop1[i] = (t15_2_B.Divide[i] > t15_2_B.Divide1_l3[i]);

    /* Gain: '<S7>/-1' */
    t15_2_B.u_i[i] = t15_2_P.u_Gain_f * t15_2_B.Divide1_l3[i];

    /* RelationalOperator: '<S9>/UpperRelop' */
    t15_2_B.UpperRelop[i] = (t15_2_B.Divide[i] < t15_2_B.u_i[i]);

    /* Switch: '<S9>/Switch' */
    if (t15_2_B.UpperRelop[i]) {
      t15_2_B.Switch[i] = t15_2_B.u_i[i];
    } else {
    ...
    if (t15_2_B.LowerRelop1[i]) {
      t15_2_B.Switch2[i] = t15_2_B.Divide1_l3[i];
    } else {
    ...
    /* Product: '<S6>/Divide1' */
    t15_2_B.Divide1_n[i] = t15_2_B.Switch2[i] * t15_2_B.Diff;

    /* Sum: '<S6>/Add2' */
    t15_2_B.Add2_p[i] = t15_2_B.Memory1_b1[i] + t15_2_B.Divide1_n[i];

    /* RelationalOperator: '<S10>/LowerRelop1' */
    t15_2_B.LowerRelop1_m[i] = (t15_2_B.Add2_p[i] > t15_2_B.DataStoreRead1_mr[i]);

    /* Gain: '<S8>/Gain' */
    t15_2_B.Gain[i] = t15_2_P.Gain_Gain_j * t15_2_B.DataStoreRead1_mr[i];

    /* RelationalOperator: '<S10>/UpperRelop' */
    t15_2_B.UpperRelop_i[i] = (t15_2_B.Add2_p[i] < t15_2_B.Gain[i]);

    /* Switch: '<S10>/Switch' */
    if (t15_2_B.UpperRelop_i[i]) {
      t15_2_B.Switch_f[i] = t15_2_B.Gain[i];
    } else {
      t15_2_B.Switch_f[i] = t15_2_B.Add2_p[i];
    }
    ...
    if (t15_2_B.LowerRelop1_m[i]) {
      t15_2_B.Switch2_d[i] = t15_2_B.DataStoreRead1_mr[i];
    } else {
      t15_2_B.Switch2_d[i] = t15_2_B.Switch_f[i];
    }
    ...
    /* Product: '<S1>/Divide3' */
    t15_2_B.Divide3_l[i] = t15_2_B.Switch2_d[i] / t15_2_B.DataStoreRead2_n[i];

    /* Product: '<S1>/Divide1' incorporates:
     *  Constant: '<S1>/wz1'
     */
    t15_2_B.Divide1_e3[i] = t15_2_P.wz1_Value[i] / t15_2_B.DataStoreRead2_n[i];
  }

  /* DataStoreRead: '<S3>/Data Store Read1' */
  t15_2_B.DataStoreRead1_py = t15_2_DWork.VS1_up;

  /* RelationalOperator: '<S11>/LowerRelop1' */
  t15_2_B.LowerRelop1_c = (t15_2_B.Divide10[0] > t15_2_B.DataStoreRead1_py);

  /* Switch: '<S11>/Switch2' */
  if (t15_2_B.LowerRelop1_c) {
    t15_2_B.Switch2_k = t15_2_B.DataStoreRead1_py;
  } else {
    /* Gain: '<S3>/Gain' */
    t15_2_B.Gain_f = t15_2_P.Gain_Gain * t15_2_B.DataStoreRead1_py;

    /* RelationalOperator: '<S11>/UpperRelop' */
    t15_2_B.UpperRelop_n = (t15_2_B.Divide10[0] < t15_2_B.Gain_f);

    /* Switch: '<S11>/Switch' */
    if (t15_2_B.UpperRelop_n) {
      t15_2_B.Switch_e = t15_2_B.Gain_f;
    } else {
      t15_2_B.Switch_e = t15_2_B.Divide10[0];
    }
  ...
  for (i = 0; i < 11; i++) {
    /* Product: '<S1>/Divide2' */
    t15_2_B.Divide2_o[i] = t15_2_B.Divide1_e3[i] * t15_2_B.Switch2_k;

    /* Sum: '<S1>/Add1' */
    t15_2_B.Add1_m[i] = t15_2_B.Divide3_l[i] + t15_2_B.Divide2_o[i];
  }

  /* End of Switch: '<S11>/Switch2' */

  /* DataStoreRead: '<S1>/Data Store Read1' */
  t15_2_B.DataStoreRead1_oh = t15_2_DWork.ntur[11];

  /* Product: '<S1>/Divide4' incorporates:
   *  Constant: '<S1>/wz2'
   */
  t15_2_B.Divide4_f = t15_2_P.wz2_Value / t15_2_B.DataStoreRead1_oh;

  /* DataStoreRead: '<S3>/Data Store Read3' */
  t15_2_B.DataStoreRead3_g = t15_2_DWork.VS3_up;

  /* RelationalOperator: '<S12>/LowerRelop1' */
  t15_2_B.LowerRelop1_i = (t15_2_B.Divide10[1] > t15_2_B.DataStoreRead3_g);

  /* Switch: '<S12>/Switch2' */
  if (t15_2_B.LowerRelop1_i) {
    t15_2_B.Switch2_o = t15_2_B.DataStoreRead3_g;
  } else {
    /* Gain: '<S3>/Gain1' */
    t15_2_B.Gain1_m = t15_2_P.Gain1_Gain * t15_2_B.DataStoreRead3_g;

    /* RelationalOperator: '<S12>/UpperRelop' */
    t15_2_B.UpperRelop_j = (t15_2_B.Divide10[1] < t15_2_B.Gain1_m);

    /* Switch: '<S12>/Switch' */
    if (t15_2_B.UpperRelop_j) {
      t15_2_B.Switch_fn = t15_2_B.Gain1_m;
    } else {
      t15_2_B.Switch_fn = t15_2_B.Divide10[1];
    }

    /* End of Switch: '<S12>/Switch' */
    t15_2_B.Switch2_o = t15_2_B.Switch_fn;
  }

  /* End of Switch: '<S12>/Switch2' */

  /* Product: '<S1>/Divide5' */
  t15_2_B.Divide5_m = t15_2_B.Divide4_f * t15_2_B.Switch2_o;
  ...
  memcpy(&t15_2_B.TmpSignalConversionAtnpf12Inpor[0], &t15_2_B.Add1_m[0], 11U *
         sizeof(real_T));
  t15_2_B.TmpSignalConversionAtnpf12Inpor[11] = t15_2_B.Divide5_m;
  for (i = 0; i < 15; i++) {
    /* Gain: '<S1>/npf,12' */
    t15_2_B.npf12[i] = 0.0;
  ...
  /* Outport: '<Root>/to_DINA' */
  memcpy(&t15_2_Y.to_DINA[15], &t15_2_B.Divide3_l[0], 11U * sizeof(real_T));
  for (i = 0; i < 11; i++) {
    /* Outport: '<Root>/to_DINA' */
    t15_2_Y.to_DINA[i + 26] = t15_2_B.Divide2_o[i];

    /* Update for Memory: '<S60>/Memory1' */
    t15_2_DWork.Memory1_PreviousInput_d[i] = t15_2_B.u99_p[i];

    /* Update for Memory: '<S61>/Memory' */
    t15_2_DWork.Memory_PreviousInput[i] = t15_2_B.u9_n[i];

    /* Update for Memory: '<S55>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_l[i] = t15_2_B.IpIp_div[i];

    /* Update for Memory: '<S6>/Memory1' */
    t15_2_DWork.Memory1_PreviousInput_ob[i] = t15_2_B.Switch2_d[i];
  }

  /* Outport: '<Root>/to_DINA' */
  t15_2_Y.to_DINA[37] = t15_2_B.Divide5_m;

  /* Update for Memory: '<S4>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput = t15_2_B.Ip1e4;

  /* Update for Memory: '<S22>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_o = t15_2_B.e6_a;
  ...
  t15_2_DWork.Memory2_PreviousInput_i = t15_2_B.c_eob_n;

  /* Update for Memory: '<S27>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_k = t15_2_B.c_eob_p;

  /* Update for Memory: '<S29>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_p = t15_2_B.c_eob_na;

  /* Update for Memory: '<S25>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_c = t15_2_B.c_eob_j;

  /* Update for Memory: '<S30>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_id = t15_2_B.c_eob_o;

  /* Update for Memory: '<S31>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_pz = t15_2_B.c_eob_nv;

  /* Update for Memory: '<S32>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_h = t15_2_B.c_eob_h;

  /* Update for Memory: '<S33>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_k4 = t15_2_B.c_eob_pl;

  /* Update for Memory: '<S34>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_b = t15_2_B.c_eob_a;

  /* Update for Memory: '<S35>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_by = t15_2_B.c_eob_pr;

  /* Update for Memory: '<S41>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_n = t15_2_B.c_eob1;

  /* Update for Memory: '<S41>/Memory1' */
  t15_2_DWork.Memory1_PreviousInput_e = t15_2_B.c_eob_nav;

  /* Update for Memory: '<S36>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_g = t15_2_B.c_eob1_c;

  /* Update for Memory: '<S36>/Memory1' */
  t15_2_DWork.Memory1_PreviousInput_k = t15_2_B.c_eob_l;

  /* Update for Memory: '<S37>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_i0 = t15_2_B.c_eob1_g;

  /* Update for Memory: '<S37>/Memory1' */
  t15_2_DWork.Memory1_PreviousInput_a = t15_2_B.c_eob_g;

  /* Update for Memory: '<S38>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_a = t15_2_B.c_eob1_cr;

  /* Update for Memory: '<S38>/Memory1' */
  t15_2_DWork.Memory1_PreviousInput_f = t15_2_B.c_eob_hb;

  /* Update for Memory: '<S39>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_e = t15_2_B.c_eob1_k;

  /* Update for Memory: '<S39>/Memory1' */
  t15_2_DWork.Memory1_PreviousInput_n = t15_2_B.c_eob_k0;

  /* Update for Memory: '<S40>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_on = t15_2_B.c_eob1_ky;

  /* Update for Memory: '<S40>/Memory1' */
  t15_2_DWork.Memory1_PreviousInput_oz = t15_2_B.c_eob_ks;

  /* Update for Memory: '<S49>/Memory3' */
  t15_2_DWork.Memory3_PreviousInput = t15_2_B.u999;

  /* Update for Memory: '<S50>/Memory1' */
  t15_2_DWork.Memory1_PreviousInput_kn = t15_2_B.u999_a;

  /* Update for DiscreteStateSpace: '<S53>/Div. contr.' */
  {
    real_T xnew[32];
    ...
    xnew[20] += (t15_2_P.Divcontr_B[340])*t15_2_B.Divide2_f[12];
    ...
    xnew[21] += (t15_2_P.Divcontr_B[341])*t15_2_B.Divide2_f[12];
    ...
    xnew[22] += (t15_2_P.Divcontr_B[342])*t15_2_B.Divide2_f[12];
    ...
    xnew[23] += (t15_2_P.Divcontr_B[343])*t15_2_B.Divide2_f[12];
  ...
  /* Update for Memory: '<S58>/Memory1' */
  t15_2_DWork.Memory1_PreviousInput_ka = t15_2_B.c_eob_gw;

  /* Update for DiscreteStateSpace: '<S52>/Curr. term. contr' */
  {
    real_T xnew[22];
  ...
  /* Update for DiscreteStateSpace: '<S55>/Curr. contr.' */
  {
...

    {
      ...
      const real_T *u = &t15_2_B.Divide1_d5[0];
      real_T *pxnew0 = &xnew[0];
      int_T numNonZero = 11;
      while (numNonZero--) {
        *pxnew0 += (*pB0++) * u[*pBidx++];
  ...
  t15_2_DWork.UD_DSTATE_p = t15_2_B.e3;

  /* Update for DiscreteStateSpace: '<S56>/VS. contr' */
  {
    real_T xnew[9];
  ...
  /* Update for DiscreteStateSpace: '<S56>/VS. contr hl' */
  {
    real_T xnew[8];
    ...
    xnew[0] += (t15_2_P.VScontrhl_B[0])*t15_2_B.Divide4_o[0] +
      (t15_2_P.VScontrhl_B[1])*t15_2_B.Divide4_o[1];
    ...
    xnew[1] += (t15_2_P.VScontrhl_B[2])*t15_2_B.Divide4_o[0] +
      (t15_2_P.VScontrhl_B[3])*t15_2_B.Divide4_o[1];
    ...
    xnew[2] += (t15_2_P.VScontrhl_B[4])*t15_2_B.Divide4_o[0] +
      (t15_2_P.VScontrhl_B[5])*t15_2_B.Divide4_o[1];
    ...
    xnew[3] += (t15_2_P.VScontrhl_B[6])*t15_2_B.Divide4_o[0] +
      (t15_2_P.VScontrhl_B[7])*t15_2_B.Divide4_o[1];
    ...
    xnew[4] += (t15_2_P.VScontrhl_B[8])*t15_2_B.Divide4_o[0] +
      (t15_2_P.VScontrhl_B[9])*t15_2_B.Divide4_o[1];
    ...
    xnew[5] += (t15_2_P.VScontrhl_B[10])*t15_2_B.Divide4_o[0] +
      (t15_2_P.VScontrhl_B[11])*t15_2_B.Divide4_o[1];
    ...
    xnew[6] += (t15_2_P.VScontrhl_B[12])*t15_2_B.Divide4_o[0] +
      (t15_2_P.VScontrhl_B[13])*t15_2_B.Divide4_o[1];
    xnew[7] = (t15_2_P.VScontrhl_A[32])*t15_2_DWork.VScontrhl_DSTATE[7];
    xnew[7] += (t15_2_P.VScontrhl_B[14])*t15_2_B.Divide4_o[0];
...
void t15_2_initialize(void)
{
	...
	char b[256];
      ...
      double c_a_tpl2,c_a_tpl_min,y0;
...
fscanf(f,"%lf",&y0);
	  ...
	  printf("  c_a_tpl1_eob,c_a_tpl2,c_a_tpl_min,y0 \n");
  	  printf("%g   %g   %g  %g  ",c_a_tpl1_eob,c_a_tpl2,c_a_tpl_min,y0);


fclose(f);


	   printf("  tcont2_Threshold  tcont2_Threshold_n Constant2_Value\n");
  	  printf("%g   %g   %g ",t15_2_P.tcont2_Threshold, 
		  t15_2_P.tcont2_Threshold_n,t15_2_P.Constant2_Value);
	  printf("\n");
	  ...
	  printf("\n");
	   ...
	   printf("  IpIp_div_Threshold  IpIp_div_Threshold_k \n");
  	  printf("%g   %g ",t15_2_P.IpIp_div_Threshold, 
		  t15_2_P.IpIp_div_Threshold_k);
	  printf("\n");
...

  {
    ...
    for (i = 0; i < 100; i++) {
      t15_2_B.SFunction1_od[i] = 0.0;
    }

    for (i = 0; i < 100; i++) {
      t15_2_B.SFunction1_gp[i] = 0.0;
    }
    ...
    for (i = 0; i < 11; i++) {
      t15_2_B.Divide1_ej[i] = 0.0;
    }

    for (i = 0; i < 11; i++) {
      t15_2_B.Saturation_f[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_kd[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead1_pv[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead1_pp[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead1_mc[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_o4[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.u01_ez[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead1_mp[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_c5[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead1_bi[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_ke[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.u01_cs[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead1_eo[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_d4[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.u01_pg[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead1_gz[i] = 0.0;
    }
    ...
    for (i = 0; i < 11; i++) {
      t15_2_B.Divide1_d5[i] = 0.0;
    }

    for (i = 0; i < 11; i++) {
      t15_2_B.DataStoreRead2_d3[i] = 0.0;
    }

    for (i = 0; i < 11; i++) {
      t15_2_B.Divide4_c[i] = 0.0;
    }
    ...
    for (i = 0; i < 11; i++) {
      t15_2_B.DataStoreRead1_mr[i] = 0.0;
    }

    for (i = 0; i < 11; i++) {
      t15_2_B.Memory1_b1[i] = 0.0;
    }

    for (i = 0; i < 11; i++) {
      t15_2_B.DataStoreRead1_g1[i] = 0.0;
    }
    ...
    for (i = 0; i < 11; i++) {
      t15_2_B.Divide1_l3[i] = 0.0;
    }

    for (i = 0; i < 11; i++) {
      t15_2_B.Add1_h[i] = 0.0;
    }
    ...
    for (i = 0; i < 11; i++) {
      t15_2_B.Divide3_l[i] = 0.0;
    }

    for (i = 0; i < 11; i++) {
      t15_2_B.Divide1_e3[i] = 0.0;
    }
    ...
    for (i = 0; i < 11; i++) {
      t15_2_B.Divide_mq[i] = 0.0;
    }

    for (i = 0; i < 11; i++) {
      t15_2_B.Divide2_fd[i] = 0.0;
    }
    ...
    for (i = 0; i < 50; i++) {
      t15_2_B.Selector1_i1[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead1_pc[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead1_oc[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_bh[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_c1[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_ob[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_pa[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead1_lj[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_bq[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_mt[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_j5[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead1_eot[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_lg[i] = 0.0;
    }
    ...
    t15_2_B.Add3_p = 0.0;
    t15_2_B.Memory2_eo = 0.0;
    t15_2_B.c_eob_o = 0.0;
    t15_2_B.Divide1_i = 0.0;
    t15_2_B.Add4 = 0.0;
    t15_2_B.Memory2_p = 0.0;
    t15_2_B.c_eob_nv = 0.0;
    ...
    t15_2_B.c_eob_pl = 0.0;
    t15_2_B.Divide1_gn = 0.0;
    t15_2_B.Add7 = 0.0;
    t15_2_B.Memory2_k = 0.0;
    t15_2_B.c_eob_a = 0.0;
    t15_2_B.Divide1_ih = 0.0;
    t15_2_B.Add8 = 0.0;
    ...
    t15_2_B.c_eob_k0 = 0.0;
    t15_2_B.c_eob_lw = 0.0;
    t15_2_B.Add5_f = 0.0;
    t15_2_B.Memory2_kq = 0.0;
    t15_2_B.c_eob1_ky = 0.0;
    t15_2_B.Memory1_f = 0.0;
    t15_2_B.c_eob_ks = 0.0;
    ...
    t15_2_B.volt1_h = 0.0;
    t15_2_B.volt1_g = 0.0;
    t15_2_B.volt1_gv = 0.0;
    t15_2_B.volt1_dv = 0.0;
    t15_2_B.volt1_m = 0.0;
    t15_2_B.volt1_i4 = 0.0;
    t15_2_B.volt1_p = 0.0;
    ...
    t15_2_B.Divide4_o[0] = 0.0;
    t15_2_B.Divide4_o[1] = 0.0;
    t15_2_B.VScontrhl[0] = 0.0;
    t15_2_B.VScontrhl[1] = 0.0;
    t15_2_B.c_eob_kj[0] = 0.0;
    t15_2_B.c_eob_kj[1] = 0.0;
    ...
    t15_2_B.e3_f = 0.0;
    t15_2_B.Sqrt = 0.0;
    t15_2_B.DataStoreRead_jq = 0.0;
    t15_2_B.u5 = 0.0;
    t15_2_B.Divide11_k = 0.0;
    t15_2_B.Divide1_jq = 0.0;
    t15_2_B.Diff_o = 0.0;
    t15_2_B.Diff_cn = 0.0;
    ...
    t15_2_B.DataStoreRead_mj = 0.0;
    t15_2_B.g1_termref = 0.0;
    t15_2_B.g1ref = 0.0;
    t15_2_B.DataStoreRead_mo = 0.0;
  ...
  t15_2_DWork.Memory2_PreviousInput_id = 0.0;
  t15_2_DWork.Memory2_PreviousInput_pz = 0.0;
  t15_2_DWork.Memory2_PreviousInput_h = 0.0;
  t15_2_DWork.Memory2_PreviousInput_k4 = 0.0;
  t15_2_DWork.Memory2_PreviousInput_b = 0.0;
  t15_2_DWork.Memory2_PreviousInput_by = 0.0;
  ...
  t15_2_DWork.Memory2_PreviousInput_i0 = 0.0;
  ...
  t15_2_DWork.Memory2_PreviousInput_on = 0.0;
  t15_2_DWork.Memory1_PreviousInput_oz = 0.0;
  t15_2_DWork.Memory3_PreviousInput = 0.0;
  t15_2_DWork.Memory1_PreviousInput_kn = 0.0;

  {
    int_T i;
    for (i = 0; i < 11; i++) {
      t15_2_DWork.Memory1_PreviousInput_d[i] = 0.0;
    }
  }
  ...
  t15_2_DWork.Memory1_PreviousInput_ka = 0.0;

  {
    int_T i;
    for (i = 0; i < 11; i++) {
      t15_2_DWork.Memory2_PreviousInput_l[i] = 0.0;
    }
  }
...

  {
    int_T i;
    for (i = 0; i < 11; i++) {
      t15_2_DWork.Memory1_PreviousInput_ob[i] = 0.0;
    }
  }
  ...
  /* register each child */
  {
    ...
    /* Level2 S-Function Block: t15_2/<S18>/S-Function1 (read_gaps) */
    {
      SimStruct *rts = t15_2_M->childSfunctions[2];
      ...
      ssSetModelName(rts, "S-Function1");
      ssSetPath(rts,
                "t15_2/kavin_contr/Control inputs 1/elong_ref.dat/S-Function1");
      ssSetRTModel(rts,t15_2_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
    ...
    /* Level2 S-Function Block: t15_2/<S41>/S-Function1 (read_gaps) */
    {
      ...
      ssSetModelName(rts, "S-Function1");
      ssSetPath(rts,
                "t15_2/kavin_contr/Control inputs 1/g1-g6.dat,g1_term-g6_term.dat/Subsystem6/S-Function1");
      ssSetRTModel(rts,t15_2_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
    ...
    /* Level2 S-Function Block: t15_2/<S47>/S-Function1 (read_gaps_term) */
    {
      ...
      ssSetModelName(rts, "S-Function1");
      ssSetPath(rts,
                "t15_2/kavin_contr/Control inputs 1/g1-g6.dat,g1_term-g6_term.dat/Subsystem6/g1_term,ref/S-Function1");
      ssSetRTModel(rts,t15_2_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
    ...
    /* Level2 S-Function Block: t15_2/<S36>/S-Function1 (read_gaps) */
    {
      SimStruct *rts = t15_2_M->childSfunctions[5];
      ...
      /* outputs */
      {
        ...
        /* port 0 */
        {
          ...
          _ssSetOutputPortNumDimensions(rts, 0, 2);
          ssSetOutputPortWidth(rts, 0, 100);
          ssSetOutputPortSignal(rts, 0, ((real_T *) t15_2_B.SFunction1_od));
        }
      }
      ...
      ssSetModelName(rts, "S-Function1");
      ssSetPath(rts,
                "t15_2/kavin_contr/Control inputs 1/g1-g6.dat,g1_term-g6_term.dat/Subsystem1/S-Function1");
      ssSetRTModel(rts,t15_2_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
    ...
    /* Level2 S-Function Block: t15_2/<S42>/S-Function1 (read_gaps_term) */
    {
      SimStruct *rts = t15_2_M->childSfunctions[6];
      ...
      /* outputs */
      {
        ...
        /* port 0 */
        {
          ...
          _ssSetOutputPortNumDimensions(rts, 0, 2);
          ssSetOutputPortWidth(rts, 0, 100);
          ssSetOutputPortSignal(rts, 0, ((real_T *) t15_2_B.SFunction1_gp));
        }
      }
      ...
      ssSetModelName(rts, "S-Function1");
      ssSetPath(rts,
                "t15_2/kavin_contr/Control inputs 1/g1-g6.dat,g1_term-g6_term.dat/Subsystem1/g2_term,ref/S-Function1");
      ssSetRTModel(rts,t15_2_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
    ...
    /* Level2 S-Function Block: t15_2/<S37>/S-Function1 (read_gaps) */
    {
      ...
      ssSetModelName(rts, "S-Function1");
      ssSetPath(rts,
                "t15_2/kavin_contr/Control inputs 1/g1-g6.dat,g1_term-g6_term.dat/Subsystem2/S-Function1");
      ssSetRTModel(rts,t15_2_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
      ...
      /* parameters */
      {
        ...
        ssSetSFcnParamsCount(rts, 1);
        ssSetSFcnParamsPtr(rts, &sfcnParams[0]);
        ssSetSFcnParam(rts, 0, (mxArray*)t15_2_P.SFunction1_P1_Size_mi);
      }
    ...
    /* Level2 S-Function Block: t15_2/<S43>/S-Function1 (read_gaps_term) */
    {
      ...
      ssSetModelName(rts, "S-Function1");
      ssSetPath(rts,
                "t15_2/kavin_contr/Control inputs 1/g1-g6.dat,g1_term-g6_term.dat/Subsystem2/g3_term,ref/S-Function1");
      ssSetRTModel(rts,t15_2_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
    ...
    /* Level2 S-Function Block: t15_2/<S38>/S-Function1 (read_gaps) */
    {
      ...
      /* outputs */
      {
        ...
        /* port 0 */
        {
          ...
          _ssSetOutputPortNumDimensions(rts, 0, 2);
          ssSetOutputPortWidth(rts, 0, 100);
          ssSetOutputPortSignal(rts, 0, ((real_T *) t15_2_B.SFunction1_oi));
        }
      }
      ...
      ssSetModelName(rts, "S-Function1");
      ssSetPath(rts,
                "t15_2/kavin_contr/Control inputs 1/g1-g6.dat,g1_term-g6_term.dat/Subsystem3/S-Function1");
      ssSetRTModel(rts,t15_2_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
      ...
      /* parameters */
      {
        ...
        ssSetSFcnParamsCount(rts, 1);
        ssSetSFcnParamsPtr(rts, &sfcnParams[0]);
        ssSetSFcnParam(rts, 0, (mxArray*)t15_2_P.SFunction1_P1_Size_fj);
      }
    ...
    /* Level2 S-Function Block: t15_2/<S44>/S-Function1 (read_gaps_term) */
    {
      ...
      ssSetModelName(rts, "S-Function1");
      ssSetPath(rts,
                "t15_2/kavin_contr/Control inputs 1/g1-g6.dat,g1_term-g6_term.dat/Subsystem3/g4_term,ref/S-Function1");
      ssSetRTModel(rts,t15_2_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
    ...
    /* Level2 S-Function Block: t15_2/<S39>/S-Function1 (read_gaps) */
    {
      ...
      ssSetModelName(rts, "S-Function1");
      ssSetPath(rts,
                "t15_2/kavin_contr/Control inputs 1/g1-g6.dat,g1_term-g6_term.dat/Subsystem4/S-Function1");
      ssSetRTModel(rts,t15_2_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
    ...
    /* Level2 S-Function Block: t15_2/<S45>/S-Function1 (read_gaps_term) */
    {
      ...
      ssSetModelName(rts, "S-Function1");
      ssSetPath(rts,
                "t15_2/kavin_contr/Control inputs 1/g1-g6.dat,g1_term-g6_term.dat/Subsystem4/g5_term,ref/S-Function1");
      ssSetRTModel(rts,t15_2_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
    ...
    /* Level2 S-Function Block: t15_2/<S40>/S-Function1 (read_gaps) */
    {
      ...
      ssSetModelName(rts, "S-Function1");
      ssSetPath(rts,
                "t15_2/kavin_contr/Control inputs 1/g1-g6.dat,g1_term-g6_term.dat/Subsystem5/S-Function1");
      ssSetRTModel(rts,t15_2_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
      ...
      /* parameters */
      {
        ...
        ssSetSFcnParamsCount(rts, 1);
        ssSetSFcnParamsPtr(rts, &sfcnParams[0]);
        ssSetSFcnParam(rts, 0, (mxArray*)t15_2_P.SFunction1_P1_Size_ly);
      }
    ...
    /* Level2 S-Function Block: t15_2/<S46>/S-Function1 (read_gaps_term) */
    {
      ...
      /* outputs */
      {
        ...
        /* port 0 */
        {
          ...
          _ssSetOutputPortNumDimensions(rts, 0, 2);
          ssSetOutputPortWidth(rts, 0, 100);
          ssSetOutputPortSignal(rts, 0, ((real_T *) t15_2_B.SFunction1_aw));
        }
      }
      ...
      ssSetModelName(rts, "S-Function1");
      ssSetPath(rts,
                "t15_2/kavin_contr/Control inputs 1/g1-g6.dat,g1_term-g6_term.dat/Subsystem5/g6_term,ref/S-Function1");
      ssSetRTModel(rts,t15_2_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
    ...
    /* Level2 S-Function Block: t15_2/<Root>/S-Function (read_tt_kavin2) */
    {
      SimStruct *rts = t15_2_M->childSfunctions[15];
      ...
      ssSetPath(rts, "t15_2/S-Function");
      ssSetRTModel(rts,t15_2_M);
      ssSetParentSS(rts, (NULL));
      ssSetRootSS(rts, rts);
      ssSetVersion(rts, SIMSTRUCT_VERSION_LEVEL2);
...

  {
    ...
    memcpy(&t15_2_DWork.ntur[0], &t15_2_P.DataStoreMemory1_InitialValue_m[0],
           12U * sizeof(real_T));
    ...
    /* End of Start for DataStoreMemory: '<Root>/Data Store Memory2' */
    ...
    t15_2_DWork.tcont2 = t15_2_P.DataStoreMemory6_InitialValue;
...

  {
    ...
    t15_2_DWork.Memory1_PreviousInput_o = t15_2_P.Memory1_X0_a;
    ...
    t15_2_DWork.UD_DSTATE_j = t15_2_P.UD_InitialCondition_e;

    /* InitializeConditions for Memory: '<S28>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_m = t15_2_P.Memory2_X0_en;
    ...
    t15_2_DWork.Memory2_PreviousInput_p = t15_2_P.Memory2_X0_b;
    ...
    t15_2_DWork.Memory2_PreviousInput_id = t15_2_P.Memory2_X0_f1;

    /* InitializeConditions for Memory: '<S31>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_pz = t15_2_P.Memory2_X0_l;

    /* InitializeConditions for Memory: '<S32>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_h = t15_2_P.Memory2_X0_fi;

    /* InitializeConditions for Memory: '<S33>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_k4 = t15_2_P.Memory2_X0_j4;
    ...
    t15_2_DWork.Memory2_PreviousInput_by = t15_2_P.Memory2_X0_lh;

    /* InitializeConditions for Memory: '<S41>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_n = t15_2_P.Memory2_X0_a;

    /* InitializeConditions for Memory: '<S41>/Memory1' */
    t15_2_DWork.Memory1_PreviousInput_e = t15_2_P.Memory1_X0_c;

    /* InitializeConditions for Memory: '<S36>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_g = t15_2_P.Memory2_X0_ft;

    /* InitializeConditions for Memory: '<S36>/Memory1' */
    t15_2_DWork.Memory1_PreviousInput_k = t15_2_P.Memory1_X0_k;

    /* InitializeConditions for Memory: '<S37>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_i0 = t15_2_P.Memory2_X0_fm;

    /* InitializeConditions for Memory: '<S37>/Memory1' */
    t15_2_DWork.Memory1_PreviousInput_a = t15_2_P.Memory1_X0_o;
    ...
    t15_2_DWork.Memory2_PreviousInput_e = t15_2_P.Memory2_X0_lj;

    /* InitializeConditions for Memory: '<S39>/Memory1' */
    t15_2_DWork.Memory1_PreviousInput_n = t15_2_P.Memory1_X0_ck;

    /* InitializeConditions for Memory: '<S40>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_on = t15_2_P.Memory2_X0_ei;

    /* InitializeConditions for Memory: '<S40>/Memory1' */
    t15_2_DWork.Memory1_PreviousInput_oz = t15_2_P.Memory1_X0_aj;
    ...
    t15_2_DWork.Memory1_PreviousInput_kn = t15_2_P.Memory1_X0_m;

    /* InitializeConditions for DiscreteStateSpace: '<S53>/Div. contr.' */
    {
      int_T i1;
    ...
    t15_2_DWork.Memory1_PreviousInput_g = t15_2_P.Memory1_X0_on;

    /* InitializeConditions for DiscreteStateSpace: '<S54>/Div_rd contr' */
    {
      int_T i1;
    ...
    t15_2_DWork.Memory1_PreviousInput_ka = t15_2_P.Memory1_X0_onh;

    /* InitializeConditions for DiscreteStateSpace: '<S52>/Curr. term. contr' */
    {
      int_T i1;
    ...
    t15_2_DWork.UD_DSTATE_p = t15_2_P.UD_InitialCondition_c;

    /* InitializeConditions for DiscreteStateSpace: '<S56>/VS. contr' */
    {
      int_T i1;
    ...
    /* InitializeConditions for DiscreteStateSpace: '<S56>/VS. contr hl' */
    {
      int_T i1;
    ...
    for (i = 0; i < 11; i++) {
      ...
      t15_2_DWork.Memory1_PreviousInput_d[i] = t15_2_P.Memory1_X0_im;

      /* InitializeConditions for Memory: '<S61>/Memory' */
      t15_2_DWork.Memory_PreviousInput[i] = t15_2_P.Memory_X0;

      /* InitializeConditions for Memory: '<S55>/Memory2' */
      t15_2_DWork.Memory2_PreviousInput_l[i] = t15_2_P.Memory2_X0_ev;

      /* InitializeConditions for Memory: '<S6>/Memory1' */
      t15_2_DWork.Memory1_PreviousInput_ob[i] = t15_2_P.Memory1_X0_ah;
    }

    /* InitializeConditions for UnitDelay: '<S5>/UD' */
    t15_2_DWork.UD_DSTATE_d = t15_2_P.UD_InitialCondition_i;
  }
}
