...
c           print*,'k+j',k+j
c           print*,'Rlim(i) Zlim(i)',Rlim(i),Zlim(i)
c           print*,'Rlim(i+1) Zlim(i+1)',Rlim(i+1),Zlim(i+1)
c           print*,'Rlim2(k+j) Zlim2(k+j)',Rlim2(k+j),Zlim2(k+j)
...
c         print*,'!!!j jj k dist_min Rdist_min Zdist_min',
c     *   j_min,jj_min,k,dist_min,Rdist_min,Zdist_min
