...
c----------------------
	...
	common /c_neut1/p_n0
       ...
       dimension denz(n_2),
     * rin_zog(n_2),rre_zog(n_2),rcx_zog(n_2)
	...
	dimension a_m(kf,kf),d_m(kf,kf),a1_m(kf,kf),f_m(kf),x_m(kf)
...
!     *  R**1.83*eps**(-0.06)*elong**0.64/Qabs**0.73
	...
	tay_ee2=0.023*I_p**0.96*Bt**0.03*(n_e*10.)**0.4*a_he**0.2*
     *  R**1.83*eps**(-0.06)*elong**0.64/Qabs**0.73
...
!      fbq=(q_10+d_q-q_b)/2.d0/d_q
      ...
      if(kpr.eq.1)then
     	call print4(' q_b tay_e fbq  t_L ==',
     * q_b,tay_ee,fbq,tay_ee2)
      end if
      ...
      i=1
	write(6,'("  q_b tay_e fbq  t_L t_b  ==",
     *  8(1pe11.4))'),
     *  q_b,tay_ee,fbq,tay_ee2,tay_ee1
      end if
...
c     V_p*d(he1)/dt=-he1*V_p/tay_p-he1*n_e*c_ion1*V_n-he1*n_e*c_rec1*V_n
c     +he2*n_e*c_rec2*V_n
c     +n0*n_e*c_ion0*V_n 

c     V_p*d(he2)/dt=-he2*V_p/tay_p-he2*n_e*c_rec2*V_n
c     +he1*n_e*c_ion1*V_n
c      
c
c     (V_v+V_n-V_p)*d(n0)/dt=-n0*n_e*c_ion0*V_n
c      +psi_n*he1*V_p/tay_p+he1*n_e*c_rec1*V_n+G_v*V_v+psi_n*he2*V_p/tay_p
...
c     psi_n recycling coeff
	...
	den_n=n0*10.
      ...
      if(kpr.eq.1)then
	write(6,'(" te_inp tn_inp den_e den_n=",
     *  6(1pe11.4))'),
     *  te_inp, tn_inp, den_e, den_n
      end if
     ...
     *  i4,6(1pe11.4))'),
     *  i,c_ion0,c_rec1,c_ex1
      i=2
	write(6,'(" i c_ion c_rec c_ex =",
     *  i4,6(1pe11.4))'),
     *  i,c_ion1,c_rec2,c_ex2
     ...
     *  i,rin_zog(i),rre_zog(i),rcx_zog(i)
      ...
      S_iT=c_ion0
      S_iz=S_iT
      S_cx=7.94d-1*(13.6/24.6)**2*(T_i/4)**0.327d0
...
!      c_rec2=0.
      ...
      a11=V_p/tay+V_p/tay_p+n_e*c_ion1*1.e7*V_n+n_e*c_rec1*1.e7*V_n
      a12=-n_e*c_rec2*1.e7*V_n
      a13=-n_e*c_ion0*1.e7*V_n

      a21=-n_e*c_ion1*1.e7*V_n
      a22=V_p/tay+V_p/tay_p+n_e*c_rec2*1.e7*V_n
      a23=0.

      a31=-psi_n*V_p/tay_p+g_v*(1.d0+t_a/tay)
!      a31=0.
      
      a32=-psi_n*V_p/tay_p+g_v*(1.d0+t_a/tay)
      
      a33=V_v0/tay+n_e*c_ion0*1.e7*V_n

      f1=V_p0*he10/tay 
      f2=V_p0*he20/tay 
      f3=V_v00/tay*n00+g_v*(pn_prog+t_a/tay*n_d0)

      if(kpr.eq.1)print *,' pn_prog he2==',pn_prog,he2
	...
	call obrm(a_m,a1_m,d_m,kf,n_mat)

      do i=1,n_mat
      x_m(i)=0
      do k=1,n_mat
      x_m(i)=x_m(i)+a1_m(i,k)*f_m(k)
      end do
      end do
	...
	print*,'o ++ kay pf'
      ...
      if(kpr.eq.1)then
      print *,' he1 he2==',he1,he2
      print *,' he10 he20==',he10,he20

      f1_left=a11*he1+a12*he2+a13*x_m(3)
      print *,' f1_left f1',f1_left,f1
      f2_left=a21*he1+a22*he2+a23*x_m(3)
      print *,' f2_left f2',f2_left,f2
      f3_left=a31*he1+a32*he2+a33*x_m(3)
      print *,' f3_left f3',f3_left,f3
      end if
...
c*** Mineev's case
      ...
      if(kpr.eq.1)then
	write(6,'("  qloss_ion  P_ioniz qloss_rad P_rad",
     *  6(1pe12.5))'),
     *  qloss_ion,  P_ioniz, qloss_rad, P_rad

      print *,' qlos_e q_bal=',qlos_e,q_bal
...
c  Neutrals Temperature .. tn=ti?
      tn=tempi(i)
        ...
        den_e=(he1+2.d0*he2)*10.
!        den_e=den_i
        
!        print *,' den_e1 den_e==',den_e1,den_e
...
c Local arrays
	...
	write(6,'("  ##  i  I R SCX ",
     *  i4,6(1pe12.5))'),
     *  i,rin_zog(i)*1.d-6,rre_zog(i)*1.d-6,rcx_zog(i)*1.d-6
...
c     *  i,j,c_ion,c_rec,c_ex,a_imp(i,j)
	...
	if(kpr.eq.1)write(6,'(" i d_imp d_imp0 sum0",
     *  i4,6(1pe12.5))'),
     *  i,d_imp(i),d_imp0(i),den_im_sum0
      ...
      subroutine en_01_he1()
      include 'double.inc'
      include 'new_com.inc'
      include 'br_com.inc'

      call en_01_he1_c(n_rad,
     * tay,kpr,n_e,n_e0,n_d,n_d0,n0,n00,T_e,T_e0,T_i,T_i0,
     * pi,a_min,R_maj,tt,n_i,n_i0,
     * I_p,I_p0,p_oh,p_cx,p_ioniz,p_rad,q_ech,z_eff,v_v0,v_p,
     * sel,v_n,p_lambda,r_pl0,v_v00,tay_ee,
...
c	  [s,MA,T,1019 m-3,AMU,m,MW].
	...
	tay_ee2=0.023*I_p**0.96*Bt**0.073*(n_e*10.)**0.4*a_he**0.2*
     *  R**1.83*eps**(-0.06)*elong**0.64/Qabs**0.73
...
!      p_ch_1=2.4d5*n0*he1*V_n/V_p*S_cx
...
!!!	qlos_imp=sel(1)*1.d-4*16.d0
	...
	qlos_imp=qlos_imp+sel(i)*1.d-1
      ...
      i=1
	write(6,'(" i P_ioniz,P_rad,qlos_imp",
     *  i4,6(1pe12.5))'),
     *  i,P_ioniz,P_rad,qlos_imp
...
c      f1=(P_oh+P_ech)*v_p+v_p0*alfa*n_e0*T_e0/tay
      f1=P_oh+P_ech+alfa*n_e0*T_e0/tay
      f1_2=P_oh+P_ech
      print *,' f1_1 f1_2 ',f1_1,f1_2


	if(kpr.eq.1)then
	write(6,'(" p_ech p_oh q_bal qlos_imp i_p",
     *  6(1pe12.5))'),
     *  p_ech,p_oh,q_bal,qlos_imp,I_p
	end if
...
c       f2=v_p*p_ch_1*T0+alfa*v_p0*n_i0*T_i0/tay 
	...
	if(kpr.eq.1)then
	write(6,'(" f1 alfa n_e0 t_e0 p_oh",
     *  6(1pe12.5))'),
     *  f1,alfa,n_e0,t_e0
	write(6,'(" f2 p_ch_1 n_i0 t_i0",
     *  6(1pe12.5))'),
     *  f2,p_ch_1,n_i0,t_i0
	write(6,'(" a11,a12,a21,a22",
     *  6(1pe12.5))'),
     *  a11,a12,a21,a22
	end if
