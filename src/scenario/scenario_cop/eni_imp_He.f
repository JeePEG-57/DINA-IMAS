     ...
     *       key_h_to_l,w_imp,w_imp2,w_imp3,w_imp4,w_imp5)
...
c
	...
	dimension q_imp(npo),q_imp1(npo),q_imp2(npo),q_imp3(npo)
	dimension q_imp4(npo),q_imp5(npo)
...
c==================
 ...
 !    if(kpr.eq.1)print *,' gamma_z4 pn_d_t(i) pn_d_t(i-1)==',
 !   *  gamma_z4,pn_d_t(i),pn_d_t(i-1)
...
!      read (*,*)
	...
	i_sh=i_sh+1
      ...
      if(kpr.eq.1)print *,' i_sh==',i_sh

	if(i_sh.eq.1)then
c-------
           open (unit=41,file='gamma_z5.dat',form='formatted') 
           read (41,*) 
           read (41,*)n_t 
           read (41,*) 
...
c
      ...
      if(kpr.eq.1)print *,' tt gamma_z5==',tt,gamma_z5
c	stop
