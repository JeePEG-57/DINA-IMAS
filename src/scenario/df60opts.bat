...
rem
rem    $Revision: 1.1.6.1 $  $Date: 2009/08/14 03:21:43 $
rem
rem ********************************************************************
...
set INCLUDE=%IFORT_COMPILER12%\Include;%LINKERDIR%\include;%VCINSTALLDIR%\ATLMFC\INCLUDE;%VCINSTALLDIR%\INCLUDE;%VCINSTALLDIR%\VCPackages;%INCLUDE%
set LIB=%IFORT_COMPILER12%\Lib\Intel64;%LINKERDIR%\LIB\x64;%VCINSTALLDIR%\LIB\amd64;%VCINSTALLDIR%\ATLMFC\LIB\amd64;%MATLAB%\extern\lib\win64;%LIB%
...
rem ********************************************************************
set COMPILER=ifort
set COMPFLAGS=/fpp /Qprec /iface:cref "/I%MATLAB%/extern/include" -c -w -nologo -DMATLAB_MEX_FILE /Qsave /fixed /MD /fp:source OPTIMFLAGS=/O2 /DNDEBUG
set DEBUGFLAGS=/Z7
set NAME_OBJECT=/Fo
