...
MODEL                   = t15_2
MODULES                 = rtGetInf.c rtGetNaN.c rt_look.c rt_look1d.c rt_nonfinite.c rt_rand.c t15_2_data.c 
MAKEFILE                = t15_2.mk
...
GEN_SAMPLE_MAIN         = 1
TARGET_LANG_EXT         = c
MEX_OPT_FILE            = -f C:\Users\vera\AppData\Roaming\MATHWO~1\MATLAB\R2009b\mexopts.bat
...
MODELLIB                  = t15_2lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = t15_2_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\t15_2_ert_shrlib_rtw
...
$(PRODUCT) : $(PREBUILT_OBJS) $(OBJS) $(MODELLIB) $(SHARED_LIB) $(LIBS) $(MODELREF_LINK_LIBS)
	@cmd /C "echo ### Linking ..."
	$(PERL) $(GEN_LNK_SCRIPT) $(CMD_FILE) $(OBJS) 
	$(LD) $(LDFLAGS) $(S_FUNCTIONS_LIB) $(MODELLIB) $(SHARED_LIB) $(LIBS) $(PREBUILT_OBJS) @$(CMD_FILE) @$(MODELREF_LINK_RSPFILE) -out:$@
	@del $(CMD_FILE)
