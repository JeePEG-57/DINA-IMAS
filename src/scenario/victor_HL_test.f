...
!	print*,'next ntay tpl cip1',next,ntay,tpl,cip1
...
c
!	PRINT*,'i NMX NMY turn',i,NMX(I),nmy(i),turn(i)
	read(41,*)R_c(I),Z_c(I),dr(i),dz(i)
!	PRINT *,'r_c z_c dr dz ',r_c(i),z_c(i),dr(i),dz(i)
	END DO
...
!	print*,'1from vic_feed_aux'
	!print*,'emoe emoq betpj tt',emoe,emoq,betpj,tt
...
ccc	betp_flat=0.62
c	betp_flat=0.6
cccccccccccccccccccccccc	betp_flat=0.59
	betp_flat=0.58
c	betp_end=0.5
c	betp_end=0.4
	betp_end=0.43
