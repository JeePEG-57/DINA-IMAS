...
!      if(kpr.eq.1)print *,' i_en zvel=',i_en,zvel
...
!      krref=0
	...
	it1=1
      ...
      if(kpr.eq.1)then
      ddd2=abs(zvel-zvel_0)
      ddd1=0.05*abs(zvel)+1.e-3
      print *,' it1 zvel_tran zvel zvel_0=',it1,zvel_tran,zvel,zvel_0
      end if
...
!      if(kpr.eq.1)print *,' ntay zvel=',ntay,zvel
