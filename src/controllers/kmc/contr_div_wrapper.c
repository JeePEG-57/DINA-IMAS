...
printf("---contr_div_vs3 K_hl kl kl2 %d %d %d \n",K_hl,kl,kl2);
...
printf("---contr_divrd_vs3 K_hl kl2  N_st2 N_out %d %d %d %d \n",K_hl,kl2,N_st2,N_out);

for(i=0; i<N_st2+N_out; i++) for(j=0;j<N_st2+N_in; j++) fscanf(f,"%lf",y2[i]+j);
fclose(f);

printf("---contr_divrd_vs3 i= %d\n",i);
