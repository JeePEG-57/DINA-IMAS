...
for(i=0;i<N;i++) {
fgets(b,255,f);
sscanf(b,"%lf %lf",y_1[i],y_1[i]+1);
printf("--- i y_1[0] y_1[1] %d %g %g \n",i,y_1[i][0],y_1[i][1]);
}
//fclose(f);
...
for(i=0;i<N;i++) {
fgets(b,255,f);
sscanf(b,"%lf %lf",y_2[i],y_2[i]+1);
printf("--- i y_2[0] y_2[1] %d %g %g \n",i,y_2[i][0],y_2[i][1]);
}
//fclose(f);
...
for(i=0;i<N;i++){
fgets(b,255,f);
sscanf(b,"%lf %lf",y_3[i],y_3[i]+1);
printf("--- i y_3[0] y_3[1] %d %g %g \n",i,y_3[i][0],y_3[i][1]);
}
//fclose(f);
...
for(i=0;i<N;i++) {
	fgets(b,255,f);
	sscanf(b,"%lf %lf",y_4[i],y_4[i]+1);
printf("--- i y_4[0] y_4[1] %d %g %g \n",i,y_4[i][0],y_4[i][1]);
}
//fclose(f);
...
for(i=0;i<N;i++) {
fgets(b,255,f);
sscanf(b,"%lf %lf",y_5[i],y_5[i]+1);
printf("--- i y_5[0] y_5[1] %d %g %g \n",i,y_5[i][0],y_5[i][1]);
}
//fclose(f);
...
fgets(b,255,f);
fscanf(f,"%d ",&N); 
printf("---g6_term.dat N %d\n",N);
fgets(b,255,f);
for(i=0;i<N;i++) {
fgets(b,255,f);
sscanf(b,"%lf %lf",y_6[i],y_6[i]+1);
printf("--- i y_6[0] y_6[1] %d %g %g \n",i,y_6[i][0],y_6[i][1]);
}
fscanf(f,"%d ",&N); 
printf("---g6_term.dat finished %d \n",N);
