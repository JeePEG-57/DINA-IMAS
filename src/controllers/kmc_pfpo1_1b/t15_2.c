...
void t15_2_step(void)
{
  ...
  t15_2_B.RelationalOperator_l = (t15_2_B.Times >= t15_2_B.Sum2);
  ...
  t15_2_B.RelationalOperator1_l = (t15_2_B.Times >= t15_2_B.DataStoreRead1);

  /* Stop: '<S5>/Stop Simulation1' */
  if (t15_2_B.RelationalOperator1_l) {
    rtmSetStopRequested(t15_2_M, 1);
  }
   ...
   */
  for (i = 0; i < 15; i++) {
    t15_2_B.e6_e[i] = t15_2_U.In2[i + 6] * t15_2_P.e6_Gain_n;
  }
  ...
  t15_2_B.DataStoreRead1_m = t15_2_DWork.RupRd[4];

  /* Gain: '<S18>/1e-3' */
  t15_2_B.e3 = t15_2_P.e3_Gain * t15_2_B.DataStoreRead1_m;
   ...
   */
  t15_2_B.Add1 = t15_2_B.Product + t15_2_P.Constant4_Value_c;
  ...
  /* Memory: '<S19>/Memory1' */
  t15_2_B.Memory1_j = t15_2_DWork.Memory1_PreviousInput_k;

  /* Switch: '<S19>/c_eob' */
  if (t15_2_B.u_a >= t15_2_P.c_eob_Threshold_f) {
    for (i = 0; i < 500; i++) {
      /* DataStoreRead: '<S19>/Data Store Read1' */
      t15_2_B.DataStoreRead1_fv[i] = t15_2_DWork.scr_data[13 * i + 1];

      /* DataStoreRead: '<S19>/Data Store Read' */
      t15_2_B.DataStoreRead_dl[i] = t15_2_DWork.scr_data[13 * i];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.Ipref), &t15_2_B.DataStoreRead1_fv[0],
                         t15_2_B.Times, &t15_2_B.DataStoreRead_dl[0], 499U);
  ...
  /* Product: '<S19>/Divide6' */
  t15_2_B.Divide6 = t15_2_B.c_eob * t15_2_B.u_a;
  ...
  /* Memory: '<S45>/Memory2' */
  t15_2_B.Memory2_g = t15_2_DWork.Memory2_PreviousInput_m;

  /* Switch: '<S45>/c_eob  1' */
  if (t15_2_B.u_a >= t15_2_P.c_eob1_Threshold) {
    for (i = 0; i < 50; i++) {
      /* Selector: '<S45>/Selector' */
      t15_2_B.Selector_h[i] = t15_2_B.SFunction1_a[(i << 1) + 1];

      /* Selector: '<S45>/Selector1' */
      t15_2_B.Selector1_b[i] = t15_2_B.SFunction1_a[i << 1];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.g1ref), &t15_2_B.Selector_h[0],
                         t15_2_B.Times, &t15_2_B.Selector1_b[0], 49U);
    t15_2_B.c_eob1 = t15_2_B.g1ref;
  } else {
    t15_2_B.c_eob1 = t15_2_B.Memory2_g;
  }

  /* End of Switch: '<S45>/c_eob  1' */

  /* Memory: '<S45>/Memory1' */
  t15_2_B.Memory1_c = t15_2_DWork.Memory1_PreviousInput_d;

  /* Switch: '<S45>/c_eob  ' */
  if (t15_2_B.u_a >= t15_2_P.c_eob_Threshold_n) {
    t15_2_B.c_eob_a = t15_2_B.Times;
  } else {
    t15_2_B.c_eob_a = t15_2_B.Memory1_c;
  }
  ...
  /* Switch: '<S45>/c_eob' */
  if (t15_2_B.u_a >= t15_2_P.c_eob_Threshold_o) {
    t15_2_B.c_eob_d = t15_2_B.c_eob1;
  } else {
    ...
    for (i = 0; i < 49; i++) {
      ...
      t15_2_B.Selector[i] = t15_2_B.SFunction1_o[((1 + i) << 1) + 1];
    ...
    t15_2_B.DataStoreRead_eg = t15_2_DWork.RupRd[1];
    for (i = 0; i < 50; i++) {
      /* Selector: '<S51>/Selector1' */
      t15_2_B.Selector1[i] = t15_2_B.SFunction1_o[i << 1];

      /* Product: '<S51>/Divide6' */
      t15_2_B.Divide6_e4r[i] = t15_2_B.Selector1[i] * t15_2_B.DataStoreRead_eg /
        t15_2_B.DataStoreRead1_it;

      /* Sum: '<S51>/Add2' */
      t15_2_B.Add2_c[i] = t15_2_B.c_eob_a + t15_2_B.Divide6_e4r[i];
    }
    ...
    LookUp_real_T_real_T( &(t15_2_B.g1_termref),
                         ...
                         t15_2_B.Times, &t15_2_B.Add2_c[0], 49U);
    t15_2_B.c_eob_d = t15_2_B.g1_termref;
  }

  /* End of Switch: '<S45>/c_eob' */

  /* Sum: '<S23>/Add2' */
  t15_2_B.Add2_p = t15_2_B.e2[0] - t15_2_B.c_eob_d;
  ...
  /* Memory: '<S40>/Memory2' */
  t15_2_B.Memory2_c = t15_2_DWork.Memory2_PreviousInput_j;

  /* Switch: '<S40>/c_eob  1' */
  if (t15_2_B.u_a >= t15_2_P.c_eob1_Threshold_m) {
    for (i = 0; i < 50; i++) {
      /* Selector: '<S40>/Selector' */
      t15_2_B.Selector_a[i] = t15_2_B.SFunction1_b[(i << 1) + 1];

      /* Selector: '<S40>/Selector1' */
      t15_2_B.Selector1_fu[i] = t15_2_B.SFunction1_b[i << 1];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.g2ref), &t15_2_B.Selector_a[0],
                         t15_2_B.Times, &t15_2_B.Selector1_fu[0], 49U);
    t15_2_B.c_eob1_p = t15_2_B.g2ref;
  } else {
    t15_2_B.c_eob1_p = t15_2_B.Memory2_c;
  }
  ...
  /* Switch: '<S40>/c_eob  ' */
  if (t15_2_B.u_a >= t15_2_P.c_eob_Threshold_c) {
    t15_2_B.c_eob_k = t15_2_B.Times;
  } else {
    t15_2_B.c_eob_k = t15_2_B.Memory1_i;
  }
  ...
  /* Switch: '<S40>/c_eob' */
  if (t15_2_B.u_a >= t15_2_P.c_eob_Threshold_m) {
    t15_2_B.c_eob_c = t15_2_B.c_eob1_p;
  } else {
    /* SignalConversion: '<S46>/TmpSignal ConversionAtg2_term,refInport3' */
    t15_2_B.TmpSignalConversionAtg2_termref[0] = t15_2_B.c_eob1_p;
    for (i = 0; i < 49; i++) {
      /* Selector: '<S46>/Selector' */
      t15_2_B.Selector_c[i] = t15_2_B.SFunction1_h[((1 + i) << 1) + 1];
      t15_2_B.TmpSignalConversionAtg2_termref[i + 1] = t15_2_B.Selector_c[i];
    }

    /* End of SignalConversion: '<S46>/TmpSignal ConversionAtg2_term,refInport3' */

    /* DataStoreRead: '<S46>/Data Store Read1' */
    t15_2_B.DataStoreRead1_oc = t15_2_DWork.trd_ref;

    /* DataStoreRead: '<S46>/Data Store Read' */
    t15_2_B.DataStoreRead_fk = t15_2_DWork.RupRd[1];
    for (i = 0; i < 50; i++) {
      /* Selector: '<S46>/Selector1' */
      t15_2_B.Selector1_f[i] = t15_2_B.SFunction1_h[i << 1];

      /* Product: '<S46>/Divide6' */
      t15_2_B.Divide6_h[i] = t15_2_B.Selector1_f[i] * t15_2_B.DataStoreRead_fk /
        t15_2_B.DataStoreRead1_oc;

      /* Sum: '<S46>/Add2' */
      t15_2_B.Add2_j[i] = t15_2_B.c_eob_k + t15_2_B.Divide6_h[i];
    }
    ...
    t15_2_B.c_eob_c = t15_2_B.g2_termref;
  }

  /* End of Switch: '<S40>/c_eob' */

  /* Sum: '<S23>/Add1' */
  t15_2_B.Add1_d = t15_2_B.e2[1] - t15_2_B.c_eob_c;
  ...
  /* Memory: '<S41>/Memory2' */
  t15_2_B.Memory2_m = t15_2_DWork.Memory2_PreviousInput_l;

  /* Switch: '<S41>/c_eob  1' */
  if (t15_2_B.u_a >= t15_2_P.c_eob1_Threshold_f) {
    for (i = 0; i < 50; i++) {
      /* Selector: '<S41>/Selector' */
      t15_2_B.Selector_ez[i] = t15_2_B.SFunction1_k[(i << 1) + 1];

      /* Selector: '<S41>/Selector1' */
      t15_2_B.Selector1_kl[i] = t15_2_B.SFunction1_k[i << 1];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.g3ref), &t15_2_B.Selector_ez[0],
                         t15_2_B.Times, &t15_2_B.Selector1_kl[0], 49U);
    t15_2_B.c_eob1_l = t15_2_B.g3ref;
  } else {
    t15_2_B.c_eob1_l = t15_2_B.Memory2_m;
  }

  /* End of Switch: '<S41>/c_eob  1' */

  /* Memory: '<S41>/Memory1' */
  t15_2_B.Memory1_cm = t15_2_DWork.Memory1_PreviousInput_h;

  /* Switch: '<S41>/c_eob  ' */
  if (t15_2_B.u_a >= t15_2_P.c_eob_Threshold_e) {
    t15_2_B.c_eob_i = t15_2_B.Times;
  } else {
    t15_2_B.c_eob_i = t15_2_B.Memory1_cm;
  }
  ...
  /* Switch: '<S41>/c_eob' */
  if (t15_2_B.u_a >= t15_2_P.c_eob_Threshold_j) {
    t15_2_B.c_eob_a0 = t15_2_B.c_eob1_l;
  } else {
    /* SignalConversion: '<S47>/TmpSignal ConversionAtg3_term,refInport3' */
    t15_2_B.TmpSignalConversionAtg3_termref[0] = t15_2_B.c_eob1_l;
    for (i = 0; i < 49; i++) {
      /* Selector: '<S47>/Selector' */
      t15_2_B.Selector_n[i] = t15_2_B.SFunction1_ov[((1 + i) << 1) + 1];
      t15_2_B.TmpSignalConversionAtg3_termref[i + 1] = t15_2_B.Selector_n[i];
    }

    /* End of SignalConversion: '<S47>/TmpSignal ConversionAtg3_term,refInport3' */

    /* DataStoreRead: '<S47>/Data Store Read1' */
    t15_2_B.DataStoreRead1_lh = t15_2_DWork.trd_ref;

    /* DataStoreRead: '<S47>/Data Store Read' */
    t15_2_B.DataStoreRead_mb = t15_2_DWork.RupRd[1];
    for (i = 0; i < 50; i++) {
      /* Selector: '<S47>/Selector1' */
      t15_2_B.Selector1_k[i] = t15_2_B.SFunction1_ov[i << 1];

      /* Product: '<S47>/Divide6' */
      t15_2_B.Divide6_m[i] = t15_2_B.Selector1_k[i] * t15_2_B.DataStoreRead_mb /
        t15_2_B.DataStoreRead1_lh;

      /* Sum: '<S47>/Add2' */
      t15_2_B.Add2_l[i] = t15_2_B.c_eob_i + t15_2_B.Divide6_m[i];
    }
    ...
    t15_2_B.c_eob_a0 = t15_2_B.g3_termref;
  }

  /* End of Switch: '<S41>/c_eob' */

  /* Sum: '<S23>/Add3' */
  t15_2_B.Add3 = t15_2_B.e2[2] - t15_2_B.c_eob_a0;
  ...
  /* Memory: '<S42>/Memory2' */
  t15_2_B.Memory2_a = t15_2_DWork.Memory2_PreviousInput_a;

  /* Switch: '<S42>/c_eob  1' */
  if (t15_2_B.u_a >= t15_2_P.c_eob1_Threshold_j) {
    for (i = 0; i < 50; i++) {
      /* Selector: '<S42>/Selector' */
      t15_2_B.Selector_d[i] = t15_2_B.SFunction1_ob[(i << 1) + 1];

      /* Selector: '<S42>/Selector1' */
      t15_2_B.Selector1_av[i] = t15_2_B.SFunction1_ob[i << 1];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.g4ref), &t15_2_B.Selector_d[0],
                         t15_2_B.Times, &t15_2_B.Selector1_av[0], 49U);
    t15_2_B.c_eob1_d = t15_2_B.g4ref;
  } else {
    t15_2_B.c_eob1_d = t15_2_B.Memory2_a;
  }

  /* End of Switch: '<S42>/c_eob  1' */

  /* Memory: '<S42>/Memory1' */
  t15_2_B.Memory1_o = t15_2_DWork.Memory1_PreviousInput_da;

  /* Switch: '<S42>/c_eob  ' */
  if (t15_2_B.u_a >= t15_2_P.c_eob_Threshold_i) {
    t15_2_B.c_eob_e = t15_2_B.Times;
  } else {
    t15_2_B.c_eob_e = t15_2_B.Memory1_o;
  }
  ...
  /* Switch: '<S42>/c_eob' */
  if (t15_2_B.u_a >= t15_2_P.c_eob_Threshold_h) {
    t15_2_B.c_eob_kv = t15_2_B.c_eob1_d;
  } else {
    ...
    for (i = 0; i < 49; i++) {
      ...
      t15_2_B.Selector_hy[i] = t15_2_B.SFunction1_kp[((1 + i) << 1) + 1];
      t15_2_B.TmpSignalConversionAtg4_termref[i + 1] = t15_2_B.Selector_hy[i];
    }

    /* End of SignalConversion: '<S48>/TmpSignal ConversionAtg4_term,refInport3' */

    /* DataStoreRead: '<S48>/Data Store Read1' */
    t15_2_B.DataStoreRead1_lx = t15_2_DWork.trd_ref;

    /* DataStoreRead: '<S48>/Data Store Read' */
    t15_2_B.DataStoreRead_o0 = t15_2_DWork.RupRd[1];
    for (i = 0; i < 50; i++) {
      /* Selector: '<S48>/Selector1' */
      t15_2_B.Selector1_iu[i] = t15_2_B.SFunction1_kp[i << 1];

      /* Product: '<S48>/Divide6' */
      t15_2_B.Divide6_j[i] = t15_2_B.Selector1_iu[i] * t15_2_B.DataStoreRead_o0 /
        t15_2_B.DataStoreRead1_lx;

      /* Sum: '<S48>/Add2' */
      t15_2_B.Add2_a[i] = t15_2_B.c_eob_e + t15_2_B.Divide6_j[i];
    }
    ...
    t15_2_B.c_eob_kv = t15_2_B.g4_termref;
  }

  /* End of Switch: '<S42>/c_eob' */

  /* Sum: '<S23>/Add4' */
  t15_2_B.Add4 = t15_2_B.e2[3] - t15_2_B.c_eob_kv;

  /* DataStoreRead: '<S23>/Data Store Read' */
  t15_2_B.DataStoreRead_l = t15_2_DWork.t_tran2D;

  /* RelationalOperator: '<S23>/Relational Operator1' */
  t15_2_B.RelationalOperator1 = (t15_2_B.Times > t15_2_B.DataStoreRead_l);
  ...
  /* Memory: '<S43>/Memory2' */
  t15_2_B.Memory2_n = t15_2_DWork.Memory2_PreviousInput_a0;

  /* Switch: '<S43>/c_eob  1' */
  if (t15_2_B.u_a >= t15_2_P.c_eob1_Threshold_mp) {
    for (i = 0; i < 50; i++) {
      /* Selector: '<S43>/Selector' */
      t15_2_B.Selector_e[i] = t15_2_B.SFunction1_j[(i << 1) + 1];

      /* Selector: '<S43>/Selector1' */
      t15_2_B.Selector1_m[i] = t15_2_B.SFunction1_j[i << 1];
    }
    ...
    t15_2_B.c_eob1_l5 = t15_2_B.g5ref;
  } else {
    t15_2_B.c_eob1_l5 = t15_2_B.Memory2_n;
  }

  /* End of Switch: '<S43>/c_eob  1' */

  /* Memory: '<S43>/Memory1' */
  t15_2_B.Memory1_ii = t15_2_DWork.Memory1_PreviousInput_m;

  /* Switch: '<S43>/c_eob  ' */
  if (t15_2_B.u_a >= t15_2_P.c_eob_Threshold_b) {
    t15_2_B.c_eob_kr = t15_2_B.Times;
  } else {
    t15_2_B.c_eob_kr = t15_2_B.Memory1_ii;
  }
  ...
  /* Switch: '<S43>/c_eob' */
  if (t15_2_B.u_a >= t15_2_P.c_eob_Threshold_iu) {
    t15_2_B.c_eob_b = t15_2_B.c_eob1_l5;
  } else {
    /* SignalConversion: '<S49>/TmpSignal ConversionAtg5_term,refInport3' */
    t15_2_B.TmpSignalConversionAtg5_termref[0] = t15_2_B.c_eob1_l5;
    for (i = 0; i < 49; i++) {
      /* Selector: '<S49>/Selector' */
      t15_2_B.Selector_l[i] = t15_2_B.SFunction1_m[((1 + i) << 1) + 1];
    ...
    t15_2_B.DataStoreRead1_dv = t15_2_DWork.trd_ref;

    /* DataStoreRead: '<S49>/Data Store Read' */
    t15_2_B.DataStoreRead_cy = t15_2_DWork.RupRd[1];
    for (i = 0; i < 50; i++) {
      /* Selector: '<S49>/Selector1' */
      t15_2_B.Selector1_ba[i] = t15_2_B.SFunction1_m[i << 1];

      /* Product: '<S49>/Divide6' */
      t15_2_B.Divide6_b[i] = t15_2_B.Selector1_ba[i] * t15_2_B.DataStoreRead_cy /
        t15_2_B.DataStoreRead1_dv;

      /* Sum: '<S49>/Add2' */
      t15_2_B.Add2_b5[i] = t15_2_B.c_eob_kr + t15_2_B.Divide6_b[i];
    }
    ...
    LookUp_real_T_real_T( &(t15_2_B.g5_termref),
                         ...
                         t15_2_B.Times, &t15_2_B.Add2_b5[0], 49U);
    t15_2_B.c_eob_b = t15_2_B.g5_termref;
  }

  /* End of Switch: '<S43>/c_eob' */

  /* Sum: '<S23>/Add5' */
  t15_2_B.Add5 = t15_2_B.c_eob_b - t15_2_B.e2[4];
  ...
  /* Memory: '<S44>/Memory2' */
  t15_2_B.Memory2_i = t15_2_DWork.Memory2_PreviousInput_h;

  /* Switch: '<S44>/c_eob  1' */
  if (t15_2_B.u_a >= t15_2_P.c_eob1_Threshold_b) {
    for (i = 0; i < 50; i++) {
      /* Selector: '<S44>/Selector' */
      t15_2_B.Selector_k[i] = t15_2_B.SFunction1_e[(i << 1) + 1];

      /* Selector: '<S44>/Selector1' */
      t15_2_B.Selector1_i[i] = t15_2_B.SFunction1_e[i << 1];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.g6ref), &t15_2_B.Selector_k[0],
                         t15_2_B.Times, &t15_2_B.Selector1_i[0], 49U);
    t15_2_B.c_eob1_pv = t15_2_B.g6ref;
  } else {
    t15_2_B.c_eob1_pv = t15_2_B.Memory2_i;
  }

  /* End of Switch: '<S44>/c_eob  1' */

  /* Memory: '<S44>/Memory1' */
  t15_2_B.Memory1_e = t15_2_DWork.Memory1_PreviousInput_o;

  /* Switch: '<S44>/c_eob  ' */
  if (t15_2_B.u_a >= t15_2_P.c_eob_Threshold_m1) {
    t15_2_B.c_eob_j = t15_2_B.Times;
  } else {
    t15_2_B.c_eob_j = t15_2_B.Memory1_e;
  }
  ...
  /* Switch: '<S44>/c_eob' */
  if (t15_2_B.u_a >= t15_2_P.c_eob_Threshold_ov) {
    t15_2_B.c_eob_di = t15_2_B.c_eob1_pv;
  } else {
    /* SignalConversion: '<S50>/TmpSignal ConversionAtg6_term,refInport3' */
    t15_2_B.TmpSignalConversionAtg6_termref[0] = t15_2_B.c_eob1_pv;
    for (i = 0; i < 49; i++) {
      /* Selector: '<S50>/Selector' */
      t15_2_B.Selector_m[i] = t15_2_B.SFunction1_e2[((1 + i) << 1) + 1];
      t15_2_B.TmpSignalConversionAtg6_termref[i + 1] = t15_2_B.Selector_m[i];
    }

    /* End of SignalConversion: '<S50>/TmpSignal ConversionAtg6_term,refInport3' */

    /* DataStoreRead: '<S50>/Data Store Read1' */
    t15_2_B.DataStoreRead1_nu = t15_2_DWork.trd_ref;

    /* DataStoreRead: '<S50>/Data Store Read' */
    t15_2_B.DataStoreRead_gv = t15_2_DWork.RupRd[1];
    for (i = 0; i < 50; i++) {
      /* Selector: '<S50>/Selector1' */
      t15_2_B.Selector1_a[i] = t15_2_B.SFunction1_e2[i << 1];

      /* Product: '<S50>/Divide6' */
      t15_2_B.Divide6_n[i] = t15_2_B.Selector1_a[i] * t15_2_B.DataStoreRead_gv /
        t15_2_B.DataStoreRead1_nu;

      /* Sum: '<S50>/Add2' */
      t15_2_B.Add2_m[i] = t15_2_B.c_eob_j + t15_2_B.Divide6_n[i];
    }
    ...
    t15_2_B.c_eob_di = t15_2_B.g6_termref;
  }

  /* End of Switch: '<S44>/c_eob' */

  /* Sum: '<S23>/Add6' */
  t15_2_B.Add6 = t15_2_B.e2[5] - t15_2_B.c_eob_di;

  /* Gain: '<S23>/1e-2' */
  t15_2_B.e2_f[0] = t15_2_P.e2_Gain_g * t15_2_B.Add2_p;
  t15_2_B.e2_f[1] = t15_2_P.e2_Gain_g * t15_2_B.Add1_d;
  t15_2_B.e2_f[2] = t15_2_P.e2_Gain_g * t15_2_B.Add3;
  t15_2_B.e2_f[3] = t15_2_P.e2_Gain_g * t15_2_B.Divide12;
  t15_2_B.e2_f[4] = t15_2_P.e2_Gain_g * t15_2_B.Add5;
  t15_2_B.e2_f[5] = t15_2_P.e2_Gain_g * t15_2_B.Add6;

  /* Memory: '<S29>/Memory2' */
  t15_2_B.Memory2_k = t15_2_DWork.Memory2_PreviousInput_g;

  /* Switch: '<S29>/c_eob' */
  if (t15_2_B.u_a >= t15_2_P.c_eob_Threshold_cx) {
    for (i = 0; i < 500; i++) {
      /* DataStoreRead: '<S29>/Data Store Read1' */
      t15_2_B.DataStoreRead1_k[i] = t15_2_DWork.scr_data[13 * i + 2];
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.I1_b), &t15_2_B.DataStoreRead1_k[0],
                         t15_2_B.Times, &t15_2_B.DataStoreRead_a[0], 499U);
    t15_2_B.c_eob_f = t15_2_B.I1_b;
  } else {
  ...
  /* Product: '<S29>/Divide1' */
  t15_2_B.Divide1 = t15_2_B.c_eob_f * t15_2_B.u_a;

  /* Sum: '<S22>/Add3' */
  t15_2_B.Add3_p = t15_2_B.e6_e[0] - t15_2_B.Divide1;

  /* Memory: '<S32>/Memory2' */
  t15_2_B.Memory2_b = t15_2_DWork.Memory2_PreviousInput_gi;

  /* Switch: '<S32>/c_eob' */
  if (t15_2_B.u_a >= t15_2_P.c_eob_Threshold_eb) {
    for (i = 0; i < 500; i++) {
      /* DataStoreRead: '<S32>/Data Store Read1' */
      t15_2_B.DataStoreRead1_f5[i] = t15_2_DWork.scr_data[13 * i + 3];
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.I1_n), &t15_2_B.DataStoreRead1_f5[0],
                         t15_2_B.Times, &t15_2_B.DataStoreRead_lz[0], 499U);
    t15_2_B.c_eob_p = t15_2_B.I1_n;
  } else {
    t15_2_B.c_eob_p = t15_2_B.Memory2_b;
  }

  /* End of Switch: '<S32>/c_eob' */

  /* Product: '<S32>/Divide1' */
  t15_2_B.Divide1_o = t15_2_B.c_eob_p * t15_2_B.u_a;

  /* Sum: '<S22>/Add1' */
  t15_2_B.Add1_f = t15_2_B.e6_e[1] - t15_2_B.Divide1_o;

  /* Memory: '<S33>/Memory2' */
  t15_2_B.Memory2_gk = t15_2_DWork.Memory2_PreviousInput_jn;

  /* Switch: '<S33>/c_eob' */
  if (t15_2_B.u_a >= t15_2_P.c_eob_Threshold_jq) {
    for (i = 0; i < 500; i++) {
      /* DataStoreRead: '<S33>/Data Store Read1' */
      t15_2_B.DataStoreRead1_ph[i] = t15_2_DWork.scr_data[13 * i + 4];

      /* DataStoreRead: '<S33>/Data Store Read' */
      t15_2_B.DataStoreRead_i[i] = t15_2_DWork.scr_data[13 * i];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.I1_a), &t15_2_B.DataStoreRead1_ph[0],
                         t15_2_B.Times, &t15_2_B.DataStoreRead_i[0], 499U);
    t15_2_B.c_eob_n = t15_2_B.I1_a;
  } else {
    t15_2_B.c_eob_n = t15_2_B.Memory2_gk;
  }

  /* End of Switch: '<S33>/c_eob' */

  /* Product: '<S33>/Divide1' */
  t15_2_B.Divide1_a = t15_2_B.c_eob_n * t15_2_B.u_a;

  /* Sum: '<S22>/Add2' */
  t15_2_B.Add2_g = t15_2_B.e6_e[2] - t15_2_B.Divide1_a;

  /* Memory: '<S34>/Memory2' */
  t15_2_B.Memory2_ko = t15_2_DWork.Memory2_PreviousInput_i;

  /* Switch: '<S34>/c_eob' */
  if (t15_2_B.u_a >= t15_2_P.c_eob_Threshold_g) {
    for (i = 0; i < 500; i++) {
      /* DataStoreRead: '<S34>/Data Store Read1' */
      t15_2_B.DataStoreRead1_ah[i] = t15_2_DWork.scr_data[13 * i + 5];

      /* DataStoreRead: '<S34>/Data Store Read' */
      t15_2_B.DataStoreRead_ml[i] = t15_2_DWork.scr_data[13 * i];
    }
    ...
    LookUp_real_T_real_T( &(t15_2_B.I1_o), &t15_2_B.DataStoreRead1_ah[0],
                         t15_2_B.Times, &t15_2_B.DataStoreRead_ml[0], 499U);
    t15_2_B.c_eob_o = t15_2_B.I1_o;
  } else {
    t15_2_B.c_eob_o = t15_2_B.Memory2_ko;
  }

  /* End of Switch: '<S34>/c_eob' */

  /* Product: '<S34>/Divide1' */
  t15_2_B.Divide1_k = t15_2_B.c_eob_o * t15_2_B.u_a;

  /* Sum: '<S22>/Add4' */
  t15_2_B.Add4_m = t15_2_B.e6_e[3] - t15_2_B.Divide1_k;

  /* Memory: '<S35>/Memory2' */
  t15_2_B.Memory2_nn = t15_2_DWork.Memory2_PreviousInput_jj;

  /* Switch: '<S35>/c_eob' */
  if (t15_2_B.u_a >= t15_2_P.c_eob_Threshold_gt) {
    for (i = 0; i < 500; i++) {
      /* DataStoreRead: '<S35>/Data Store Read1' */
      t15_2_B.DataStoreRead1_fz[i] = t15_2_DWork.scr_data[13 * i + 6];

      /* DataStoreRead: '<S35>/Data Store Read' */
      t15_2_B.DataStoreRead_kq[i] = t15_2_DWork.scr_data[13 * i];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.I1_gs), &t15_2_B.DataStoreRead1_fz[0],
                         t15_2_B.Times, &t15_2_B.DataStoreRead_kq[0], 499U);
    t15_2_B.c_eob_m = t15_2_B.I1_gs;
  } else {
    t15_2_B.c_eob_m = t15_2_B.Memory2_nn;
  }

  /* End of Switch: '<S35>/c_eob' */

  /* Product: '<S35>/Divide1' */
  t15_2_B.Divide1_j = t15_2_B.c_eob_m * t15_2_B.u_a;

  /* Sum: '<S22>/Add5' */
  t15_2_B.Add5_c = t15_2_B.e6_e[4] - t15_2_B.Divide1_j;

  /* Memory: '<S36>/Memory2' */
  t15_2_B.Memory2_l = t15_2_DWork.Memory2_PreviousInput_k;

  /* Switch: '<S36>/c_eob' */
  if (t15_2_B.u_a >= t15_2_P.c_eob_Threshold_l) {
    for (i = 0; i < 500; i++) {
      /* DataStoreRead: '<S36>/Data Store Read1' */
      t15_2_B.DataStoreRead1_h5[i] = t15_2_DWork.scr_data[13 * i + 7];

      /* DataStoreRead: '<S36>/Data Store Read' */
      t15_2_B.DataStoreRead_ec[i] = t15_2_DWork.scr_data[13 * i];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.I1_g), &t15_2_B.DataStoreRead1_h5[0],
                         t15_2_B.Times, &t15_2_B.DataStoreRead_ec[0], 499U);
    t15_2_B.c_eob_pa = t15_2_B.I1_g;
  } else {
    t15_2_B.c_eob_pa = t15_2_B.Memory2_l;
  }

  /* End of Switch: '<S36>/c_eob' */

  /* Product: '<S36>/Divide1' */
  t15_2_B.Divide1_p = t15_2_B.c_eob_pa * t15_2_B.u_a;

  /* Sum: '<S22>/Add6' */
  t15_2_B.Add6_p = t15_2_B.e6_e[5] - t15_2_B.Divide1_p;

  /* Memory: '<S37>/Memory2' */
  t15_2_B.Memory2_d = t15_2_DWork.Memory2_PreviousInput_in;

  /* Switch: '<S37>/c_eob' */
  if (t15_2_B.u_a >= t15_2_P.c_eob_Threshold_og) {
    for (i = 0; i < 500; i++) {
      /* DataStoreRead: '<S37>/Data Store Read1' */
      t15_2_B.DataStoreRead1_m3[i] = t15_2_DWork.scr_data[13 * i + 8];

      /* DataStoreRead: '<S37>/Data Store Read' */
      t15_2_B.DataStoreRead_p5[i] = t15_2_DWork.scr_data[13 * i];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.I1_e), &t15_2_B.DataStoreRead1_m3[0],
                         t15_2_B.Times, &t15_2_B.DataStoreRead_p5[0], 499U);
    t15_2_B.c_eob_cb = t15_2_B.I1_e;
  } else {
    t15_2_B.c_eob_cb = t15_2_B.Memory2_d;
  }

  /* End of Switch: '<S37>/c_eob' */

  /* Product: '<S37>/Divide1' */
  t15_2_B.Divide1_oe = t15_2_B.c_eob_cb * t15_2_B.u_a;

  /* Sum: '<S22>/Add7' */
  t15_2_B.Add7 = t15_2_B.e6_e[6] - t15_2_B.Divide1_oe;

  /* Memory: '<S38>/Memory2' */
  t15_2_B.Memory2_nx = t15_2_DWork.Memory2_PreviousInput_af;

  /* Switch: '<S38>/c_eob' */
  if (t15_2_B.u_a >= t15_2_P.c_eob_Threshold_fz) {
    for (i = 0; i < 500; i++) {
      /* DataStoreRead: '<S38>/Data Store Read1' */
      t15_2_B.DataStoreRead1_ac[i] = t15_2_DWork.scr_data[13 * i + 9];

      /* DataStoreRead: '<S38>/Data Store Read' */
      t15_2_B.DataStoreRead_m1[i] = t15_2_DWork.scr_data[13 * i];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.I1_i), &t15_2_B.DataStoreRead1_ac[0],
                         t15_2_B.Times, &t15_2_B.DataStoreRead_m1[0], 499U);
    t15_2_B.c_eob_jb = t15_2_B.I1_i;
  } else {
    t15_2_B.c_eob_jb = t15_2_B.Memory2_nx;
  }

  /* End of Switch: '<S38>/c_eob' */

  /* Product: '<S38>/Divide1' */
  t15_2_B.Divide1_f = t15_2_B.c_eob_jb * t15_2_B.u_a;

  /* Sum: '<S22>/Add8' */
  t15_2_B.Add8 = t15_2_B.e6_e[7] - t15_2_B.Divide1_f;

  /* Memory: '<S39>/Memory2' */
  t15_2_B.Memory2_dj = t15_2_DWork.Memory2_PreviousInput_gb;

  /* Switch: '<S39>/c_eob' */
  if (t15_2_B.u_a >= t15_2_P.c_eob_Threshold_p) {
    for (i = 0; i < 500; i++) {
      /* DataStoreRead: '<S39>/Data Store Read1' */
      t15_2_B.DataStoreRead1_a[i] = t15_2_DWork.scr_data[13 * i + 10];

      /* DataStoreRead: '<S39>/Data Store Read' */
      t15_2_B.DataStoreRead_cw[i] = t15_2_DWork.scr_data[13 * i];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.I1), &t15_2_B.DataStoreRead1_a[0],
                         t15_2_B.Times, &t15_2_B.DataStoreRead_cw[0], 499U);
    t15_2_B.c_eob_id = t15_2_B.I1;
  } else {
    t15_2_B.c_eob_id = t15_2_B.Memory2_dj;
  }

  /* End of Switch: '<S39>/c_eob' */

  /* Product: '<S39>/Divide1' */
  t15_2_B.Divide1_g = t15_2_B.c_eob_id * t15_2_B.u_a;

  /* Sum: '<S22>/Add9' */
  t15_2_B.Add9 = t15_2_B.e6_e[8] - t15_2_B.Divide1_g;

  /* Memory: '<S30>/Memory2' */
  t15_2_B.Memory2_mw = t15_2_DWork.Memory2_PreviousInput_jo;

  /* Switch: '<S30>/c_eob' */
  if (t15_2_B.u_a >= t15_2_P.c_eob_Threshold_mg) {
    for (i = 0; i < 500; i++) {
      /* DataStoreRead: '<S30>/Data Store Read1' */
      t15_2_B.DataStoreRead1_az[i] = t15_2_DWork.scr_data[13 * i + 11];

      /* DataStoreRead: '<S30>/Data Store Read' */
      t15_2_B.DataStoreRead_lb[i] = t15_2_DWork.scr_data[13 * i];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.I1_if), &t15_2_B.DataStoreRead1_az[0],
                         t15_2_B.Times, &t15_2_B.DataStoreRead_lb[0], 499U);
    t15_2_B.c_eob_l = t15_2_B.I1_if;
  } else {
    t15_2_B.c_eob_l = t15_2_B.Memory2_mw;
  }

  /* End of Switch: '<S30>/c_eob' */

  /* Product: '<S30>/Divide1' */
  t15_2_B.Divide1_gk = t15_2_B.c_eob_l * t15_2_B.u_a;

  /* Sum: '<S22>/Add10' */
  t15_2_B.Add10 = t15_2_B.e6_e[9] - t15_2_B.Divide1_gk;

  /* Memory: '<S31>/Memory2' */
  t15_2_B.Memory2_o = t15_2_DWork.Memory2_PreviousInput_hr;

  /* Switch: '<S31>/c_eob' */
  if (t15_2_B.u_a >= t15_2_P.c_eob_Threshold_d) {
    for (i = 0; i < 500; i++) {
      /* DataStoreRead: '<S31>/Data Store Read1' */
      t15_2_B.DataStoreRead1_ek[i] = t15_2_DWork.scr_data[13 * i + 12];

      /* DataStoreRead: '<S31>/Data Store Read' */
      t15_2_B.DataStoreRead_m5[i] = t15_2_DWork.scr_data[13 * i];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.I1_f), &t15_2_B.DataStoreRead1_ek[0],
                         t15_2_B.Times, &t15_2_B.DataStoreRead_m5[0], 499U);
    t15_2_B.c_eob_cv = t15_2_B.I1_f;
  } else {
    t15_2_B.c_eob_cv = t15_2_B.Memory2_o;
  }

  /* End of Switch: '<S31>/c_eob' */

  /* Product: '<S31>/Divide1' */
  t15_2_B.Divide1_e = t15_2_B.c_eob_cv * t15_2_B.u_a;

  /* Sum: '<S22>/Add11' */
  t15_2_B.Add11 = t15_2_B.e6_e[10] - t15_2_B.Divide1_e;

  /* DataStoreRead: '<S17>/Data Store Read1' */
  t15_2_B.DataStoreRead1_d = t15_2_DWork.Ip_div;

  /* RelationalOperator: '<S17>/Relational Operator' */
  t15_2_B.RelationalOperator_m = (t15_2_B.e6 > t15_2_B.DataStoreRead1_d);

  /* Memory: '<S25>/Memory' */
  t15_2_B.Memory_c = t15_2_DWork.Memory_PreviousInput_n;

  /* Logic: '<S25>/Logical Operator' */
  t15_2_B.LogicalOperator_n = ((t15_2_B.RelationalOperator_m != 0.0) ||
    (t15_2_B.Memory_c != 0.0));

  /* Switch: '<S17>/1' incorporates:
   *  Constant: '<S14>/Constant4'
   */
  if (t15_2_B.LogicalOperator_n >= t15_2_P._Threshold) {
    for (i = 0; i < 6; i++) {
      t15_2_B.u_j[i] = t15_2_B.e2_f[i];
    }

    t15_2_B.u_j[6] = t15_2_P.Constant4_Value_k;
    t15_2_B.u_j[7] = t15_2_B.Add1_l;
    t15_2_B.u_j[8] = t15_2_B.Add3_p;
    t15_2_B.u_j[9] = t15_2_B.Add1_f;
    t15_2_B.u_j[10] = t15_2_B.Add2_g;
    t15_2_B.u_j[11] = t15_2_B.Add4_m;
    t15_2_B.u_j[12] = t15_2_B.Add5_c;
    t15_2_B.u_j[13] = t15_2_B.Add6_p;
    t15_2_B.u_j[14] = t15_2_B.Add7;
    t15_2_B.u_j[15] = t15_2_B.Add8;
    t15_2_B.u_j[16] = t15_2_B.Add9;
    t15_2_B.u_j[17] = t15_2_B.Add10;
    t15_2_B.u_j[18] = t15_2_B.Add11;
    t15_2_B.u_j[19] = t15_2_P.Constant4_Value_k;
  } else {
    for (i = 0; i < 50; i++) {
      /* Selector: '<S21>/Selector' */
      t15_2_B.Selector_f[i] = t15_2_B.SFunction1_f[(i << 1) + 1];

      /* Selector: '<S21>/Selector1' */
      t15_2_B.Selector1_l[i] = t15_2_B.SFunction1_f[i << 1];
    }
     ...
     *
     */
    LookUp_real_T_real_T( &(t15_2_B.elong), &t15_2_B.Selector_f[0],
                         t15_2_B.Times, &t15_2_B.Selector1_l[0], 49U);

    /* Sum: '<S14>/Add2' incorporates:
     *  Inport: '<Root>/In1'
     */
    t15_2_B.Add2_o = t15_2_U.In1[2] - t15_2_B.elong;

    /* DataStoreRead: '<S24>/Data Store Read1' */
    t15_2_B.DataStoreRead1_ma = t15_2_DWork.k_g4;
     ...
     */
    t15_2_B.Divide_e[0] = t15_2_B.e2_f[2] * t15_2_P.Constant4_Value;
    t15_2_B.Divide_e[1] = t15_2_B.e2_f[3] * t15_2_B.DataStoreRead1_ma;
    t15_2_B.Divide_e[2] = t15_2_B.e2_f[4] * t15_2_P.Constant1_Value;
    t15_2_B.Divide_e[3] = t15_2_B.e2_f[5] * t15_2_P.Constant2_Value;
    t15_2_B.u_j[0] = t15_2_B.Add2_o;
    t15_2_B.u_j[1] = t15_2_P.Constant4_Value_k;
    t15_2_B.u_j[2] = t15_2_B.Divide_e[0];
    t15_2_B.u_j[3] = t15_2_B.Divide_e[1];
    t15_2_B.u_j[4] = t15_2_B.Divide_e[2];
    t15_2_B.u_j[5] = t15_2_B.Divide_e[3];
    t15_2_B.u_j[6] = t15_2_P.Constant4_Value_k;
    t15_2_B.u_j[7] = t15_2_B.Add1_l;
    t15_2_B.u_j[8] = t15_2_B.Add3_p;
    t15_2_B.u_j[9] = t15_2_B.Add1_f;
  ...
  /* UnitDelay: '<S28>/UD' */
  t15_2_B.Uk1_f = t15_2_DWork.UD_DSTATE_p;

  /* Sum: '<S28>/Diff' */
  t15_2_B.Diff_l = t15_2_B.Times - t15_2_B.Uk1_f;

  /* Product: '<S20>/Divide' */
  t15_2_B.Divide = t15_2_B.Diff / t15_2_B.Diff_l;

  /* DataStoreRead: '<S15>/Data Store Read' */
  t15_2_B.DataStoreRead_ox = t15_2_DWork.c_a_tpl1_eob;

  /* Gain: '<S15>/ 1//15' */
  t15_2_B.u15 = t15_2_P.u15_Gain_b * t15_2_B.DataStoreRead_ox;

  /* RelationalOperator: '<S68>/Compare' incorporates:
   *  Constant: '<S68>/Constant'
   */
  t15_2_B.Compare_p = (t15_2_B.u_a < t15_2_P.Constant_Value);

  /* DataStoreRead: '<S52>/Data Store Read' */
  t15_2_B.DataStoreRead_c = t15_2_DWork.ref_ramp;

  /* Memory: '<S52>/Memory3' */
  t15_2_B.Memory3 = t15_2_DWork.Memory3_PreviousInput;

  /* DataStoreRead: '<S69>/Data Store Read' */
  t15_2_B.DataStoreRead_ck = t15_2_DWork.RupRd[2];

  /* Abs: '<S69>/Abs' */
  t15_2_B.Abs = fabs(t15_2_B.DataStoreRead_ck);

  /* RelationalOperator: '<S69>/Relational Operator' */
  t15_2_B.RelationalOperator_b = (t15_2_B.e6 < t15_2_B.Abs);

  /* Logic: '<S52>/Logical Operator1' */
  t15_2_B.LogicalOperator1 = (t15_2_B.RelationalOperator_b && t15_2_B.Compare_p);
  ...
  /* Product: '<S52>/Divide1' */
  t15_2_B.Divide1_jh = 1.0 / t15_2_B.DataStoreRead_c * t15_2_B.Subtract2;

  /* Sum: '<S52>/Subtract1' incorporates:
   *  Constant: '<S52>/1'
   */
  t15_2_B.Subtract1 = t15_2_B.Divide1_jh + t15_2_P._Value_j;

  /* Saturate: '<S52>/Saturation1' */
  tmin = t15_2_B.Subtract1;
  u = t15_2_P.Saturation1_LowerSat_p;
  ...
  /* Memory: '<S52>/Memory1' */
  memcpy(&t15_2_B.Memory1_k[0], &t15_2_DWork.Memory1_PreviousInput_l[0], 11U *
         sizeof(real_T));

  /* Memory: '<S64>/Memory1' */
  t15_2_B.Memory1_f = t15_2_DWork.Memory1_PreviousInput_de;

  /* Switch: '<S64>/c_eob' */
  if (t15_2_B.u_a >= t15_2_P.c_eob_Threshold_ll) {
    t15_2_B.c_eob_ji = t15_2_B.e6;
  } else {
    t15_2_B.c_eob_ji = t15_2_B.Memory1_f;
  }

  /* End of Switch: '<S64>/c_eob' */

  /* Switch: '<S15>/c_eob' */
  if (t15_2_B.u_a >= t15_2_P.c_eob_Threshold_k) {
    /* DataStoreRead: '<S15>/Data Store Read2' */
    t15_2_B.DataStoreRead2_m = t15_2_DWork.c_a_tpl2;

    /* Gain: '<S15>/ 1//15 ' */
    t15_2_B.u15_o = t15_2_P.u15_Gain * t15_2_B.DataStoreRead2_m;

    /* Product: '<S15>/Divide9' */
    t15_2_B.Divide9 = t15_2_B.e6 * t15_2_B.u15_o;
    ...
    t15_2_B.c_eob_mp = t15_2_B.Saturation_d;
  } else {
    /* DataStoreRead: '<S64>/Data Store Read2' */
    t15_2_B.DataStoreRead2_b = t15_2_DWork.y0;

    /* Sum: '<S64>/Sum3' incorporates:
     *  Constant: '<S64>/2'
     */
    t15_2_B.Sum3_i = t15_2_P._Value - t15_2_B.DataStoreRead2_b;

    /* DataStoreRead: '<S64>/Data Store Read4' */
    t15_2_B.DataStoreRead4_m = t15_2_DWork.c2_y0;

    /* DataStoreRead: '<S64>/Data Store Read3' */
    t15_2_B.DataStoreRead3_e = t15_2_DWork.c1_y0;

    /* Sum: '<S64>/Sum2' */
    t15_2_B.Sum2_p = t15_2_B.DataStoreRead4_m - t15_2_B.DataStoreRead3_e;

    /* Product: '<S64>/Divide1' */
    t15_2_B.Divide1_jhy = 1.0 / t15_2_B.Sum2_p * t15_2_B.Sum3_i;

    /* Product: '<S64>/Divide6' */
    t15_2_B.Divide6_d = t15_2_B.c_eob_ji * t15_2_B.u_a;

    /* Sum: '<S64>/Sum' */
    t15_2_B.Sum = t15_2_B.Divide6_d - t15_2_B.DataStoreRead3_e;

    /* Product: '<S64>/Divide2' */
    t15_2_B.Divide2_k = t15_2_B.Sum * t15_2_B.Divide1_jhy;

    /* Sum: '<S64>/Sum1' */
    t15_2_B.Sum1_c = t15_2_B.Divide2_k + t15_2_B.DataStoreRead2_b;

    /* RelationalOperator: '<S84>/LowerRelop1' incorporates:
     *  Constant: '<S64>/1'
     */
    t15_2_B.LowerRelop1_j = (t15_2_B.Sum1_c > t15_2_P._Value_i);

    /* Switch: '<S84>/Switch2' incorporates:
     *  Constant: '<S64>/1'
     */
    if (t15_2_B.LowerRelop1_j) {
      t15_2_B.Switch2_e = t15_2_P._Value_i;
    } else {
      /* RelationalOperator: '<S84>/UpperRelop' */
      t15_2_B.UpperRelop_al = (t15_2_B.Sum1_c < t15_2_B.DataStoreRead2_b);

      /* Switch: '<S84>/Switch' */
      if (t15_2_B.UpperRelop_al) {
        t15_2_B.Switch_i = t15_2_B.DataStoreRead2_b;
      } else {
        t15_2_B.Switch_i = t15_2_B.Sum1_c;
      }

      /* End of Switch: '<S84>/Switch' */
      t15_2_B.Switch2_e = t15_2_B.Switch_i;
    }

    /* End of Switch: '<S84>/Switch2' */
    t15_2_B.c_eob_mp = t15_2_B.Switch2_e;
  }

  /* End of Switch: '<S15>/c_eob' */

  /* DataStoreRead: '<S75>/Data Store Read' */
  t15_2_B.DataStoreRead_m = t15_2_DWork.tcont2;

  /* RelationalOperator: '<S75>/Relational Operator' */
  t15_2_B.RelationalOperator_a = (t15_2_B.Times > t15_2_B.DataStoreRead_m);

  /* Product: '<S75>/Divide12' */
  for (i = 0; i < 20; i++) {
    t15_2_B.Divide12_b[i] = t15_2_B.u_j[i] * (real_T)
      t15_2_B.RelationalOperator_a;
  }
  ...
  memcpy(&t15_2_B.DataStoreRead2_n[0], &t15_2_DWork.ntur[0], 11U * sizeof(real_T));

  /* Switch: '<S52>/switch1' */
  if (t15_2_B.LogicalOperator1 >= t15_2_P.switch1_Threshold_p) {
    memcpy(&t15_2_B.switch1_f[0], &t15_2_B.Memory1_k[0], 11U * sizeof(real_T));
  } else {
    /* DataStoreRead: '<S76>/Data Store Read' */
    t15_2_B.DataStoreRead_j = t15_2_DWork.tcont2;

    /* RelationalOperator: '<S76>/Relational Operator' */
    t15_2_B.RelationalOperator_eg = (t15_2_B.Times > t15_2_B.DataStoreRead_j);

    /* Switch: '<S76>/1' */
    if (t15_2_B.RelationalOperator_eg) {
      /* DataStoreRead: '<S74>/Data Store Read1' */
      t15_2_B.DataStoreRead1_fc = t15_2_DWork.dtcont2;

      /* DataStoreRead: '<S74>/Data Store Read' */
      t15_2_B.DataStoreRead_fp = t15_2_DWork.tcont2;

      /* Sum: '<S74>/Subtract3' */
      t15_2_B.Subtract3_d = t15_2_B.Times - t15_2_B.DataStoreRead_fp;

      /* Product: '<S74>/Divide2' */
      t15_2_B.Divide2_c = t15_2_B.Subtract3_d / t15_2_B.DataStoreRead1_fc;

      /* Saturate: '<S74>/Saturation1' */
      tmin = t15_2_B.Divide2_c;
      ...
      /* Product: '<S55>/Divide ' */
      for (i = 0; i < 11; i++) {
        t15_2_B.Divide_o[i] = t15_2_B.c_eob_mp * t15_2_B.Limcontr[i] *
          t15_2_B.Saturation1_a;
        t15_2_B.u_l[i] = t15_2_B.Divide_o[i];
      }
      ...
      /* Product: '<S55>/Divide2' */
      for (i = 0; i < 11; i++) {
        t15_2_B.Divide2_j[i] = t15_2_B.Currcontr[i] / t15_2_B.DataStoreRead2_n[i];
        t15_2_B.u_l[i] = t15_2_B.Divide2_j[i];
      }
    ...
    /* End of Switch: '<S76>/1' */
    memcpy(&t15_2_B.switch1_f[0], &t15_2_B.u_l[0], 11U * sizeof(real_T));
  }
   ...
   *  Constant: '<S52>/1'
   */
  t15_2_B.Subtract3 = t15_2_P._Value_j - t15_2_B.Saturation1;

  /* DataStoreRead: '<S53>/Data Store Read1' */
  t15_2_B.DataStoreRead1_h = t15_2_DWork.c_cur_max;

  /* DataStoreRead: '<S66>/Data Store Read' */
  t15_2_B.DataStoreRead_h = t15_2_DWork.RupRd[2];

  /* Abs: '<S66>/Abs' */
  t15_2_B.Abs_p = fabs(t15_2_B.DataStoreRead_h);

  /* RelationalOperator: '<S66>/Relational Operator' */
  t15_2_B.RelationalOperator_h = (t15_2_B.e6 < t15_2_B.Abs_p);

  /* RelationalOperator: '<S85>/Compare' incorporates:
   *  Constant: '<S85>/Constant'
   */
  t15_2_B.Compare_l = (t15_2_B.u_a < t15_2_P.Constant_Value_d);

  /* Logic: '<S66>/Logical Operator2' */
  t15_2_B.LogicalOperator2 = (t15_2_B.RelationalOperator_h && t15_2_B.Compare_l);
  for (i = 0; i < 11; i++) {
    /* Product: '<S52>/Divide5' */
    t15_2_B.Divide5[i] = t15_2_B.Saturation1 * t15_2_B.switch1_f[i];

    /* Gain: '<S53>/1e3' */
    t15_2_B.e3_j[i] = t15_2_P.e3_Gain_i * t15_2_B.e6_e[i];

    /* Abs: '<S53>/Abs' */
    t15_2_B.Abs_o[i] = fabs(t15_2_B.e3_j[i]);

    /* DataStoreRead: '<S15>/Data Store Read1' */
    t15_2_B.DataStoreRead1_g[i] = t15_2_DWork.Imax[i];

    /* DataStoreRead: '<S53>/Data Store Read2' */
    t15_2_B.DataStoreRead2_j[i] = t15_2_DWork.ntur[i];

    /* Product: '<S53>/Divide5' */
    t15_2_B.Divide5_a[i] = t15_2_B.DataStoreRead1_g[i] *
      t15_2_B.DataStoreRead2_j[i];

    /* Sum: '<S53>/Sum2' */
    t15_2_B.Sum2_a[i] = t15_2_B.Divide5_a[i] - t15_2_B.Abs_o[i];

    /* Product: '<S53>/Divide3' */
    t15_2_B.Divide3[i] = t15_2_B.Divide5_a[i] * t15_2_B.DataStoreRead1_h;

    /* Sum: '<S53>/Sum1' */
    t15_2_B.Sum1[i] = t15_2_B.Divide5_a[i] - t15_2_B.Divide3[i];

    /* Product: '<S53>/Divide4' */
    t15_2_B.Divide4[i] = t15_2_B.Sum2_a[i] / t15_2_B.Sum1[i];

    /* Product: '<S53>/Divide1' */
    t15_2_B.Divide1_m[i] = t15_2_B.Divide4[i] * t15_2_B.Divide4[i] *
      t15_2_B.Divide4[i];

    /* Saturate: '<S53>/Saturation' */
    tmin = t15_2_B.Divide1_m[i];
    ...
    /* Memory: '<S66>/Memory1' */
    t15_2_B.Memory1_kx[i] = t15_2_DWork.Memory1_PreviousInput_m4[i];

    /* Memory: '<S58>/Memory' */
    t15_2_B.Memory_k[i] = t15_2_DWork.Memory_PreviousInput_e[i];
  }
  ...
  t15_2_B.RelationalOperator1_a = (t15_2_B.e6 < t15_2_B.DataStoreRead_d);

  /* RelationalOperator: '<S77>/Compare' incorporates:
   *  Constant: '<S77>/Constant'
   */
  t15_2_B.Compare_g = (t15_2_B.u_a < t15_2_P.Constant_Value_k);

  /* DataStoreRead: '<S58>/Data Store Read1' */
  t15_2_B.DataStoreRead1_o = t15_2_DWork.RupRd[2];

  /* Abs: '<S58>/Abs' */
  t15_2_B.Abs_m = fabs(t15_2_B.DataStoreRead1_o);

  /* RelationalOperator: '<S58>/Relational Operator' */
  t15_2_B.RelationalOperator_a5 = (t15_2_B.e6 > t15_2_B.Abs_m);

  /* Logic: '<S58>/Logical Operator1' */
  t15_2_B.LogicalOperator1_l = (t15_2_B.RelationalOperator1_a &&
    t15_2_B.Compare_g && t15_2_B.RelationalOperator_a5);

  /* Product: '<S15>/Divide2' */
  for (i = 0; i < 20; i++) {
    t15_2_B.Divide2[i] = t15_2_B.LogicalOperator1 * t15_2_B.u_j[i];
  }
  ...
  for (i = 0; i < 11; i++) {
    /* Switch: '<S58>/0.1' */
    if (t15_2_B.LogicalOperator1_l >= t15_2_P.u_Threshold) {
      t15_2_B.u_aw[i] = t15_2_B.Memory_k[i];
    } else {
      /* Product: '<S15>/Divide' */
      t15_2_B.Divide_dl[i] = t15_2_B.c_eob_mp * t15_2_B.Divcontr[i] *
        t15_2_B.Subtract3;
      t15_2_B.u_aw[i] = t15_2_B.Divide_dl[i];
    }
  ...
  /* Memory: '<S62>/Memory1' */
  t15_2_B.Memory1_l = t15_2_DWork.Memory1_PreviousInput_c;

  /* DataStoreRead: '<S62>/Data Store Read' */
  t15_2_B.DataStoreRead_hn = t15_2_DWork.Ip_rd;

  /* RelationalOperator: '<S62>/Relational Operator1' */
  t15_2_B.RelationalOperator1_p = (t15_2_B.e6 < t15_2_B.DataStoreRead_hn);

  /* RelationalOperator: '<S81>/Compare' incorporates:
   *  Constant: '<S81>/Constant'
   */
  t15_2_B.Compare_e = (t15_2_B.u_a < t15_2_P.Constant_Value_f);

  /* Logic: '<S62>/Logical Operator1' */
  t15_2_B.LogicalOperator1_o = (t15_2_B.RelationalOperator1_p &&
    t15_2_B.Compare_e);

  /* Switch: '<S62>/switch1' */
  if (t15_2_B.LogicalOperator1_o >= t15_2_P.switch1_Threshold_a) {
    t15_2_B.switch1_k = t15_2_B.Memory1_l;
  } else {
  ...
  for (i = 0; i < 20; i++) {
    t15_2_B.Divide13[i] = t15_2_B.Divide2[i] * t15_2_B.LogicalOperator1_o;
  }
  ...
  /* Switch: '<S66>/1' */
  if (t15_2_B.LogicalOperator2 >= t15_2_P._Threshold_b) {
    memcpy(&t15_2_B.u_i[0], &t15_2_B.Memory1_kx[0], 11U * sizeof(real_T));
  } else {
    /* Sum: '<S62>/Subtract2' */
    t15_2_B.Subtract2_m = t15_2_B.switch1_k - t15_2_B.Times;

    /* DataStoreRead: '<S62>/Data Store Read1' */
    t15_2_B.DataStoreRead1_gj = t15_2_DWork.ref_ramp;

    /* Product: '<S62>/Divide4' */
    t15_2_B.Divide4_b = 1.0 / t15_2_B.DataStoreRead1_gj * t15_2_B.Subtract2_m;

    /* Sum: '<S62>/Subtract3' incorporates:
     *  Constant: '<S62>/1'
     */
    t15_2_B.Subtract3_n = t15_2_B.Divide4_b + t15_2_P._Value_k;

    /* Saturate: '<S62>/Saturation' */
    tmin = t15_2_B.Subtract3_n;
    u = t15_2_P.Saturation_LowerSat_n;
    u_0 = t15_2_P.Saturation_UpperSat_a;
    if (tmin >= u_0) {
      t15_2_B.Saturation_l = u_0;
    } else if (tmin <= u) {
      t15_2_B.Saturation_l = u;
    } else {
      t15_2_B.Saturation_l = tmin;
    }
     ...
     *  Constant: '<S62>/1'
     */
    t15_2_B.Subtract1_i = t15_2_P._Value_k - t15_2_B.Saturation_l;
    for (i = 0; i < 11; i++) {
      /* Product: '<S15>/Divide3' */
      t15_2_B.Divide3_e[i] = t15_2_B.Div_rdcontr[i] * t15_2_B.c_eob_mp *
        t15_2_B.Subtract1_i;

      /* Product: '<S15>/Divide1' */
      t15_2_B.Divide1_bd[i] = t15_2_B.u_aw[i] * t15_2_B.Saturation_l;

      /* Sum: '<S15>/Sum2' */
      t15_2_B.Sum2_f[i] = t15_2_B.Divide1_bd[i] + t15_2_B.Divide3_e[i];
      t15_2_B.u_i[i] = t15_2_B.Sum2_f[i];
    }
  }
  ...
  /* Abs: '<S73>/Abs' */
  t15_2_B.Abs_c = fabs(t15_2_B.DataStoreRead_f);

  /* RelationalOperator: '<S73>/Relational Operator' */
  t15_2_B.RelationalOperator_e = (t15_2_B.e6 < t15_2_B.Abs_c);

  /* RelationalOperator: '<S72>/Compare' incorporates:
   *  Constant: '<S72>/Constant'
   */
  t15_2_B.Compare_kb = (t15_2_B.e6 < t15_2_P.Constant_Value_kq);

  /* Logic: '<S54>/Logical Operator2' */
  t15_2_B.LogicalOperator2_a = (t15_2_B.RelationalOperator_e &&
    t15_2_B.Compare_kb);

  /* Sum: '<S54>/Subtract4' incorporates:
   *  Constant: '<S54>/1'
   */
  t15_2_B.Subtract4 = t15_2_P._Value_gi - t15_2_B.LogicalOperator2_a;
  ...
  for (i = 0; i < 11; i++) {
    /* Product: '<S15>/Divide4' */
    t15_2_B.Divide4_k[i] = t15_2_B.u_i[i] * t15_2_B.Subtract4;
  ...
  for (i = 0; i < 500; i++) {
    ...
    /* Gain: '<S86>/0.001' */
    t15_2_B.u01[i] = t15_2_P.u01_Gain * t15_2_B.DataStoreRead_n[i];

    /* DataStoreRead: '<S86>/Data Store Read1' */
    t15_2_B.DataStoreRead1_dr[i] = t15_2_DWork.volt[20 * i + 1];

    /* DataStoreRead: '<S89>/Data Store Read' */
    t15_2_B.DataStoreRead_k[i] = t15_2_DWork.volt[20 * i];

    /* Gain: '<S89>/0.001' */
    t15_2_B.u01_h[i] = t15_2_P.u01_Gain_f * t15_2_B.DataStoreRead_k[i];

    /* DataStoreRead: '<S89>/Data Store Read1' */
    t15_2_B.DataStoreRead1_i[i] = t15_2_DWork.volt[20 * i + 2];

    /* DataStoreRead: '<S90>/Data Store Read' */
    t15_2_B.DataStoreRead_hd[i] = t15_2_DWork.volt[20 * i];

    /* Gain: '<S90>/0.001' */
    t15_2_B.u01_e[i] = t15_2_P.u01_Gain_c * t15_2_B.DataStoreRead_hd[i];

    /* DataStoreRead: '<S90>/Data Store Read1' */
    t15_2_B.DataStoreRead1_dq[i] = t15_2_DWork.volt[20 * i + 3];

    /* DataStoreRead: '<S91>/Data Store Read' */
    t15_2_B.DataStoreRead_g[i] = t15_2_DWork.volt[20 * i];

    /* Gain: '<S91>/0.001' */
    t15_2_B.u01_i[i] = t15_2_P.u01_Gain_fp * t15_2_B.DataStoreRead_g[i];
    ...
    /* Gain: '<S92>/0.001' */
    t15_2_B.u01_d[i] = t15_2_P.u01_Gain_n * t15_2_B.DataStoreRead_p[i];

    /* DataStoreRead: '<S92>/Data Store Read1' */
    t15_2_B.DataStoreRead1_e[i] = t15_2_DWork.volt[20 * i + 5];

    /* DataStoreRead: '<S93>/Data Store Read' */
    t15_2_B.DataStoreRead_h3[i] = t15_2_DWork.volt[20 * i];

    /* Gain: '<S93>/0.001' */
    t15_2_B.u01_o[i] = t15_2_P.u01_Gain_b * t15_2_B.DataStoreRead_h3[i];

    /* DataStoreRead: '<S93>/Data Store Read1' */
    t15_2_B.DataStoreRead1_p[i] = t15_2_DWork.volt[20 * i + 6];

    /* DataStoreRead: '<S94>/Data Store Read' */
    t15_2_B.DataStoreRead_l1[i] = t15_2_DWork.volt[20 * i];

    /* Gain: '<S94>/0.001' */
    t15_2_B.u01_f[i] = t15_2_P.u01_Gain_p * t15_2_B.DataStoreRead_l1[i];

    /* DataStoreRead: '<S94>/Data Store Read1' */
    t15_2_B.DataStoreRead1_ib[i] = t15_2_DWork.volt[20 * i + 7];

    /* DataStoreRead: '<S95>/Data Store Read' */
    t15_2_B.DataStoreRead_e[i] = t15_2_DWork.volt[20 * i];

    /* Gain: '<S95>/0.001' */
    t15_2_B.u01_j[i] = t15_2_P.u01_Gain_l * t15_2_B.DataStoreRead_e[i];

    /* DataStoreRead: '<S95>/Data Store Read1' */
    t15_2_B.DataStoreRead1_oz[i] = t15_2_DWork.volt[20 * i + 8];

    /* DataStoreRead: '<S96>/Data Store Read' */
    t15_2_B.DataStoreRead_nv[i] = t15_2_DWork.volt[20 * i];

    /* Gain: '<S96>/0.001' */
    t15_2_B.u01_od[i] = t15_2_P.u01_Gain_pg * t15_2_B.DataStoreRead_nv[i];

    /* DataStoreRead: '<S96>/Data Store Read1' */
    t15_2_B.DataStoreRead1_oe[i] = t15_2_DWork.volt[20 * i + 9];

    /* DataStoreRead: '<S87>/Data Store Read' */
    t15_2_B.DataStoreRead_hx[i] = t15_2_DWork.volt[20 * i];

    /* Gain: '<S87>/0.001' */
    t15_2_B.u01_js[i] = t15_2_P.u01_Gain_o * t15_2_B.DataStoreRead_hx[i];

    /* DataStoreRead: '<S87>/Data Store Read1' */
    t15_2_B.DataStoreRead1_f[i] = t15_2_DWork.volt[20 * i + 10];

    /* DataStoreRead: '<S88>/Data Store Read' */
    t15_2_B.DataStoreRead_cf[i] = t15_2_DWork.volt[20 * i];

    /* Gain: '<S88>/0.001' */
    t15_2_B.u01_c[i] = t15_2_P.u01_Gain_bh * t15_2_B.DataStoreRead_cf[i];

    /* DataStoreRead: '<S88>/Data Store Read1' */
    t15_2_B.DataStoreRead1_dp[i] = t15_2_DWork.volt[20 * i + 11];
  }
   ...
   *
   */
  LookUp_real_T_real_T( &(t15_2_B.volt1), &t15_2_B.DataStoreRead1_dr[0],
   ...
   *
   */
  LookUp_real_T_real_T( &(t15_2_B.volt1_p), &t15_2_B.DataStoreRead1_i[0],
   ...
   *
   */
  LookUp_real_T_real_T( &(t15_2_B.volt1_m), &t15_2_B.DataStoreRead1_dq[0],
   ...
   *
   */
  LookUp_real_T_real_T( &(t15_2_B.volt1_c), &t15_2_B.DataStoreRead1_c[0],
   ...
   *
   */
  LookUp_real_T_real_T( &(t15_2_B.volt1_mx), &t15_2_B.DataStoreRead1_e[0],
   ...
   *
   */
  LookUp_real_T_real_T( &(t15_2_B.volt1_j), &t15_2_B.DataStoreRead1_p[0],
   ...
   *
   */
  LookUp_real_T_real_T( &(t15_2_B.volt1_a), &t15_2_B.DataStoreRead1_ib[0],
   ...
   *
   */
  LookUp_real_T_real_T( &(t15_2_B.volt1_b), &t15_2_B.DataStoreRead1_oz[0],
   ...
   *
   */
  LookUp_real_T_real_T( &(t15_2_B.volt1_p4), &t15_2_B.DataStoreRead1_oe[0],
                       t15_2_B.Times, &t15_2_B.u01_od[0], 499U);
   ...
   *
   */
  LookUp_real_T_real_T( &(t15_2_B.volt1_cq), &t15_2_B.DataStoreRead1_f[0],
                       t15_2_B.Times, &t15_2_B.u01_js[0], 499U);
   ...
   *
   */
  LookUp_real_T_real_T( &(t15_2_B.volt1_k), &t15_2_B.DataStoreRead1_dp[0],
                       t15_2_B.Times, &t15_2_B.u01_c[0], 499U);

  /* Sum: '<S15>/Sum1' incorporates:
   *  Constant: '<S15>/1 '
   */
  t15_2_B.Sum1_f = t15_2_P._Value_l - t15_2_B.LogicalOperator1;

  /* Product: '<S15>/Divide7' */
  t15_2_B.Divide7[0] = t15_2_B.volt1 * t15_2_B.Sum1_f;
  t15_2_B.Divide7[1] = t15_2_B.volt1_p * t15_2_B.Sum1_f;
  t15_2_B.Divide7[2] = t15_2_B.volt1_m * t15_2_B.Sum1_f;
  t15_2_B.Divide7[3] = t15_2_B.volt1_c * t15_2_B.Sum1_f;
  t15_2_B.Divide7[4] = t15_2_B.volt1_mx * t15_2_B.Sum1_f;
  t15_2_B.Divide7[5] = t15_2_B.volt1_j * t15_2_B.Sum1_f;
  t15_2_B.Divide7[6] = t15_2_B.volt1_a * t15_2_B.Sum1_f;
  t15_2_B.Divide7[7] = t15_2_B.volt1_b * t15_2_B.Sum1_f;
  t15_2_B.Divide7[8] = t15_2_B.volt1_p4 * t15_2_B.Sum1_f;
  t15_2_B.Divide7[9] = t15_2_B.volt1_cq * t15_2_B.Sum1_f;
  t15_2_B.Divide7[10] = t15_2_B.volt1_k * t15_2_B.Sum1_f;
  for (i = 0; i < 11; i++) {
    /* Sum: '<S15>/Sum3' */
    t15_2_B.Sum3[i] = ((t15_2_B.Divide4_k[i] + t15_2_B.Divide5_n[i]) +
                       t15_2_B.Divide5[i]) + t15_2_B.Divide7[i];

    /* Product: '<S53>/Divide2' */
    t15_2_B.Divide2_b[i] = t15_2_B.e6_e[i] * t15_2_B.Sum3[i];

    /* RelationalOperator: '<S71>/Compare' incorporates:
     *  Constant: '<S71>/Constant'
     */
    t15_2_B.Compare_k[i] = (uint8_T)(t15_2_B.Divide2_b[i] <
      t15_2_P.Constant_Value_h);

    /* Logic: '<S53>/Logical Operator' */
    t15_2_B.LogicalOperator_i[i] = ((t15_2_B.Compare[i] != 0) &&
      (t15_2_B.Compare_k[i] != 0));

    /* Switch: '<S53>/Switch' incorporates:
     *  Constant: '<S53>/1'
     */
    if (t15_2_B.LogicalOperator_i[i]) {
      t15_2_B.Switch[i] = t15_2_P._Value_ja;
    } else {
  ...
  t15_2_B.DataStoreRead_ok = t15_2_DWork.RupRd[5];

  /* Gain: '<S82>/1.75' */
  t15_2_B.u5 = t15_2_P.u5_Gain * t15_2_B.DataStoreRead_ok;

  /* Product: '<S82>/Divide11' */
  t15_2_B.Divide11 = t15_2_B.UniformRandomNumber * t15_2_B.u5;

  /* UnitDelay: '<S83>/UD' */
  t15_2_B.Uk1_fy = t15_2_DWork.UD_DSTATE_k;

  /* Sum: '<S83>/Diff' */
  t15_2_B.Diff_h = t15_2_B.Times - t15_2_B.Uk1_fy;

  /* Gain: '<S82>/2e3' */
  t15_2_B.e3_o = t15_2_P.e3_Gain_k * t15_2_B.Diff_h;

  /* Sqrt: '<S82>/Sqrt' */
  t15_2_B.Sqrt = sqrt(t15_2_B.e3_o);

  /* Product: '<S82>/Divide1' */
  t15_2_B.Divide1_b = t15_2_B.Divide11 / t15_2_B.Sqrt;

  /* Sum: '<S63>/Sum2' */
  t15_2_B.Sum2_d = t15_2_B.Divide1_b + t15_2_B.Divide;

  /* DataStoreRead: '<S65>/Data Store Read' */
  t15_2_B.DataStoreRead_nf = t15_2_DWork.t_tran2D;

  /* RelationalOperator: '<S65>/Relational Operator1' */
  t15_2_B.RelationalOperator1_j = (t15_2_B.Times > t15_2_B.DataStoreRead_nf);

  /* Product: '<S65>/Divide12' */
  t15_2_B.Divide12_d[0] = t15_2_B.Sum2_d * t15_2_B.RelationalOperator1_j;
  t15_2_B.Divide12_d[1] = t15_2_B.e6_e[11] * t15_2_B.RelationalOperator1_j;
  ...
  /* DiscreteStateSpace: '<S60>/VS. contr' */
  {
    ...
    t15_2_B.VScontr[0] += (t15_2_P.VScontr_D[0])*t15_2_B.Divide12_d[0] +
      (t15_2_P.VScontr_D[1])*t15_2_B.Divide12_d[1];
    ...
    t15_2_B.VScontr[1] += (t15_2_P.VScontr_D[2])*t15_2_B.Divide12_d[0] +
      (t15_2_P.VScontr_D[3])*t15_2_B.Divide12_d[1];
  }

  /* RelationalOperator: '<S79>/Compare' incorporates:
   *  Constant: '<S79>/Constant'
   */
  t15_2_B.Compare_i = (t15_2_B.u_a < t15_2_P.Constant_Value_ao);

  /* Product: '<S60>/Divide4' */
  t15_2_B.Divide4_f[0] = (real_T)t15_2_B.Compare_i * t15_2_B.Divide12_d[0];
  t15_2_B.Divide4_f[1] = (real_T)t15_2_B.Compare_i * t15_2_B.Divide12_d[1];
  ...
  /* Switch: '<S60>/c_eob' */
  if (t15_2_B.u_a >= t15_2_P.c_eob_Threshold_ou) {
    t15_2_B.c_eob_bg[0] = t15_2_B.VScontr[0];
    t15_2_B.c_eob_bg[1] = t15_2_B.VScontr[1];
  } else {
    t15_2_B.c_eob_bg[0] = t15_2_B.VScontrhl[0];
    t15_2_B.c_eob_bg[1] = t15_2_B.VScontrhl[1];
  }

  /* End of Switch: '<S60>/c_eob' */

  /* DataStoreRead: '<S59>/Data Store Read1' */
  t15_2_B.DataStoreRead1_m5 = t15_2_DWork.Ip_rd;

  /* RelationalOperator: '<S59>/Relational Operator2' */
  t15_2_B.RelationalOperator2 = (t15_2_B.e6 < t15_2_B.DataStoreRead1_m5);

  /* DataStoreRead: '<S59>/Data Store Read' */
  t15_2_B.DataStoreRead_pk = t15_2_DWork.RupRd[2];

  /* Abs: '<S59>/Abs' */
  t15_2_B.Abs_ml = fabs(t15_2_B.DataStoreRead_pk);

  /* RelationalOperator: '<S59>/Relational Operator1' */
  t15_2_B.RelationalOperator1_c = (t15_2_B.e6 > t15_2_B.Abs_ml);

  /* RelationalOperator: '<S78>/Compare' incorporates:
   *  Constant: '<S78>/Constant'
   */
  t15_2_B.Compare_a = (t15_2_B.u_a < t15_2_P.Constant_Value_l);

  /* Logic: '<S59>/Logical Operator1' */
  t15_2_B.LogicalOperator1_j = ((t15_2_B.RelationalOperator2 != 0.0) &&
    (t15_2_B.RelationalOperator1_c != 0.0) && t15_2_B.Compare_a);

  /* DataStoreRead: '<S61>/Data Store Read' */
  t15_2_B.DataStoreRead_o4 = t15_2_DWork.c_a_tpl1;

  /* Gain: '<S61>/1//15' */
  t15_2_B.u5_k = t15_2_P.u5_Gain_a * t15_2_B.DataStoreRead_o4;

  /* Product: '<S61>/Div' */
  t15_2_B.Div = t15_2_B.e6 * t15_2_B.u5_k;

  /* Switch: '<S59>/1' incorporates:
   *  Switch: '<S15>/c_eob '
   */
  if (t15_2_B.LogicalOperator1_j >= t15_2_P._Threshold_e) {
    /* Product: '<S15>/Divide6' */
    t15_2_B.Divide6_e4 = t15_2_B.u15 * t15_2_B.e6;

    /* RelationalOperator: '<S56>/LowerRelop1' incorporates:
     *  Constant: '<S15>/1'
     */
    t15_2_B.LowerRelop1_i = (t15_2_B.Divide6_e4 > t15_2_P._Value_c);

    /* Switch: '<S56>/Switch2' incorporates:
     *  Constant: '<S15>/1'
     */
    if (t15_2_B.LowerRelop1_i) {
      t15_2_B.Switch2_h = t15_2_P._Value_c;
    } else {
      /* DataStoreRead: '<S15>/Data Store Read3' */
      t15_2_B.DataStoreRead3_p = t15_2_DWork.c_a_tpl_min;

      /* RelationalOperator: '<S56>/UpperRelop' */
      t15_2_B.UpperRelop_i = (t15_2_B.Divide6_e4 < t15_2_B.DataStoreRead3_p);

      /* Switch: '<S56>/Switch' */
      if (t15_2_B.UpperRelop_i) {
        t15_2_B.Switch_j = t15_2_B.DataStoreRead3_p;
      } else {
        t15_2_B.Switch_j = t15_2_B.Divide6_e4;
      }

      /* End of Switch: '<S56>/Switch' */
      t15_2_B.Switch2_h = t15_2_B.Switch_j;
    }

    /* End of Switch: '<S56>/Switch2' */

    /* Product: '<S15>/Divide11' */
    t15_2_B.Divide11_j[0] = t15_2_B.Switch2_h * t15_2_B.c_eob_bg[0];
    t15_2_B.Divide11_j[1] = t15_2_B.Switch2_h * t15_2_B.c_eob_bg[1];
    t15_2_B.u_f[0] = t15_2_B.Divide11_j[0];
    t15_2_B.u_f[1] = t15_2_B.Divide11_j[1];
  } else {
    if (t15_2_B.u_a >= t15_2_P.c_eob_Threshold) {
      /* DataStoreRead: '<S61>/Data Store Read1' incorporates:
       *  Switch: '<S15>/c_eob '
       */
      t15_2_B.DataStoreRead1_fl = t15_2_DWork.Ip_div;

      /* RelationalOperator: '<S61>/Relational Operator2' incorporates:
       *  Switch: '<S15>/c_eob '
       */
      t15_2_B.RelationalOperator2_j = (t15_2_B.e6 > t15_2_B.DataStoreRead1_fl);

      /* Switch: '<S61>/Lim. Div. tr.' incorporates:
       *  Switch: '<S15>/c_eob '
       */
      if (t15_2_B.RelationalOperator2_j >= t15_2_P.LimDivtr_Threshold) {
        ...
        t15_2_B.DataStoreRead2_i = t15_2_DWork.max_VS_lim;

        /* RelationalOperator: '<S80>/LowerRelop1' */
        t15_2_B.LowerRelop1_f = (t15_2_B.Div > t15_2_B.DataStoreRead2_i);

        /* Switch: '<S80>/Switch2' */
        if (t15_2_B.LowerRelop1_f) {
          t15_2_B.Switch2_o = t15_2_B.DataStoreRead2_i;
        } else {
          /* RelationalOperator: '<S80>/UpperRelop' incorporates:
           *  Constant: '<S61>/1'
           */
          t15_2_B.UpperRelop_g = (t15_2_B.Div < t15_2_P._Value_b);

          /* Switch: '<S80>/Switch' incorporates:
           *  Constant: '<S61>/1'
           */
          if (t15_2_B.UpperRelop_g) {
            t15_2_B.Switch_c = t15_2_P._Value_b;
          } else {
            t15_2_B.Switch_c = t15_2_B.Div;
          }

          /* End of Switch: '<S80>/Switch' */
          t15_2_B.Switch2_o = t15_2_B.Switch_c;
        }

        /* End of Switch: '<S80>/Switch2' */
        t15_2_B.LimDivtr = t15_2_B.Switch2_o;
      }
       ...
       *  Switch: '<S15>/c_eob '
       */
      t15_2_B.Divide8[0] = t15_2_B.LimDivtr * t15_2_B.c_eob_bg[0];
      t15_2_B.Divide8[1] = t15_2_B.LimDivtr * t15_2_B.c_eob_bg[1];

      /* Switch: '<S15>/c_eob ' */
      t15_2_B.c_eob_lo[0] = t15_2_B.Divide8[0];
      t15_2_B.c_eob_lo[1] = t15_2_B.Divide8[1];
    } else {
       ...
       *  Switch: '<S15>/c_eob '
       */
      t15_2_B.LowerRelop1_f0 = (t15_2_B.Divide15 > t15_2_B.DataStoreRead4);

      /* Switch: '<S57>/Switch2' incorporates:
       *  Switch: '<S15>/c_eob '
       */
      if (t15_2_B.LowerRelop1_f0) {
        t15_2_B.Switch2_i = t15_2_B.DataStoreRead4;
      } else {
        /* RelationalOperator: '<S57>/UpperRelop' incorporates:
         *  Constant: '<S15>/2'
         */
        t15_2_B.UpperRelop_a = (t15_2_B.Divide15 < t15_2_P._Value_g);

        /* Switch: '<S57>/Switch' incorporates:
         *  Constant: '<S15>/2'
         */
        if (t15_2_B.UpperRelop_a) {
          t15_2_B.Switch_f = t15_2_P._Value_g;
        } else {
          t15_2_B.Switch_f = t15_2_B.Divide15;
        }

        /* End of Switch: '<S57>/Switch' */
        t15_2_B.Switch2_i = t15_2_B.Switch_f;
      }
       ...
       *  Switch: '<S15>/c_eob '
       */
      t15_2_B.Divide_k[0] = t15_2_B.c_eob_bg[0] * t15_2_B.Switch2_i;
      t15_2_B.Divide_k[1] = t15_2_B.c_eob_bg[1] * t15_2_B.Switch2_i;

      /* Switch: '<S15>/c_eob ' */
      t15_2_B.c_eob_lo[0] = t15_2_B.Divide_k[0];
      t15_2_B.c_eob_lo[1] = t15_2_B.Divide_k[1];
    }

    t15_2_B.u_f[0] = t15_2_B.c_eob_lo[0];
    t15_2_B.u_f[1] = t15_2_B.c_eob_lo[1];
  }

  /* End of Switch: '<S59>/1' */

  /* Product: '<S15>/Divide10' */
  t15_2_B.Divide10[0] = t15_2_B.Sum1_f * t15_2_B.u_f[0];
  t15_2_B.Divide10[1] = t15_2_B.Sum1_f * t15_2_B.u_f[1];
  for (i = 0; i < 20; i++) {
    ...
    t15_2_B.Divide12_o[i] = t15_2_B.G_curr_term[i] * t15_2_B.LogicalOperator1;
  }

  /* DataStoreRead: '<S54>/Data Store Read' */
  t15_2_B.DataStoreRead_gy = t15_2_DWork.ref_ramp;
  for (i = 0; i < 11; i++) {
    /* Product: '<S55>/Divide1' */
    t15_2_B.Divide1_i[i] = t15_2_B.u_j[i + 8] / t15_2_B.DataStoreRead2_n[i];

    /* Gain: '<S55>/1e6' */
    t15_2_B.e6_f[i] = t15_2_P.e6_Gain_g * t15_2_B.Divide1_i[i];

    /* DataStoreRead: '<S5>/Data Store Read2' */
    t15_2_B.DataStoreRead2_jy[i] = t15_2_DWork.ntur[i];

    /* Product: '<S5>/Divide4' */
    t15_2_B.Divide4_g[i] = t15_2_B.DataStoreRead2_jy[i] * t15_2_B.Divide6_e[i];
  }
  ...
  memcpy(&t15_2_DWork.ntur[0], &t15_2_B.SFunction_c[32], 12U * sizeof(real_T));

  /* DataStoreWrite: '<S1>/Data Store Write2' */
  for (i = 0; i < 6; i++) {
    t15_2_DWork.RupRd[i] = t15_2_B.SFunction_c[i];
  }

  /* End of DataStoreWrite: '<S1>/Data Store Write2' */

  /* DataStoreWrite: '<S1>/Data Store Write3' */
  t15_2_DWork.VS3_up = t15_2_B.SFunction_c[7];

  /* DataStoreWrite: '<S1>/Data Store Write5' */
  t15_2_DWork.VS1_up = t15_2_B.SFunction_c[6];

  /* DataStoreWrite: '<S1>/Data Store Write7' */
  t15_2_DWork.Tu = t15_2_B.SFunction_c[19];

  /* DataStoreWrite: '<S1>/Data Store Write8' */
  t15_2_DWork.c_cur_max = t15_2_B.SFunction_c[20];

  /* Memory: '<S4>/Memory1' */
  t15_2_B.Memory1_oe = t15_2_DWork.Memory1_PreviousInput_g;
  ...
  /* Memory: '<S4>/Memory2' */
  t15_2_B.Memory2_mi = t15_2_DWork.Memory2_PreviousInput_j4;

  /* Product: '<S2>/Divide5' */
  t15_2_B.Divide5_p = t15_2_B.Divide4_gn * t15_2_B.Memory2_mi;
  for (i = 0; i < 11; i++) {
    /* DataStoreWrite: '<S1>/Data Store Write4' */
    t15_2_DWork.Vcspf_up[i] = t15_2_B.SFunction_c[i + 8];

    /* DataStoreWrite: '<S1>/Data Store Write9' */
    t15_2_DWork.Imax[i] = t15_2_B.SFunction_c[i + 21];

    /* Memory: '<S3>/Memory1' */
    t15_2_B.Memory1_g[i] = t15_2_DWork.Memory1_PreviousInput_e[i];

    /* DataStoreRead: '<S2>/Data Store Read2' */
    t15_2_B.DataStoreRead2_n3[i] = t15_2_DWork.ntur[i];

    /* Product: '<S2>/Divide3' */
    t15_2_B.Divide3_b[i] = t15_2_B.Memory1_g[i] / t15_2_B.DataStoreRead2_n3[i];

    /* Product: '<S2>/Divide1' incorporates:
     *  Constant: '<S2>/wz1'
     */
    t15_2_B.Divide1_l[i] = t15_2_P.wz1_Value[i] / t15_2_B.DataStoreRead2_n3[i];

    /* Product: '<S2>/Divide2' */
    t15_2_B.Divide2_m[i] = t15_2_B.Divide1_l[i] * t15_2_B.Memory1_oe;
  ...
  /* UnitDelay: '<S6>/UD' */
  t15_2_B.Uk1_e = t15_2_DWork.UD_DSTATE_n;

  /* Sum: '<S6>/Diff' */
  t15_2_B.Diff_o = t15_2_B.Times - t15_2_B.Uk1_e;

  /* DataStoreRead: '<S8>/Data Store Read3' */
  t15_2_B.DataStoreRead3 = t15_2_DWork.Tu;
  for (i = 0; i < 11; i++) {
    /* Memory: '<S7>/Memory1' */
    t15_2_B.Memory1_ld[i] = t15_2_DWork.Memory1_PreviousInput_kd[i];

    /* Sum: '<S7>/Add1' */
    t15_2_B.Add1_k3[i] = t15_2_B.Divide4_g[i] - t15_2_B.Memory1_ld[i];

    /* DataStoreRead: '<S8>/Data Store Read1' */
    t15_2_B.DataStoreRead1_l[i] = t15_2_DWork.Vcspf_up[i];

    /* Gain: '<S8>/2' */
    t15_2_B.u_iv[i] = t15_2_P._Gain * t15_2_B.DataStoreRead1_l[i];

    /* Product: '<S8>/Divide1' */
    t15_2_B.Divide1_fw[i] = t15_2_B.u_iv[i] / t15_2_B.DataStoreRead3;

    /* Product: '<S7>/Divide' */
    t15_2_B.Divide_d[i] = t15_2_B.Add1_k3[i] / t15_2_B.Diff_o;

    /* RelationalOperator: '<S10>/LowerRelop1' */
    t15_2_B.LowerRelop1[i] = (t15_2_B.Divide_d[i] > t15_2_B.Divide1_fw[i]);

    /* Gain: '<S8>/-1' */
    t15_2_B.u_am[i] = t15_2_P.u_Gain_e * t15_2_B.Divide1_fw[i];

    /* RelationalOperator: '<S10>/UpperRelop' */
    t15_2_B.UpperRelop[i] = (t15_2_B.Divide_d[i] < t15_2_B.u_am[i]);

    /* Switch: '<S10>/Switch' */
    if (t15_2_B.UpperRelop[i]) {
      t15_2_B.Switch_e[i] = t15_2_B.u_am[i];
    } else {
      t15_2_B.Switch_e[i] = t15_2_B.Divide_d[i];
    }
    ...
    if (t15_2_B.LowerRelop1[i]) {
      t15_2_B.Switch2[i] = t15_2_B.Divide1_fw[i];
    } else {
      t15_2_B.Switch2[i] = t15_2_B.Switch_e[i];
    }

    /* End of Switch: '<S10>/Switch2' */

    /* Product: '<S7>/Divide1' */
    t15_2_B.Divide1_bp[i] = t15_2_B.Switch2[i] * t15_2_B.Diff_o;

    /* Sum: '<S7>/Add2' */
    t15_2_B.Add2_b[i] = t15_2_B.Memory1_ld[i] + t15_2_B.Divide1_bp[i];

    /* DataStoreRead: '<S9>/Data Store Read1' */
    t15_2_B.DataStoreRead1_do[i] = t15_2_DWork.Vcspf_up[i];

    /* Gain: '<S9>/Gain' */
    t15_2_B.Gain[i] = t15_2_P.Gain_Gain_p * t15_2_B.DataStoreRead1_do[i];

    /* RelationalOperator: '<S11>/LowerRelop1' */
    t15_2_B.LowerRelop1_c[i] = (t15_2_B.Add2_b[i] > t15_2_B.DataStoreRead1_do[i]);

    /* RelationalOperator: '<S11>/UpperRelop' */
    t15_2_B.UpperRelop_n[i] = (t15_2_B.Add2_b[i] < t15_2_B.Gain[i]);

    /* Switch: '<S11>/Switch' */
    if (t15_2_B.UpperRelop_n[i]) {
      t15_2_B.Switch_a[i] = t15_2_B.Gain[i];
    } else {
      t15_2_B.Switch_a[i] = t15_2_B.Add2_b[i];
    }
    ...
    if (t15_2_B.LowerRelop1_c[i]) {
      t15_2_B.Switch2_j[i] = t15_2_B.DataStoreRead1_do[i];
    } else {
      t15_2_B.Switch2_j[i] = t15_2_B.Switch_a[i];
    }
  ...
  t15_2_B.DataStoreRead1_n = t15_2_DWork.VS1_up;

  /* RelationalOperator: '<S12>/LowerRelop1' */
  t15_2_B.LowerRelop1_l = (t15_2_B.Divide10[0] > t15_2_B.DataStoreRead1_n);

  /* Switch: '<S12>/Switch2' */
  if (t15_2_B.LowerRelop1_l) {
    t15_2_B.Switch2_a = t15_2_B.DataStoreRead1_n;
  } else {
    /* Gain: '<S4>/Gain' */
    t15_2_B.Gain_j = t15_2_P.Gain_Gain * t15_2_B.DataStoreRead1_n;

    /* RelationalOperator: '<S12>/UpperRelop' */
    t15_2_B.UpperRelop_bc = (t15_2_B.Divide10[0] < t15_2_B.Gain_j);

    /* Switch: '<S12>/Switch' */
    if (t15_2_B.UpperRelop_bc) {
      t15_2_B.Switch_l = t15_2_B.Gain_j;
    } else {
      t15_2_B.Switch_l = t15_2_B.Divide10[0];
    }

    /* End of Switch: '<S12>/Switch' */
    t15_2_B.Switch2_a = t15_2_B.Switch_l;
  }

  /* End of Switch: '<S12>/Switch2' */

  /* DataStoreRead: '<S4>/Data Store Read3' */
  t15_2_B.DataStoreRead3_f = t15_2_DWork.VS3_up;

  /* RelationalOperator: '<S13>/LowerRelop1' */
  t15_2_B.LowerRelop1_a = (t15_2_B.Divide10[1] > t15_2_B.DataStoreRead3_f);

  /* Switch: '<S13>/Switch2' */
  if (t15_2_B.LowerRelop1_a) {
    t15_2_B.Switch2_ap = t15_2_B.DataStoreRead3_f;
  } else {
    /* Gain: '<S4>/Gain1' */
    t15_2_B.Gain1 = t15_2_P.Gain1_Gain * t15_2_B.DataStoreRead3_f;

    /* RelationalOperator: '<S13>/UpperRelop' */
    t15_2_B.UpperRelop_b = (t15_2_B.Divide10[1] < t15_2_B.Gain1);

    /* Switch: '<S13>/Switch' */
    if (t15_2_B.UpperRelop_b) {
      t15_2_B.Switch_iz = t15_2_B.Gain1;
    } else {
      t15_2_B.Switch_iz = t15_2_B.Divide10[1];
    }

    /* End of Switch: '<S13>/Switch' */
    t15_2_B.Switch2_ap = t15_2_B.Switch_iz;
  }
  ...
  for (i = 0; i < 11; i++) {
    ...
    t15_2_DWork.Memory1_PreviousInput_l[i] = t15_2_B.switch1_f[i];

    /* Update for Memory: '<S66>/Memory1' */
    t15_2_DWork.Memory1_PreviousInput_m4[i] = t15_2_B.u_i[i];

    /* Update for Memory: '<S58>/Memory' */
    t15_2_DWork.Memory_PreviousInput_e[i] = t15_2_B.u_aw[i];

    /* Update for Memory: '<S3>/Memory1' */
    t15_2_DWork.Memory1_PreviousInput_e[i] = t15_2_B.Switch2_j[i];

    /* Update for Memory: '<S7>/Memory1' */
    t15_2_DWork.Memory1_PreviousInput_kd[i] = t15_2_B.Switch2_j[i];
  }
  ...
  t15_2_DWork.Memory2_PreviousInput_j = t15_2_B.c_eob1_p;

  /* Update for Memory: '<S40>/Memory1' */
  t15_2_DWork.Memory1_PreviousInput_i = t15_2_B.c_eob_k;

  /* Update for Memory: '<S41>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_l = t15_2_B.c_eob1_l;

  /* Update for Memory: '<S41>/Memory1' */
  t15_2_DWork.Memory1_PreviousInput_h = t15_2_B.c_eob_i;

  /* Update for Memory: '<S42>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_a = t15_2_B.c_eob1_d;

  /* Update for Memory: '<S42>/Memory1' */
  t15_2_DWork.Memory1_PreviousInput_da = t15_2_B.c_eob_e;

  /* Update for Memory: '<S43>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_a0 = t15_2_B.c_eob1_l5;

  /* Update for Memory: '<S43>/Memory1' */
  t15_2_DWork.Memory1_PreviousInput_m = t15_2_B.c_eob_kr;

  /* Update for Memory: '<S44>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_h = t15_2_B.c_eob1_pv;

  /* Update for Memory: '<S44>/Memory1' */
  t15_2_DWork.Memory1_PreviousInput_o = t15_2_B.c_eob_j;

  /* Update for Memory: '<S29>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_g = t15_2_B.c_eob_f;

  /* Update for Memory: '<S32>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_gi = t15_2_B.c_eob_p;

  /* Update for Memory: '<S33>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_jn = t15_2_B.c_eob_n;

  /* Update for Memory: '<S34>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_i = t15_2_B.c_eob_o;

  /* Update for Memory: '<S35>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_jj = t15_2_B.c_eob_m;

  /* Update for Memory: '<S36>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_k = t15_2_B.c_eob_pa;

  /* Update for Memory: '<S37>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_in = t15_2_B.c_eob_cb;

  /* Update for Memory: '<S38>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_af = t15_2_B.c_eob_jb;

  /* Update for Memory: '<S39>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_gb = t15_2_B.c_eob_id;

  /* Update for Memory: '<S30>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_jo = t15_2_B.c_eob_l;

  /* Update for Memory: '<S31>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_hr = t15_2_B.c_eob_cv;

  /* Update for Memory: '<S25>/Memory' */
  t15_2_DWork.Memory_PreviousInput_n = t15_2_B.LogicalOperator_n;
  ...
  t15_2_DWork.Memory1_PreviousInput_de = t15_2_B.c_eob_ji;
  ...
  t15_2_DWork.Memory1_PreviousInput_c = t15_2_B.switch1_k;
  ...
  /* Update for DiscreteStateSpace: '<S15>/Curr. term. contr' */
  {
...

    {
      ...
      const real_T *u = &t15_2_B.Divide12_o[0];
      real_T *pxnew11 = &xnew[11];
      int_T numNonZero = 11;
      while (numNonZero--) {
        *pxnew11 += (*pB0++) * u[*pBidx++];
  ...
  /* Update for DiscreteStateSpace: '<S60>/VS. contr' */
  {
    ...
    xnew[0] += (t15_2_P.VScontr_B[0])*t15_2_B.Divide12_d[0] +
      (t15_2_P.VScontr_B[1])*t15_2_B.Divide12_d[1];
    ...
    xnew[1] += (t15_2_P.VScontr_B[2])*t15_2_B.Divide12_d[0] +
      (t15_2_P.VScontr_B[3])*t15_2_B.Divide12_d[1];
    ...
    xnew[2] += (t15_2_P.VScontr_B[4])*t15_2_B.Divide12_d[0] +
      (t15_2_P.VScontr_B[5])*t15_2_B.Divide12_d[1];
    ...
    xnew[3] += (t15_2_P.VScontr_B[6])*t15_2_B.Divide12_d[0] +
      (t15_2_P.VScontr_B[7])*t15_2_B.Divide12_d[1];
    ...
    xnew[4] += (t15_2_P.VScontr_B[8])*t15_2_B.Divide12_d[0] +
      (t15_2_P.VScontr_B[9])*t15_2_B.Divide12_d[1];
    ...
    xnew[5] += (t15_2_P.VScontr_B[10])*t15_2_B.Divide12_d[0] +
      (t15_2_P.VScontr_B[11])*t15_2_B.Divide12_d[1];
    ...
    xnew[6] += (t15_2_P.VScontr_B[12])*t15_2_B.Divide12_d[0] +
      (t15_2_P.VScontr_B[13])*t15_2_B.Divide12_d[1];
    xnew[7] = (t15_2_P.VScontr_A[32])*t15_2_DWork.VScontr_DSTATE[7];
    xnew[7] += (t15_2_P.VScontr_B[14])*t15_2_B.Divide12_d[0];
    xnew[8] = (t15_2_P.VScontr_A[33])*t15_2_DWork.VScontr_DSTATE[8];
    xnew[8] += (t15_2_P.VScontr_B[15])*t15_2_B.Divide12_d[1];
  ...
  t15_2_DWork.Memory1_PreviousInput_g = t15_2_B.Switch2_a;

  /* Update for Memory: '<S4>/Memory2' */
  t15_2_DWork.Memory2_PreviousInput_j4 = t15_2_B.Switch2_ap;

  /* Update for UnitDelay: '<S6>/UD' */
  t15_2_DWork.UD_DSTATE_n = t15_2_B.Times;
...
void t15_2_initialize(void)
{
...

  {
    ...
    for (i = 0; i < 11; i++) {
      t15_2_B.DataStoreRead2_j[i] = 0.0;
    }

    for (i = 0; i < 11; i++) {
      t15_2_B.Divide5_a[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead1_dr[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_hd[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_h3[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_l1[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead1_ib[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead1_oz[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.u01_od[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead1_oe[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_hx[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.u01_js[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_cf[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead1_dp[i] = 0.0;
    }
    ...
    for (i = 0; i < 11; i++) {
      t15_2_B.DataStoreRead2_jy[i] = 0.0;
    }
    ...
    for (i = 0; i < 11; i++) {
      t15_2_B.DataStoreRead2_n3[i] = 0.0;
    }
    ...
    for (i = 0; i < 11; i++) {
      t15_2_B.Memory1_ld[i] = 0.0;
    }

    for (i = 0; i < 11; i++) {
      t15_2_B.Add1_k3[i] = 0.0;
    }
    ...
    for (i = 0; i < 11; i++) {
      t15_2_B.DataStoreRead1_do[i] = 0.0;
    }
    ...
    for (i = 0; i < 50; i++) {
      t15_2_B.Selector_ez[i] = 0.0;
    }

    for (i = 0; i < 50; i++) {
      t15_2_B.Selector1_kl[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_cw[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead1_ac[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead1_m3[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_p5[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead1_h5[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_ec[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead1_fz[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_kq[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead1_f5[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead1_ek[i] = 0.0;
    }

    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_m5[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead_lb[i] = 0.0;
    }
    ...
    for (i = 0; i < 500; i++) {
      t15_2_B.DataStoreRead1_fv[i] = 0.0;
    }
    ...
    t15_2_B.c_eob1_l5 = 0.0;
    t15_2_B.Memory1_ii = 0.0;
    t15_2_B.c_eob_kr = 0.0;
    t15_2_B.c_eob_b = 0.0;
    t15_2_B.Add5 = 0.0;
    t15_2_B.Memory2_i = 0.0;
    t15_2_B.c_eob1_pv = 0.0;
    t15_2_B.Memory1_e = 0.0;
    t15_2_B.c_eob_j = 0.0;
    t15_2_B.c_eob_di = 0.0;
    t15_2_B.Add6 = 0.0;
    ...
    t15_2_B.Add1_f = 0.0;
    t15_2_B.Memory2_gk = 0.0;
    t15_2_B.c_eob_n = 0.0;
    t15_2_B.Divide1_a = 0.0;
    t15_2_B.Add2_g = 0.0;
    t15_2_B.Memory2_ko = 0.0;
    t15_2_B.c_eob_o = 0.0;
    t15_2_B.Divide1_k = 0.0;
    t15_2_B.Add4_m = 0.0;
    t15_2_B.Memory2_nn = 0.0;
    t15_2_B.c_eob_m = 0.0;
    ...
    t15_2_B.c_eob_cb = 0.0;
    t15_2_B.Divide1_oe = 0.0;
    t15_2_B.Add7 = 0.0;
    t15_2_B.Memory2_nx = 0.0;
    t15_2_B.c_eob_jb = 0.0;
    t15_2_B.Divide1_f = 0.0;
    t15_2_B.Add8 = 0.0;
    t15_2_B.Memory2_dj = 0.0;
    t15_2_B.c_eob_id = 0.0;
    t15_2_B.Divide1_g = 0.0;
    t15_2_B.Add9 = 0.0;
    t15_2_B.Memory2_mw = 0.0;
    t15_2_B.c_eob_l = 0.0;
    t15_2_B.Divide1_gk = 0.0;
    t15_2_B.Add10 = 0.0;
    t15_2_B.Memory2_o = 0.0;
    t15_2_B.c_eob_cv = 0.0;
    t15_2_B.Divide1_e = 0.0;
    t15_2_B.Add11 = 0.0;
    t15_2_B.DataStoreRead1_d = 0.0;
    t15_2_B.RelationalOperator_m = 0.0;
    t15_2_B.Memory_c = 0.0;
    t15_2_B.LogicalOperator_n = 0.0;
    t15_2_B.Uk1 = 0.0;
    t15_2_B.Diff = 0.0;
    t15_2_B.Uk1_f = 0.0;
    t15_2_B.Diff_l = 0.0;
    t15_2_B.Divide = 0.0;
    t15_2_B.DataStoreRead_ox = 0.0;
    t15_2_B.u15 = 0.0;
    t15_2_B.DataStoreRead_c = 0.0;
    t15_2_B.Memory3 = 0.0;
    t15_2_B.DataStoreRead_ck = 0.0;
    t15_2_B.Abs = 0.0;
    t15_2_B.LogicalOperator1 = 0.0;
    t15_2_B.switch1 = 0.0;
    t15_2_B.Subtract2 = 0.0;
    t15_2_B.Divide1_jh = 0.0;
    t15_2_B.Subtract1 = 0.0;
    t15_2_B.Saturation1 = 0.0;
    t15_2_B.Memory1_f = 0.0;
    t15_2_B.c_eob_ji = 0.0;
    t15_2_B.c_eob_mp = 0.0;
    ...
    t15_2_B.volt1_m = 0.0;
    t15_2_B.volt1_c = 0.0;
    t15_2_B.volt1_mx = 0.0;
    t15_2_B.volt1_j = 0.0;
    t15_2_B.volt1_a = 0.0;
    t15_2_B.volt1_b = 0.0;
    t15_2_B.volt1_p4 = 0.0;
    t15_2_B.volt1_cq = 0.0;
    t15_2_B.volt1_k = 0.0;
    t15_2_B.Sum1_f = 0.0;
    ...
    t15_2_B.Sum2_d = 0.0;
    t15_2_B.DataStoreRead_nf = 0.0;
    t15_2_B.RelationalOperator1_j = 0.0;
    t15_2_B.Divide12_d[0] = 0.0;
    t15_2_B.Divide12_d[1] = 0.0;
    ...
    t15_2_B.c_eob_bg[0] = 0.0;
    t15_2_B.c_eob_bg[1] = 0.0;
    t15_2_B.DataStoreRead1_m5 = 0.0;
    t15_2_B.RelationalOperator2 = 0.0;
    t15_2_B.DataStoreRead_pk = 0.0;
    t15_2_B.Abs_ml = 0.0;
    t15_2_B.RelationalOperator1_c = 0.0;
    t15_2_B.LogicalOperator1_j = 0.0;
    t15_2_B.DataStoreRead_o4 = 0.0;
    t15_2_B.u5_k = 0.0;
    t15_2_B.Div = 0.0;
    t15_2_B.u_f[0] = 0.0;
    t15_2_B.u_f[1] = 0.0;
    ...
    t15_2_B.DataStoreRead_gy = 0.0;
    t15_2_B.Memory1_oe = 0.0;
    t15_2_B.DataStoreRead1_pu = 0.0;
    t15_2_B.Divide4_gn = 0.0;
    t15_2_B.Memory2_mi = 0.0;
    ...
    t15_2_B.Switch2_ap = 0.0;
    t15_2_B.Subtract2_m = 0.0;
    t15_2_B.DataStoreRead1_gj = 0.0;
    t15_2_B.Divide4_b = 0.0;
    t15_2_B.Subtract3_n = 0.0;
    t15_2_B.Saturation_l = 0.0;
    t15_2_B.Subtract1_i = 0.0;
    t15_2_B.Divide6_e4 = 0.0;
    t15_2_B.Switch2_h = 0.0;
    t15_2_B.Divide11_j[0] = 0.0;
    t15_2_B.Divide11_j[1] = 0.0;
    t15_2_B.DataStoreRead3_p = 0.0;
    t15_2_B.Switch_j = 0.0;
    t15_2_B.c_eob_lo[0] = 0.0;
    t15_2_B.c_eob_lo[1] = 0.0;
    t15_2_B.DataStoreRead1_fl = 0.0;
    ...
    t15_2_B.DataStoreRead1_fc = 0.0;
    t15_2_B.DataStoreRead_fp = 0.0;
    t15_2_B.Subtract3_d = 0.0;
    ...
    t15_2_B.Sum3_i = 0.0;
    t15_2_B.DataStoreRead4_m = 0.0;
    t15_2_B.DataStoreRead3_e = 0.0;
    t15_2_B.Sum2_p = 0.0;
    t15_2_B.Divide1_jhy = 0.0;
    ...
    t15_2_B.DataStoreRead_eg = 0.0;
    t15_2_B.g1_termref = 0.0;
    t15_2_B.g1ref = 0.0;
    t15_2_B.DataStoreRead1_nu = 0.0;
    t15_2_B.DataStoreRead_gv = 0.0;
    t15_2_B.g6_termref = 0.0;
    t15_2_B.g6ref = 0.0;
    t15_2_B.DataStoreRead1_dv = 0.0;
    t15_2_B.DataStoreRead_cy = 0.0;
    t15_2_B.g5_termref = 0.0;
    t15_2_B.g5ref = 0.0;
    t15_2_B.DataStoreRead1_lx = 0.0;
    t15_2_B.DataStoreRead_o0 = 0.0;
    t15_2_B.g4_termref = 0.0;
    t15_2_B.g4ref = 0.0;
    t15_2_B.DataStoreRead1_lh = 0.0;
    t15_2_B.DataStoreRead_mb = 0.0;
    t15_2_B.g3_termref = 0.0;
    t15_2_B.g3ref = 0.0;
    t15_2_B.DataStoreRead1_oc = 0.0;
    t15_2_B.DataStoreRead_fk = 0.0;
  ...
  t15_2_DWork.Memory1_PreviousInput_da = 0.0;
  t15_2_DWork.Memory2_PreviousInput_a0 = 0.0;
  ...
  t15_2_DWork.Memory2_PreviousInput_jj = 0.0;
  t15_2_DWork.Memory2_PreviousInput_k = 0.0;
  t15_2_DWork.Memory2_PreviousInput_in = 0.0;
  t15_2_DWork.Memory2_PreviousInput_af = 0.0;
  t15_2_DWork.Memory2_PreviousInput_gb = 0.0;
  t15_2_DWork.Memory2_PreviousInput_jo = 0.0;
  t15_2_DWork.Memory2_PreviousInput_hr = 0.0;
  t15_2_DWork.Memory_PreviousInput_n = 0.0;
  ...
  t15_2_DWork.Memory1_PreviousInput_de = 0.0;

  {
    int_T i;
    for (i = 0; i < 11; i++) {
      t15_2_DWork.Memory1_PreviousInput_m4[i] = 0.0;
    }
  }
  ...
  t15_2_DWork.Memory2_PreviousInput_j4 = 0.0;

  {
    int_T i;
    for (i = 0; i < 11; i++) {
      t15_2_DWork.Memory1_PreviousInput_kd[i] = 0.0;
    }
  }
  ...
  /* register each child */
  {
    ...
    /* Level2 S-Function Block: t15_2/<S41>/S-Function1 (read_gaps) */
    {
      ...
      /* parameters */
      {
        ...
        ssSetSFcnParamsCount(rts, 1);
        ssSetSFcnParamsPtr(rts, &sfcnParams[0]);
        ssSetSFcnParam(rts, 0, (mxArray*)t15_2_P.SFunction1_P1_Size_he);
      }
    ...
    /* Level2 S-Function Block: t15_2/<S47>/S-Function1 (read_gaps_term) */
    {
      ...
      /* outputs */
      {
        ...
        /* port 0 */
        {
          ...
          _ssSetOutputPortNumDimensions(rts, 0, 2);
          ssSetOutputPortWidth(rts, 0, 100);
          ssSetOutputPortSignal(rts, 0, ((real_T *) t15_2_B.SFunction1_ov));
        }
      }
    ...
    /* Level2 S-Function Block: t15_2/<S48>/S-Function1 (read_gaps_term) */
    {
      ...
      /* outputs */
      {
        ...
        /* port 0 */
        {
          ...
          _ssSetOutputPortNumDimensions(rts, 0, 2);
          ssSetOutputPortWidth(rts, 0, 100);
          ssSetOutputPortSignal(rts, 0, ((real_T *) t15_2_B.SFunction1_kp));
        }
      }
    ...
    /* Level2 S-Function Block: t15_2/<S50>/S-Function1 (read_gaps_term) */
    {
      ...
      /* outputs */
      {
        ...
        /* port 0 */
        {
          ...
          _ssSetOutputPortNumDimensions(rts, 0, 2);
          ssSetOutputPortWidth(rts, 0, 100);
          ssSetOutputPortSignal(rts, 0, ((real_T *) t15_2_B.SFunction1_e2));
        }
      }
    ...
    /* Level2 S-Function Block: t15_2/<S1>/S-Function (read_tt_kavin2) */
    {
      ...
      /* outputs */
      {
        ...
        /* port 0 */
        {
          ...
          ssSetOutputPortSignal(rts, 0, ((real_T *) t15_2_B.SFunction_c));
        }
      }
...

  {
    ...
    for (r = 0; r < 6; r++) {
      t15_2_DWork.RupRd[r] = t15_2_P.DataStoreMemory2_InitialValue_j[r];
    }

    /* End of Start for DataStoreMemory: '<S1>/Data Store Memory2' */

    /* Start for DataStoreMemory: '<S1>/Data Store Memory3' */
    t15_2_DWork.VS3_up = t15_2_P.DataStoreMemory3_InitialValue_i;

    /* Start for DataStoreMemory: '<S1>/Data Store Memory5' */
    t15_2_DWork.VS1_up = t15_2_P.DataStoreMemory5_InitialValue_h;
    ...
    t15_2_DWork.c_cur_max = t15_2_P.DataStoreMemory8_InitialValue_e;
    for (r = 0; r < 11; r++) {
      /* Start for DataStoreMemory: '<S1>/Data Store Memory4' */
      t15_2_DWork.Vcspf_up[r] = t15_2_P.DataStoreMemory4_InitialValue_i[r];

      /* Start for DataStoreMemory: '<S1>/Data Store Memory9' */
      t15_2_DWork.Imax[r] = t15_2_P.DataStoreMemory9_InitialValue_e[r];
    }
  }

  {
    ...
    t15_2_DWork.Memory1_PreviousInput_k = t15_2_P.Memory1_X0_p;
    ...
    t15_2_DWork.Memory1_PreviousInput_d = t15_2_P.Memory1_X0_i;

    /* InitializeConditions for Memory: '<S40>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_j = t15_2_P.Memory2_X0_o;

    /* InitializeConditions for Memory: '<S40>/Memory1' */
    t15_2_DWork.Memory1_PreviousInput_i = t15_2_P.Memory1_X0_d;

    /* InitializeConditions for Memory: '<S41>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_l = t15_2_P.Memory2_X0_f;

    /* InitializeConditions for Memory: '<S41>/Memory1' */
    t15_2_DWork.Memory1_PreviousInput_h = t15_2_P.Memory1_X0_k;
    ...
    t15_2_DWork.Memory1_PreviousInput_da = t15_2_P.Memory1_X0_l;

    /* InitializeConditions for Memory: '<S43>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_a0 = t15_2_P.Memory2_X0_n;

    /* InitializeConditions for Memory: '<S43>/Memory1' */
    t15_2_DWork.Memory1_PreviousInput_m = t15_2_P.Memory1_X0_j;

    /* InitializeConditions for Memory: '<S44>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_h = t15_2_P.Memory2_X0_b;

    /* InitializeConditions for Memory: '<S44>/Memory1' */
    t15_2_DWork.Memory1_PreviousInput_o = t15_2_P.Memory1_X0_dy;

    /* InitializeConditions for Memory: '<S29>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_g = t15_2_P.Memory2_X0_g;

    /* InitializeConditions for Memory: '<S32>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_gi = t15_2_P.Memory2_X0_oe;

    /* InitializeConditions for Memory: '<S33>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_jn = t15_2_P.Memory2_X0_jq;

    /* InitializeConditions for Memory: '<S34>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_i = t15_2_P.Memory2_X0_k;

    /* InitializeConditions for Memory: '<S35>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_jj = t15_2_P.Memory2_X0_h;

    /* InitializeConditions for Memory: '<S36>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_k = t15_2_P.Memory2_X0_kk;

    /* InitializeConditions for Memory: '<S37>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_in = t15_2_P.Memory2_X0_c;

    /* InitializeConditions for Memory: '<S38>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_af = t15_2_P.Memory2_X0_cm;

    /* InitializeConditions for Memory: '<S39>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_gb = t15_2_P.Memory2_X0_l0;

    /* InitializeConditions for Memory: '<S30>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_jo = t15_2_P.Memory2_X0_m;

    /* InitializeConditions for Memory: '<S31>/Memory2' */
    t15_2_DWork.Memory2_PreviousInput_hr = t15_2_P.Memory2_X0_a;

    /* InitializeConditions for Memory: '<S25>/Memory' */
    t15_2_DWork.Memory_PreviousInput_n = t15_2_P.Memory_X0_h;
    ...
    t15_2_DWork.Memory1_PreviousInput_de = t15_2_P.Memory1_X0_po;
    ...
    t15_2_DWork.Memory1_PreviousInput_c = t15_2_P.Memory1_X0_m4;
    ...
    t15_2_DWork.UD_DSTATE_k = t15_2_P.UD_InitialCondition_o;
    ...
    t15_2_DWork.Memory2_PreviousInput_j4 = t15_2_P.Memory2_X0_ci;

    /* InitializeConditions for UnitDelay: '<S6>/UD' */
    t15_2_DWork.UD_DSTATE_n = t15_2_P.UD_InitialCondition_e;
    for (i = 0; i < 11; i++) {
      /* InitializeConditions for Memory: '<S52>/Memory1' */
      t15_2_DWork.Memory1_PreviousInput_l[i] = t15_2_P.Memory1_X0_h;

      /* InitializeConditions for Memory: '<S66>/Memory1' */
      t15_2_DWork.Memory1_PreviousInput_m4[i] = t15_2_P.Memory1_X0_m;

      /* InitializeConditions for Memory: '<S58>/Memory' */
      t15_2_DWork.Memory_PreviousInput_e[i] = t15_2_P.Memory_X0_l;

      /* InitializeConditions for Memory: '<S3>/Memory1' */
      t15_2_DWork.Memory1_PreviousInput_e[i] = t15_2_P.Memory1_X0_c;

      /* InitializeConditions for Memory: '<S7>/Memory1' */
      t15_2_DWork.Memory1_PreviousInput_kd[i] = t15_2_P.Memory1_X0_hm;
    }
  }
}
